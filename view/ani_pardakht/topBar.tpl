        ...
        <div class="sup-menu-flex-r">
            <div class="login-head-icon">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"  version="1.1"  x="0" y="0" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512" xml:space="preserve" class=""><g>
                        <g xmlns="http://www.w3.org/2000/svg">
                            <path style="" d="M453.71,409.92V512H58.29V409.92c0-85.15,69.28-154.42,154.42-154.42h86.58   C384.43,255.5,453.71,324.77,453.71,409.92z"  data-original="#00a5ff" class=""/>
                            <path style="" d="M375.41,119.41c0,65.84-53.57,119.41-119.41,119.41s-119.41-53.57-119.41-119.41S190.16,0,256,0   S375.41,53.57,375.41,119.41z"  data-original="#00a5ff" class=""/>
                        </g>
                        <g xmlns="http://www.w3.org/2000/svg">
                            <path style="" d="M256,238.82V0c65.84,0,119.41,53.57,119.41,119.41S321.84,238.82,256,238.82z"  data-original="#0087ff" class=""/>
                            <path style="" d="M453.71,409.92V512H256V255.5h43.29C384.43,255.5,453.71,324.77,453.71,409.92z"  data-original="#0087ff" class=""/>
                        </g>
                        <g xmlns="http://www.w3.org/2000/svg">
                        </g>
                        <g xmlns="http://www.w3.org/2000/svg">
            ...
            {if $typeMember eq 'Counter'}
                <div class="etebar-login"><span>##S360Accreditation##</span>
                    <span><i>{$objFunctions->CalculateCredit($objSession->getUserId())}</i> <i>##S360Rial##</i></span>
                </div>
            ...
            {if $smarty.const.IS_ENABLE_CLUB eq 1}
                    ...
                    <a class="club_" target="_parent" href="https://{$smarty.const.CLIENT_MAIN_DOMAIN}/fa/user/login.php?clubID={$hashedPass}">##S360CustomerClub##</a>
            {/if}
        </div>
