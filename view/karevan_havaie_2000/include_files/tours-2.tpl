...
{assign var="max_internal" value=14}
                                                ...
                                                <div class="parent-text-tour">
                                                    ...
                                                    <div class="price-tour">
                                                        ...
                                                        <div class="start-price">
                                                            <span>شروع قیمت</span>
                                                            <span class="number-price"><span class="___price_class__">{$item['min_price']['discountedMinPriceR']|number_format}</span> تومان</span>
                                                        </div>
                                                    </div>
                                                </div>
