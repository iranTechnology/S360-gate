      ...
      <div class="col-lg-2 col-md-6 col-sm-12 col-12 p-2">
       <div class="parent-namad">
        ...
        <div class="namads">
         ...
         <a href="javascript:">
          <img referrerpolicy="origin" id = 'jxlzjzpewlaofukzoeukjxlz' style = 'cursor:pointer' onclick = 'window.open("https://logo.samandehi.ir/Verify.aspx?id=174681&p=rfthjyoeaodsgvkamcsirfth", "Popup","toolbar=no, scrollbars=no, location=no, statusbar=no, menubar=no, resizable=0, width=450, height=630, top=30")' alt = 'logo-samandehi' src = 'https://logo.samandehi.ir/logo.aspx?id=174681&p=nbpdyndtshwlwlbqaqgwnbpd' />
         </a>

        <a referrerpolicy='origin' target='_blank' href='https://trustseal.enamad.ir/?id=33313&Code=g1B0fWahDoJGoM9gcBDx'><img referrerpolicy='origin' src='https://trustseal.enamad.ir/logo.aspx?id=33313&Code=g1B0fWahDoJGoM9gcBDx' alt='' style='cursor:pointer' code='g1B0fWahDoJGoM9gcBDx'></a>
