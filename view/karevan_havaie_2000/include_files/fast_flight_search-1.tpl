                ...
                <ul class="__origin__cities__ nav nav-pills m-0 p-0" id="search_flight_internation-div-tab" role="tablist">
                    ...
                    {foreach $foreign_cities as $city_code}
                        ...
                        {if $i < $__local_max_var__  and {$cities['main']['DepartureCityFa']}}
                            ...
                            <li class="__i_modular_nc_item_class_0 nav-item" role="presentation">
                                <button aria-controls="{$cities['main']['DepartureCityEn']}-external" aria-selected="true" class="__button__ nav-link {if $i==1} show active {/if}" data-target="#{$cities['main']['DepartureCityEn']}-external" data-toggle="pill" id="{$cities['main']['DepartureCityEn']}-external-tab" role="tab" type="button">{$cities['main']['DepartureCityFa']}</button>
                            </li>
                ...
                <div class="__destination__cities__ tab-content" id="search_flight_internation-div-tabContent">
                    ...
                    {foreach $foreign_cities as $city_code}
                        ...
                        {if $i < $__local_max_var__  and {$cities['main']['DepartureCityFa']}}
                            ...
                            <div aria-labelledby="{$cities['main']['DepartureCityEn']}-external-tab" class="__i_modular_nc_item_class_0 tab-pane fade {if $i==1} show active {/if}" id="{$cities['main']['DepartureCityEn']}-external" role="tabpanel">
                                <div class="search_flight_grid">
