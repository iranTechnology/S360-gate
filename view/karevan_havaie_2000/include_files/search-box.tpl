{assign var="services_array_json" value= '{"Flight": "Flight", "Tour": "Tour", "Visa": "Visa"}'}
{assign var="services_array" value=$services_array_json|json_decode}
<section class="i_modular_banner_gallery banner-demo {if $smarty.const.GDS_SWITCH neq 'mainPage' } banner-page {/if}">
