            ...
            <nav class="navigation d-flex align-items-center">
                ...
                <div class="nav-menus-wrapper">
                    <ul class="nav-menu">
                        ...
                        <li><a href="{$smarty.const.ROOT_ADDRESS}/page/hotel">رزرو هتل</a>
                            <ul class="nav-dropdown">
                                ...
                                <li><a href="{$smarty.const.ROOT_ADDRESS}/page/hotel-mashhad">هتل مشهد </a></li>
                                <li><a href="{$smarty.const.ROOT_ADDRESS}/page/hotel-van">هتل وان</a></li>
                            </ul>
                        </li>
                        <li><a href="{$smarty.const.ROOT_ADDRESS}/page/tour">رزرو تور</a>
                            <ul class="nav-dropdown">
                                <li><a href="{$smarty.const.ROOT_ADDRESS}/page/tour-mashhad">تور مشهد</a></li>
                                <li><a href="{$smarty.const.ROOT_ADDRESS}/page/tour-van">تور وان</a></li>
                                <li><a href="{$smarty.const.ROOT_ADDRESS}/page/combined-tour-of-erbil">تور اربیل</a>
                                </li>
                                <li><a href="{$smarty.const.ROOT_ADDRESS}/page/baghdad-tours">تور بغداد</a></li>
                                <li><a href="{$smarty.const.ROOT_ADDRESS}/page/karbala-tours">تور کربلا</a></li>
                                <li></li>
                                <li>
                                    <a href="{$smarty.const.ROOT_ADDRESS}/page/expo-tour">تور نمایشگاهی</a>
                                    <ul class="nav-dropdown">
                                        <li>
                                            <a href="{$smarty.const.ROOT_ADDRESS}/page/erbil-expo">تور نمایشگاهی اربیل</a>
                                        </li>
                                        <li>
                                            <a href="{$smarty.const.ROOT_ADDRESS}/page/baghdad-expo">تور نمایشگاهی بغداد</a>
                                        </li>
                                        <li>
                                            <a href="{$smarty.const.ROOT_ADDRESS}/page/basra-expo">تور نمایشگاهی بصره</a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
                        ...
                        <li class="d-block-c d-sm-none-c"><a href="{$smarty.const.ROOT_ADDRESS}/UserTracking">پیگیری
                                خرید</a></li>
