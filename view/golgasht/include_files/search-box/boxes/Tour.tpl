<div class="__box__ {if $page['slug'] eq 'tour'} {else} tab-pane{/if} {if  $smarty.const.GDS_SWITCH eq 'page'}active{/if}" id="Tour">
...
{*    </div>*}
    <div class="international-tour-js" id="international_tour">
        <div class="col-12">
            <div class="row">
                <form class="d_contents" data-action="://s360online.iran-tech.com/" id="gdsPortalLocal" method="post"
                      name="gdsPortalLocal" target="_blank">
