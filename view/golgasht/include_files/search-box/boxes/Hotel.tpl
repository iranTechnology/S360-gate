<div class="__box__  {if $page['slug'] eq 'Hotel'} {else} tab-pane{/if} active" id="Hotel">
    <div class="d-flex flex-wrap international-hotel-js" id="international_hotel">
        <form class="d_contents" data-action="https://s360online.iran-tech.com/" id="hotel_search_form" method="post" target="_blank">
                ...
                <div class="form-group destination_start">
                    <div class="inputSearchForeign-box inputSearchForeign-pad_Fhotel w-100">
                        <div class="s-u-in-out-wrapper raft raft-change change-bor">
                            <input autocomplete="off" class="inputSearchForeign w-100 form-control" id="autoComplateSearchIN_2" name="autoComplateSearchIN" onclick="openBoxPopularInternalAndExternal('externalHotel')" onkeyup="searchCityInternalAndExternal('externalHotel')" placeholder="انتخاب شهر" type="text" value=""/>
            ...
            <div class="col-lg-2 col-md-6 col-sm-6 col-12 col_search search_col">
                <div class="form-group">
                    <input autocomplete="off" class="init-shamsi-datepicker form-control check-in-date-js check-in-date-js-new" data-type="internal" id="startDateForHotelLocal" name="startDateForHotelLocal" placeholder="تاریخ ورود" readonly="" type="text"/>
            ...
            <div class="col-lg-2 col-md-6 col-sm-6 col-12 col_search search_col">
                <div class="form-group">
                    <input autocomplete="off" class="init-shamsi-return-datepicker form-control check-out-date-internal-js check-in-date-js-new" data-type="internal" id="endDateForHotelLocal" name="endDateForHotelLocal" placeholder="تاریخ خروج" readonly="" type="text"/>
                    <i class="fal fa-calendar-alt"></i>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12 col_search">
                <div class="form-group">
                    <div class="hotel_passenger_picker international-hotel-passenger-picker-js">
                        <ul onclick="openCountPassengerNew()">
                                ...
                                <div class="myroom-hotel-item international-my-room-hotel-item-js" data-roomnumber="1">
                                    <div class="myroom-hotel-item-title international-my-room-hotel-item-title-js">
                                        <span class="close d-none" onclick="itemsRoom('international')">
                                            <i>
                                                <svg viewbox="0 0 448 512" xmlns="http://www.w3.org/2000/svg"><path d="M144 400C144 408.8 136.8 416 128 416C119.2 416 112 408.8 112 400V176C112 167.2 119.2 160 128 160C136.8 160 144 167.2 144 176V400zM240 400C240 408.8 232.8 416 224 416C215.2 416 208 408.8 208 400V176C208 167.2 215.2 160 224 160C232.8 160 240 167.2 240 176V400zM336 400C336 408.8 328.8 416 320 416C311.2 416 304 408.8 304 400V176C304 167.2 311.2 160 320 160C328.8 160 336 167.2 336 176V400zM310.1 22.56L336.9 64H432C440.8 64 448 71.16 448 80C448 88.84 440.8 96 432 96H416V432C416 476.2 380.2 512 336 512H112C67.82 512 32 476.2 32 432V96H16C7.164 96 0 88.84 0 80C0 71.16 7.164 64 16 64H111.1L137 22.56C145.8 8.526 161.2 0 177.7 0H270.3C286.8 0 302.2 8.526 310.1 22.56V22.56zM148.9 64H299.1L283.8 39.52C280.9 34.84 275.8 32 270.3 32H177.7C172.2 32 167.1 34.84 164.2 39.52L148.9 64zM64 432C64 458.5 85.49 480 112 480H336C362.5 480 384 458.5 384 432V96H64V432z"></path></svg>
                                            </i>
                                        </span>
                                        اتاق اول
                                    </div>
                                    <div class="myroom-hotel-item-info international-my-room-hotel-item-info-js">
                                        <div class="myroom-hotel-item-tedad my-room-hotel-bozorgsal">
                                            ...
                                            <div>
                                                ...
                                                <input autocomplete="off" class="countParent international-count-parent-js" id="adult1" max="5" min="0" name="adult1" readonly="" type="text" value="2"/>
                                        ...
                                        <div class="myroom-hotel-item-tedad my-room-hotel-bozorgsal">
                                            ...
                                            <div>
                                                ...
                                                <input autocomplete="off" class="countChild international-count-child-js" id="child1" max="5" min="0" name="child1" readonly="" type="text" value="0"/>
                                                <i class="minusChild international-minus-number-child-js hotelroom-minus minus-hotelroom-koodak fas fa-minus" onclick="minusNumberChild('international',this)"></i>
                                            </div>
                                        </div>
            ...
            <div class="col-lg-2 col-md-3 col-sm-6 col-12 btn_s col_search margin-center">
                ...
                <input type="hidden" id="check_in_date_hidden" name="check_in_date_hidden" value=""/>
                <input type="hidden" id="check_out_date_hidden" name="check_out_date_hidden" value=""/>
                <button class="btn theme-btn seub-btn b-0" onclick="searchHotel()" type="button"><span>جستجو</span></button>
            </div>
        </form>
    </div>
