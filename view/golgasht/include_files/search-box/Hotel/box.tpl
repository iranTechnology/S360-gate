...
<input autocomplete="off" class="countChild international-count-child-js" id="child1" max="5" min="0" name="child1" readonly="" type="text" value="0"/><i class="minusChild international-minus-number-child-js hotelroom-minus minus-hotelroom-koodak fas fa-minus" onclick="minusNumberChild('international',this)"></i>
</div>
</div>
