        ...
        <div class="container">
            <div class="parent-about">
                <div class="parent-text-about">
                    <h3>
                        پرشین گلف : کیفیت، تعهد، و انگیزه در وب‌ سایت ما
                    </h3>
                    ...
                    <div class="parent-box-about">
                        <div class="item-about">
                            ...
                            <div class="parent-paragraph-about">
                                <h6>سال‌ها همراهی با مسافران</h6>
                                <p>
                                    با بیش از ده سال تجربه کاری در دنیای مسافرت‌ها همراه شما هستیم
                                </p>
                            </div>
                        </div>
                        <div class="item-about">
                            <div class="parent-svg-about">
                                <svg viewbox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                                    <!--! Font Awesome Pro 6.3.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                                    <path d="M253.4 2.9C249.2 1 244.7 0 240 0s-9.2 1-13.4 2.9L38.3 82.8C16.3 92.1-.1 113.8 0 140c.5 99.2 41.3 280.7 213.6 363.2c16.7 8 36.1 8 52.8 0C438.7 420.7 479.5 239.2 480 140c.1-26.2-16.3-47.9-38.3-57.2L253.4 2.9zM353 209L225 337c-9.4 9.4-24.6 9.4-33.9 0l-64-64c-9.4-9.4-9.4-24.6 0-33.9s24.6-9.4 33.9 0l47 47L319 175c9.4-9.4 24.6-9.4 33.9 0s9.4 24.6 0 33.9z"></path>
                                </svg>
                            </div>
                            <div class="parent-paragraph-about">
                                <h6>سفر با اطمینان خاطر</h6>
                                <p>
                                    میتوانید با اطمینان خاطر به پرشین گلف اعتماد کنند و از تجربه سفری با کیفیت بالا لذت
                                    ببرند
                                </p>
                            </div>
                        </div>
                        <div class="item-about">
                            ...
                            <div class="parent-paragraph-about">
                                <h6>همراه شما در هر لحظه از سفر</h6>
                                <p>
                                    از مرحله برنامه‌ریزی تا بازگشت به خانه، سفری بدون دغدغه و با آرامش کامل
                                </p>
                            </div>
                        </div>
                        <div class="item-about">
                            ...
                            <div class="parent-paragraph-about">
                                <h6>جهان را با ما کاوش کنید</h6>
                                <p>
                                    سفر به جاذبه‌های شهرهای بزرگ گرفته تا مسیرهای ماجراجویانه در دیگر نقاط جهان
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="parent-img-about">
                    <img alt="img-about" src="project_files/images/about.jpg" />
                </div>
            </div>
        </div>
    </section>
