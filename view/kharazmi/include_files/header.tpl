...
{load_presentation_object filename="kharazmi" assign="obj_main_page" subName="customers"}
...
<link href="project_files/images/favicon.png" rel="shortcut icon" type="image/x-icon"/>
    ...
    <link rel="stylesheet" href="project_files/css/header.css"><link rel="stylesheet" href="project_files/css/bootstrap.min.css"><link rel="stylesheet" href="project_files/css/header.css">
...
<link href="project_files/css/{$StyleSheetHeader}" rel="stylesheet"/>
    ...
    <link rel="stylesheet" href="project_files/css/tabs.css"><link rel="stylesheet" href="project_files/css/all.min.css"><link rel="stylesheet" href="project_files/css/register.css"><link rel="stylesheet" href="project_files/css/style.css">
</head>
