            ...
            const mainData = [
                {
                    ...
                    description: ' برای خرید آنلاین بلیط هواپیما در تامین تور کافیست مبدا، مقصد و تاریخ پرواز خود را انتخاب کنید. ',
                    image: 'gds/view/taminTour/project_files/images/bg-parvaz.jpg',
                },
                {
                    index: 'Hotel',
                    ...
                    image: 'gds/view/taminTour/project_files/images/bg-hotel.jpg',
                },
                {
                    index: 'Package',
                    ...
                    image: 'gds/view/taminTour/project_files/images/bg-hotelParvaz.jpg',
                },
                {
                    index: 'Train',
                    ...
                    image: 'gds/view/taminTour/project_files/images/bg-train.jpg',
                },
                {
                    index: 'Bus',
                    title: 'سفر راحت با رزرو بلیط اتوبوس‌های داخلی ',
                    description: '  تامین تور بهترین گزینه‌ها را برای رزرو بلیط اتوبوس‌های داخلی با قیمت‌های مناسب و خدمات عالی ارائه می‌دهد.    ',
                    image: 'gds/view/taminTour/project_files/images/bg-bus.jpg',
                },
                {
                    index: 'Insurance',
                    ...
                    image: 'gds/view/taminTour/project_files/images/bg-bime.jpg',
                },
                {
                    index: 'Tour',
                    title: 'تورهای ویژه داخلی و خارجی با خدمات استثنایی',
                    description: 'با تامین تور، سفرهای داخلی و خارجی خود را به تورهایی فراموش‌ نشدنی تبدیل کنید. ',
                    image: 'gds/view/taminTour/project_files/images/bg-tour.jpg',
                },
                {
                    index: 'Entertainment',
                    ...
                    image: 'gds/view/taminTour/project_files/images/bg-tafrihat.jpg',
                },
                {
                    index: 'Visa',
                    ...
                    image: 'gds/view/taminTour/project_files/images/bg-visa.jpg',
                },
                {
                    index: 'Europcar',
                    title: 'اجاره خودرو با شرایط عالی برای سفرهای داخلی و خارجی',
                    description: 'با تامین تور، خودروهای باکیفیت و متنوع را با قیمت‌های مناسب و شرایط انعطاف‌پذیر اجاره کنید. ',
                    image: 'gds/view/taminTour/project_files/images/bg-car.jpg',
                },
            ];
...
document.addEventListener('click', function(e) {
    const dropdownMenu = document.querySelector('.dropdown-menu-kharegi');

    // اگر منو وجود نداشته باشد یا نمایش داده نشده باشد، ادامه نده
    if (!dropdownMenu || !dropdownMenu.classList.contains('activeDropdown')) return;

    const toggleButton = document.querySelector('.dropdown-toggle-cheng-kharegi');

    // بررسی کلیک روی دکمه toggle یا خود منو
    const clickedInsideMenu = dropdownMenu.contains(e.target);
    const clickedOnToggle = toggleButton ? toggleButton.contains(e.target) : false;

    // اگر کلیک بیرون از منو و دکمه toggle بود، منو را ببند
...
// const dropdownContentInsurance = document.querySelector('.ul-insurance');
// const insuranceId = document.querySelector('#insuranceId');
//
// function toggleDropdownInsurance() {
//     dropdownContentInsurance.classList.toggle('activeDropdown');
// }
//
// document.body.addEventListener('click', function(event) {
//     if(insuranceId){
//         if (!dropdownTour.contains(event.target)) {
//             dropdownContentInsurance.classList.remove('activeDropdown');
//         }
//     }
// });
// if(insuranceId){
//     insuranceId.addEventListener('click', function(event) {
//         event.stopPropagation();
//     });
//
// }
//
//
// function selectOptionInsurance(optionTextInsurance,type) {
//     const toggleTextInsurance = document.getElementById('toggle-text-insurance');
//     const internalContent = document.querySelector('#internalSection');
//     const externalContent = document.querySelector('#externalSection');
//
//
//     toggleTextInsurance.innerText = optionTextInsurance;
//
//     if (type === 'internal') {
//         internalContent.style.display = 'flex';
//         externalContent.style.display = 'none';
