...
<div class="caption-input-search-box">تاریخ پرواز رفت را انتخاب کنید</div>
<input class="deptCalendar went departure-date-international-js" id="departure_date_international" name="departure_date_international" placeholder="تاریخ رفت" readonly="" type="text"/>
</div>
</div>