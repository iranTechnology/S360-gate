<div class="{if isset($col) } {$col} {else} col-lg-3{/if} col-md-6 col-sm-6 col-12 col_search search_col">
    <div class="cip-form-group-search">
        <div class="parent-input-search-box origin_start">
            ...
            <div class="caption-input-search-box">نوع پرواز/سفر را انتخاب کنید</div>
        <select id="flightTypeSelect" class="form-control">
            <option value=""></option>
        </select>
    </div>
    </div>
