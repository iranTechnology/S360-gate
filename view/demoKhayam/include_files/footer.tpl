                    ...
                    <div class="item3-footer-pabpa">
                        <div class="item_footer">
                            ...
                            <ul class="">
                                ...
                                <li><a href="https://caa.gov.ir/air-transport-agencies-renewal">لیست آژانسهای بند الف    </a></li>
                                <li><a href="https://ta.mcth.ir/kartablePage?applicationPageId=bc9bfc38-3819-4dee-aa12-01c68e5c448e">لیست آژانسهای بند ب     </a></li>
                                <li><a href="https://caa.gov.ir/air-cargo">لیست آژانسهای بار هوایی      </a></li>
                                <li><a href="https://ta.mcth.ir/kartablePage?applicationPageId=3a68195e-c21e-4c02-847f-2c1ef86f9cd0">لیست آژانسهای گردشگری سلامت   </a></li>
                    ...
                    <div class="item4-footer-pabpa">
                        <div class="item_footer">
                            ...
                            <ul>
                                ...
                                <li><a href="{$smarty.const.ROOT_ADDRESS}/authenticate">پیگیری خرید  </a></li>
                                                          </ul>
                        </div>
                    </div>
