...
{assign var="internal_tour_params" value=['type'=>'','limit'=> '20','dateNow' => $dateNow, 'country' =>'internal']}
{assign var="foreging_tour_params" value=['type'=>'','limit'=> '20','dateNow' => $dateNow, 'country' =>'external']}
{assign var="summer_tours_params" value=['type'=>'','limit'=> '20','dateNow' => $dateNow,'category' => '17']}
{assign var="recent_tours_params" value=['type'=>'','limit'=> '20','dateNow' => $dateNow,  'category' => '6']}
{*{assign var="installment_tour_params" value=['type'=>'','limit'=> '20','dateNow' => $dateNow, 'category' =>'5000']}*}
{*{assign var="earth_tours_params" value=['type'=>'','limit'=> '20','dateNow' => $dateNow,'category' => '14']}*}

{assign var='internalTours' value=$obj_main_page->getToursReservation($internal_tour_params)}
{assign var='earthTours' value=$obj_main_page->getToursReservation($foreging_tour_params)}
...
{if !empty($internalTours) || !empty($foreginTours) || !empty($earthTours)  || !empty($recentTours)}
    <section class="new_tours">
        <div class="container">
            <div class="titr_Terms_Conditions">
                <h4>جدیدترین تورها</h4>
                <ul class="nav nav-pills " id="tab-tour" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="pills-home-tab" data-toggle="pill" data-target="#pills-home"
                                type="button" role="tab" aria-controls="pills-home" aria-selected="true">داخلی
                        </button>
                    </li>
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="pills-contact-tab" data-toggle="pill" data-target="#pills-contact"
                                type="button" role="tab" aria-controls="pills-contact" aria-selected="false">خارجی
                        </button>
                    </li>

                    {if $earthTours|count neq 0}
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="pills-summer-tab" data-toggle="pill"
                                    data-target="#pills-summer" type="button" role="tab" aria-controls="pills-summer"
                                    aria-selected="false">گروهی
                            </button>
                        </li>
                    {/if}
                    ...
                    {if $recentTours|count neq 0}
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="pills-last-minute-tab" data-toggle="pill"
                                    data-target="#pills-last-minute" type="button" role="tab"
                                    aria-controls="pills-last-minute" aria-selected="false">بوم گردی
                            </button>
                        </li>
                    {/if}
...
{*                                                                                    {/if}*}
                                     ...
                                     <span class="Money_color font-weight-bold">
                                        ...
                                        {$item['min_price_r']|number_format}
                                         <span class="text_toman"> {if $item['min_price']['is_toman'] == true}
                                                 تومان
                                             {else}
                                                 ریال
                                             {/if}</span>
...
{*                                            {/if}*}
                        ...
                        <a class="btn-more--new"
                           href="{$smarty.const.ROOT_ADDRESS}/resultTourLocal/all-all/all-all/all/3">
                            نمایش تمام تورها
                            <i class="fa-solid fa-arrow-left"></i>
                        </a>
                        {*                    <a class="btn-more--new showMoreRecentTour" href="javascript:">*}
...
{*                                            {/if}*}
                                     ...
                                     <span class="Money_color font-weight-bold">
                                         <i class="fa-light fa-sack-dollar"></i>
                                          ...
                                          {if $item['min_price_r'] != 0}
                                              {$item['min_price_r']|number_format}  {if $item['min_price']['is_toman'] == true}
                                              تومان
                                          {else}
                                              ریال
                                          {/if}
                ...
                <div class="tab-pane fade" id="pills-last-minute" role="tabpanel"
                     aria-labelledby="pills-last-minute-tab">
                    <div class="tour-list-component">
                        <div class="tours_titr">
                            <div class="d-flex flex-wrap w-100">
                                <div class="col border_my">
...
{*                                            {/if}*}
                        ...
                        {/foreach}
                        <a class="btn-more--new"
                           href="{$smarty.const.ROOT_ADDRESS}/resultTourLocal/all-all/all-all/all/6">
                            نمایش تمام تورها
                            <i class="fa-solid fa-arrow-left"></i>
                        </a>
                        {*                    <a class="btn-more--new showMoreRecentTour" href="javascript:">*}
