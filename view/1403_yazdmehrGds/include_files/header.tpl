{load_presentation_object filename="yazdmehrGds" assign="obj_main_page" subName="customers"}
...
<head>
    ...
    {literal}
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-KTE0G0YQ3Z"></script>
        <script>
          window.dataLayer = window.dataLayer || [];
          function gtag(){dataLayer.push(arguments);}
          gtag('js', new Date());

          gtag('config', 'G-KTE0G0YQ3Z');
        </script>
    {/literal}
