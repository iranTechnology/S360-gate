            ...
            <div class="col-lg-3 col-sm-6 service_item">
                <div class="service-item site-bg-main-color">
                    <div class="service-item-icon">
                        <svg class="site-bg-svg-color" id="Capa_1" style="enable-background:new 0 0 512.004 512.004"
                             version="1.1"
                    ...
                    <span class="service-item-title">امنیت</span>
                    <p>کلیه خدمات ما از مرحله جستجو تا مرحله خرید با دقت خاصی بررسی می شود در صورت بروز هرگونه خطای ناشی از کار، ما تمام خسارات وارده به شما را جبران خواهیم کرد. </p>
                </div>
            </div>
            <div class="col-lg-3 col-sm-6 service_item">
                <div class="service-item site-bg-main-color">
                    ...
                    <span class="service-item-title">پشتیبانی 24 ساعته</span>
                    <p>در هر ساعتی از شبانه روز و در هر کجای دنیا که باشید از طریق چت و تماس تلفنی ما را خواهید دید تا از خرید خود مطمئن شوید. </p>
                </div>
            </div>
            <div class="col-lg-3 col-sm-6 service_item">
                <div class="service-item site-bg-main-color">
                    ...
                    <span class="service-item-title">بهترین قیمت</span>
                    <p>یک تحقیق کوتاه به شما تایید می کند که قیمت های ما و خدماتی که ارائه می دهیم مناسب ترین و بهترین هستند. </p>
                </div>
            </div>
            <div class="col-lg-3 col-sm-6 service_item">
                <div class="service-item site-bg-main-color">
                    ...
                    <span class="service-item-title">تجربه و تخصص</span>
                    <p>بیش از نیم قرن تجربه در ارائه خدمات گردشگری، فروش بلیط، ارائه تور و صدور ویزا در ایران و خارج از کشور. </p>
                </div>
            </div>
        </div>
    </div>
