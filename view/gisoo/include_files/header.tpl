...
{load_presentation_object filename="gisoo" assign="obj_main_page" subName="customers"}
...
<meta content="ie=edge" http-equiv="X-UA-Compatible"/>
    ...
    <script type="text/javascript">
      !function(){var i="Db7DwK",a=window,d=document;function g(){var g=d.createElement("script"),s="https://www.goftino.com/widget/"+i,l=localStorage.getItem("goftino_"+i);g.async=!0,g.src=l?s+"?o="+l:s;d.getElementsByTagName("head")[0].appendChild(g);}"complete"===d.readyState?g():a.attachEvent?a.attachEvent("onload",g):a.addEventListener("load",g,!1);}();
    </script>
    {/literal}
...
<script src="assets/datepicker/datepicker-declarations.js" type="text/javascript"></script>
    ...
    {if $smarty.const.GDS_SWITCH eq 'page' || $smarty.const.GDS_SWITCH eq 'mainPage'}
