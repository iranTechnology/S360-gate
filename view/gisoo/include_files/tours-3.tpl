...
{assign var="tour_params_internal" value=['type'=>'special','limit'=> '20','dateNow' => $dateNow, 'country' =>'internal']}
...
{assign var="max_internal_internal" value=20}
            ...
            <div class="parent-tour-gisoo">
                <div class="title-gisoo">
                    <div class="text-title-gisoo">
                        <h2>تورهای محبوب داخلی </h2>
                        <p>کنار گذاشتن دنیا، تورهای داخلی پرطرفدار برای لذت بردن از زیبایی‌های کشورمان</p>
                    </div>
                ...
                <div class="parent-tab-tour">
                    <div class="owl-carousel owl-theme owl-tour-gisoo">
