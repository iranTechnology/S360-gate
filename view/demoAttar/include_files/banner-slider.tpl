...
'flight-attar'=>'specialFlightPic',
'hotel-attar'=> 'specialHotelPic',
'train-attar' => 'specialTrainPic',
'bus-attar' =>'specialBusPic',
'tour-attar' =>'specialTourPic',
'insurance-attar' =>'specialInsurancePic',
'visa-attar' =>'specialVisaPic',
'gasht-attar' =>'specialGashtPic',
'package-attar' =>'specialPackagePic',
'rentCar-attar' =>'specialCarPic',
'entertainment-attar' =>'specialEntertainmentPic',
...
<script>
    ...
    if($(window).width() > 576){
        ...
        {if $specialFlightPic}
        {literal}
        $('.Flight-tab-pic').click(function () {$('.banner-safiran').css('background-image' , 'url("{/literal}{$specialFlightPic}{literal}")')});
        {/literal}
        {/if}
        {if $specialHotelPic}
        {literal}
        $('.Hotel-tab-pic').click(function () {$('.banner-safiran').css('background-image' , 'url("{/literal}{$specialHotelPic}{literal}")')});
        {/literal}
        {/if}
        {if $specialTrainPic}
        {literal}
        ...
        {if $specialTourPic}
        {literal}
        $('.Tour-tab-pic').click(function () {$('.banner-safiran').css('background-image' , 'url("{/literal}{$specialTourPic}{literal}")')});
        {/literal}
        {/if}
        {if $specialInsurancePic}
        {literal}
        $('.Insurance-tab-pic').click(function () {$('.banner-safiran').css('background-image' , 'url("{/literal}{$specialInsurancePic}{literal}")')});
        {/literal}
        {/if}
        {if $specialVisaPic}
        {literal}
        ...
        {if $specialCarPic}
        {literal}
        $('.Europcar-tab-pic').click(function () {$('.banner-safiran').css('background-image' , 'url("{/literal}{$specialCarPic}{literal}")')});
        {/literal}
        {/if}
        {if $specialPackagePic}
        {literal}
        $('.Package-tab-pic').click(function () {$('.banner-safiran').css('background-image' , 'url("{/literal}{$specialPackagePic}{literal}")')});
        {/literal}
        {/if}
