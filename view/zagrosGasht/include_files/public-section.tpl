...
{*                                class="cta "><span>##S360UserRegister##</span></a></div>*}
                ...
                <div class="links_box date_convert shamsiConvertDate">
                    ...
                    <div class="captin_box">
                        <div class="form__group field">
                            ...
                            <input value="" type="text" readonly="" class="form__field  custom-date convertShamsiMiladiCalendar"
                        ...
                        <div class="form__group field">
                            ...
                            <input type="text" readonly="" class="form__field  custom-date convertMiladiShamsiCalendar"
            ...
            <div class="col-lg-4 col-md-4 meteorology">
                <div class="links_box">
                    <div class=" flatbox">
