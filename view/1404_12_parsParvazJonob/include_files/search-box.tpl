...
<section class="banner-kanoun i_modular_banner_gallery">
    ...
    <div class="container">
        <div class="parent-text-banner">
            <h2>آژانس مسافرتی پارس پرواز جنوب</h2>
            <p class="__title_class__">آسمانی پر از رویاها، سفر به دنیایی از حس‌ها و لحظه‌های بی‌نظیر </p>
        </div>
