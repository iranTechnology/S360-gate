...
<button class="btn theme-btn seub-btn b-0" onclick="searchInternalHotel()" type="button"><span>Search</span></button>
</div>
</form>
</div>
...
<div class="col-lg-2 col-md-3 col-sm-6 col-12 btn_s col_search margin-center p-1">
<input class="nights-hotel-js" id="nights_hotel" name="nights_hotel" placeholder="Check Out" type="hidden" value=""/>
<button class="btn theme-btn seub-btn b-0" onclick="searchInternationalHotel()" type="button"><span>Search</span></button>
</div>
</form>
</div>
