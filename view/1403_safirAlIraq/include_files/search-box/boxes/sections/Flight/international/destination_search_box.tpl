...
<input autocomplete="off" class="inputSearchForeign form-control iata-destination-international-js" id="iata_destination_international" name="iata_destination_international" onclick='displayCityListExternal("destination" , event)' placeholder="Destination (city, airport)" type="text"/>
</span>
