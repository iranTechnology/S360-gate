...
{if $smarty.session.layout neq 'pwa'}
    {if $smarty.const.GDS_SWITCH neq $smarty.const.ConstPrintHotel && $smarty.const.GDS_SWITCH neq $smarty.const.ConstPrintTicket && $smarty.const.GDS_SWITCH neq $smarty.const.ConstPrintHotelReservation && $smarty.const.GDS_SWITCH neq $smarty.const.ConstPrintHotelReservationAhuan}
        <footer class="i_modular_footer {if $smarty.const.GDS_SWITCH neq 'mainPage' } mt-5 {/if}">
                            ...
                            <div class="item-footer col-lg-4 col-md-6 col-sm-12 col-12">
                                <div class="parent-item-footer parent-item-footer-responsive">
                                    <div class="img-box-footer">
                                        <img alt="footer-logo" src="project_files/images/logo-footer.png" />
                                    </div>
...
{*                                        </li>*}
                            ...
                            <div class="item-footer col-lg-4 col-md-12 col-sm-12 col-12 order-foot2">
                                <div class="parent-namad box-item-footer text-right">
{*                                    <h3 class="my-footer-icon">*}
{*                                        Permissions*}
{*                                    </h3>*}
