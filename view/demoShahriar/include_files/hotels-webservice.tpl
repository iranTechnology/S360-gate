...
<div aria-labelledby="tab-hotel-dakheli-demo" class="tab-pane fade show active __hotel__internal__" id="hotel-dakheli-demo" role="tabpanel">
<div class="owl-carousel owl-theme owl-hotels">
    {foreach $internal_hotels as $item}

    <div class="item __i_modular_nc_item_class_0">
<a class="hotel-card __link__" href="{$smarty.const.ROOT_ADDRESS}/detailHotel/api/{$item['HotelIndex']}">
<div class="parent-hotels">
...
<span class="__star_class_light__1">{$item['StarCode']} ستاره </span>
</div>
</div>
...
<div aria-labelledby="tab-hotel-khareji-demo" class="tab-pane fade __hotel__external__" id="hotel-khareji-demo" role="tabpanel">
<div class="owl-carousel owl-theme owl-hotels">
    {foreach $foregin_hotels as $item}

    <div class="item __i_modular_nc_item_class_0">
<a class="hotel-card __link__" href="{$smarty.const.ROOT_ADDRESS}/resultExternalHotel/{$item['CountryEn']}/{$item['DepartureCityEn']}/{$objDate->daysAfterToday('7')}/{$objDate->daysAfterToday('8')}/1/R:2-0-0">
<div class="parent-hotels">
