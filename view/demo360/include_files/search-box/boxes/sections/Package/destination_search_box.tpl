<div class="col-lg-2 col-md-6 col-sm-6 col-12 col_search search_col p-1">
    <div class="">
        <div class="parent-input-search-box destination_start">
            ...
            <label for='iata_destination_package' class="caption-input-search-box">مقصد خود را وارد کنید</label>
            <input type="text" id="iata_destination_package" name="iata_destination_package" class="inputSearchForeign iata-destination-package-js" placeholder="مقصد ( شهر )" autocomplete="off">
            <input id="destination_package" type="hidden" value="" name="destination_package" class="destination-package-js">
            ...
            <div class="resultUlInputSearch list-show-result list_popular_package_destination-js" id="list_destination_popular_package"></div>
        </div>
    </div>
</div>