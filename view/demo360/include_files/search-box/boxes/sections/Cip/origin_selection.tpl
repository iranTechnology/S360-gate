{$col}
<div class="{if isset($col) } {$col} {else} col-lg-2{/if} col-md-6 col-sm-6 col-12 col_search col_with_route">
    <div class="form-group">
        <div class="form-group origin_start">
            <div class="parent-input-search-box origin_start">
                ...
                <div class="caption-input-search-box">نام فرودگاه را وارد کنید</div>
            <input
                    type="text"
                    id="route_origin_all"
