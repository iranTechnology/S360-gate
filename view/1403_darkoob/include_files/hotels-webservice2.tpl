...
{*                <ul class="nav nav-pills external01" id="pills-tab" role="tablist">*}

{*                    <li class="nav-item" role="presentation">*}
{*                        <button class="nav-link button01 active" id="tab-hotel-khareji-demo" data-toggle="pill" data-target="#hotel-khareji-demo"*}
{*                                type="button" role="tab" aria-controls="hotel-khareji-demo" aria-selected="false"> خارجی*}
{*                        </button>*}
{*                    </li>*}

{*                    <li class="nav-item" role="presentation">*}
{*                        <button class="nav-link button01" id="tab-hotel-dakheli-demo" data-toggle="pill" data-target="#hotel-dakheli-demo"*}
{*                                type="button" role="tab" aria-controls="hotel-dakheli-demo" aria-selected="true"> داخلی*}
{*                        </button>*}
{*                    </li>*}
{*                </ul>*}
...
{*                        <div class="tab-pane fade" id="hotel-dakheli-demo" role="tabpanel" aria-labelledby="tab-hotel-dakheli-demo">*}
                            <div class='box-hotel-popular'>
                                <div class="owl-carousel owl-theme __hotel__internal__ owl-hotel-ghods">
                                    {foreach $list_city_hotel as $key=>$item}
                                        {if $key<20}
                                            <a href="{$smarty.const.ROOT_ADDRESS}/searchHotel&type=new&city={$item['id']}&startDate={$objDate->jtoday()}&nights=3&rooms=R:2-0-0" class="link-parent item">
...
{*                        <div class="tab-pane fade show active" id="hotel-khareji-demo" role="tabpanel" aria-labelledby="tab-hotel-khareji-demo">*}
{*                        <div class='box-hotel-popular'>*}
{*                            <div class="owl-carousel owl-theme __hotel__internal__ owl-hotel-ghods">*}
{*                                {foreach $list_city_hotel as $key=>$item}*}
{*                                    {if $key<20}*}
