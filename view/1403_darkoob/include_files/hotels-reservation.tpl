...
{assign var=dateNow value=dateTimeSetting::jdate("Ymd", "", "", "", "en")}
{assign var="internal_hotel_params" value=['limit'=> '20', 'country' =>'external']}
                ...
                <div class="parent-data-hotel-tab-demo">
                    <ul class="nav nav-pills" id="pills-tab-hotel" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button aria-controls="tour-khareji-demo" aria-selected="false" class="nav-link active"
                        ...
                        <li class="nav-item" role="presentation">
                            <button aria-controls="tour-dakheli-demo" aria-selected="true" class="nav-link"
