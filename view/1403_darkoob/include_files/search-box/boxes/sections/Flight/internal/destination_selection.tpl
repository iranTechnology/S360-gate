...
<input autocomplete="off" class="inputSearchForeign input-search-box route_destination_internal-js" id="route_destination_internal" name="route_destination_internal" onclick="displayCityList('destination')" placeholder="مقصد ( شهر )" type="text"/>
