<div class="__box__ tab-pane {if  $smarty.const.GDS_SWITCH eq 'page'} active {/if} active" id="Hotel">
    <h4 class='title-searchBox-mobile'>جستجو برای هتل های داخلی و خارجی</h4>
    <div class="d-flex flex-wrap gap-search-box">
        <div class="cheng-internal-external" id="dropdown-hotel-internal-external" onclick="toggleDropdownHotel()">
            <h4 id="toggle-text-hotel">خارجی</h4>
            <svg id="dropdown-icon-hotel" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
            ...
            <ul id="hotel-dropdown" class="money-filter_ul arrow-up2">
                <li>
                    <div class="switch-btn-js" data-main="flight-toggle-js" data-target="international_flight" onclick="selectOptionBtnInternalExternalHotel('خارجی', 'external')">
                        خارجی
                    </div>
                </li>
                <li>
                    <div class="switch-btn-js" data-main="flight-toggle-js" data-target="internal_flight" onclick="selectOptionBtnInternalExternalHotel('داخلی', 'internal')">
                        داخلی
                    </div>
                </li>
            </ul>
        ...
        <div id="internal_hotel" class="_internal flex-wrap internal-hotel-js internal-content-hotel w-100">
        ...
        <div id="international_hotel" class="_external d_flex flex-wrap international-hotel-js external-content-hotel w-100">
