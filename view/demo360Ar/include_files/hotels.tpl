    ...
    <div class="container" style="position: relative; z-index: 2">
        <div class="title-demo">
            <div class="text-title-demo">
                <h2>الفنادق</h2>
                <p>
                    الراحة والمتعة في قلب المعالم الحضرية، فندقنا ينتظر حضوركم
                </p>
            </div>
            <a href="{$smarty.const.ROOT_ADDRESS}/page/hotel" class="more-title-demo">
                <span>المزيد من الفنادق</span>
        ...
        <div>
            ...
            <div class="owl-carousel owl-theme __hotel__internal__ owl-hotel-ghods">
                ...
                <div class="item">
                    <a href="{$smarty.const.ROOT_ADDRESS}/resultExternalHotel/{$item['CountryEn']}/{$item['DepartureCityEn']}/{$objDate->daysAfterToday('7')}/{$objDate->daysAfterToday('8')}/1/R:2-0-0" class="__i_modular_nc_item_class_1 link-parent">
...
{*                <div class="item">*}
{*                    <a href="{$smarty.const.ROOT_ADDRESS}/detailHotel/api/{$item['HotelIndex']}" class="__i_modular_nc_item_class_2 link-parent">*}
