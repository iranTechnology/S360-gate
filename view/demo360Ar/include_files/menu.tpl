            ...
            <nav class="navigation d-flex align-items-center">
                ...
                <div class="nav-menus-wrapper">
                    <ul class="nav-menu">
                        ...
                        <li><a href="{$smarty.const.ROOT_ADDRESS}/page/bus">حافلة</a></li>
                        <li><a href="{$smarty.const.ROOT_ADDRESS}/page/visa">فيزا</a>
                            <ul class="nav-dropdown">
                                ...
                                <li><a href="{$smarty.const.ROOT_ADDRESS}/page/visa">البحث عن التأشيرة</a></li>
                            </ul>
                        </li>
