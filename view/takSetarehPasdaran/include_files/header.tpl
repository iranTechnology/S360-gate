...
{load_presentation_object filename="takSetarehPasdaran" assign="obj_main_page" subName="customers"}
...
<link rel="stylesheet" href="project_files/css/owl.carousel.min.css"><link rel="stylesheet" href="project_files/css/rangeslider.css">
