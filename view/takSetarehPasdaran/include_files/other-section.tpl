    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-3 col-md-6 p-2">
                <div class="links_box">
                    <div class="icon_box flatbox">
                        <svg enable-background="new 0 0 512.004 512.004" height="512" id="Capa_1"
                    ...
                    <a class="ttt" href="javascript:">باشگاه مسافران</a>
                    <div class="captin_box">
                        <p>دنیای پر رقابت امروز، تنها شرکت هایی موفق خواهند بود که در مسیر شناخت نیاز مسافران خود
                            گام
                            برداشته باشند</p>
                    </div>
                    <div class="links_btn">
                        {if $obj_main_page->isLogin()}
                            <a class="cta" href="{$smarty.const.ROOT_ADDRESS}/profile">
                                <span>ورود </span>
                            </a>
                        {else}
                        <a class="cta" href="{$smarty.const.ROOT_ADDRESS}/authenticate">
                            <span>ورود </span>
                        </a>
                        <a class="cta" href="{$smarty.const.ROOT_ADDRESS}/authenticate">
                            <span>ثبت نام </span>
            ...
            <div class="col-lg-3 col-md-6 p-2">
                <div class="links_box">
                    <div class="flatbox">
                        <svg enable-background="new 0 0 64 64" height="512" id="Layer_5" viewbox="0 0 64 64"
                    ...
                    <a class="ttt" href="{$smarty.const.ROOT_ADDRESS}/weather"> هواشناسی</a>
                    <div class="captin_box">
                        <p>توسط این بخش می تواند منطقه یا مناطق جغرافیایی را جهت نمایش وضعیت آب هوایی انتخاب
                            نماید.تا در
                            زمان گردش بیشترین لذت را از مسافرت خود داشته باشید.</p>
                    </div>
                    <div class="links_btn">
                        <a class="cta SMWeather" href="{$smarty.const.ROOT_ADDRESS}/weather">
                            <span>هواشناسی </span>
                        </a>
                    </div>
                </div>
            ...
            <div class="col-lg-3 col-md-6 p-2">
                <div class="links_box">
                    <div class="icon_arz flatbox">
                        <svg id="Capa_1" style="enable-background:new 0 0 496 496;" version="1.1"
                             viewbox="0 0 496 496" x="0px" xml:space="preserve" xmlns="http://www.w3.org/2000/svg"
                             y="0px">
<g>
    <g>
        <path d="M264,336h-32c-8.824,0-16-7.176-16-16c0-8.824,7.176-16,16-16h32c8.824,0,16,7.176,16,16h16c0-17.648-14.352-32-32-32h-8
                                                    v-16h-16v16h-8c-17.648,0-32,14.352-32,32s14.352,32,32,32h32c8.824,0,16,7.176,16,16c0,8.824-7.176,16-16,16h-32
                                                    c-8.824,0-16-7.176-16-16h-16c0,17.648,14.352,32,32,32h8v16h16v-16h8c17.648,0,32-14.352,32-32S281.648,336,264,336z"></path>
    </g>
</g>
                            <g>
                                <g>
			...
			s120,53.832,120,120C256,171.696,251.104,191.048,241.92,208.312z"></path>
                                </g>
                            </g>
                            <g>
                                <g>
                                    <path d="M360,208c-13.232,0-24-10.768-24-24v-8h16v-16h-16v-16h16v-16h-16v-8c0-13.232,10.768-24,24-24s24,10.768,24,24h16
			c0-22.056-17.944-40-40-40c-22.056,0-40,17.944-40,40v8h-16v16h16v16h-16v16h16v8c0,22.056,17.944,40,40,40
			c22.056,0,40-17.944,40-40h-16C384,197.232,373.232,208,360,208z"></path>
                                </g>
                            </g>
                            <g>
                                <g>
                                    <polygon points="144,138.96 190.072,85.208 177.928,74.792 136,123.704 94.072,74.792 81.928,85.208 128,138.96 128,160 112,160
			...
			144,160 		"></polygon>
                    ...
                    <a class="ttt SMChange" href="javascript:"> نرخ ارز</a>
                    <div class="captin_box">
                        <p>
                            توسط این بخش شما می تواند بروز ترین ، آخرین نرخ لحظه ای ارزهای انتخابی خود را بر اساس
                            ارز
                            مرجع،مشاهده نمایید. تا در زمان گردش بیشترین لذت را از مسافرت خود داشته باشید
                        </p>
                    </div>
                    <div class="links_btn">
                        <a class="cta SMChange" href="{$smarty.const.ROOT_ADDRESS}/currency">
                            <span>نرخ ارز </span>
                        </a>
                    </div>
                </div>
