   ...
   <div class="container">
    <div class="parent-about-namad-footer">
     <div class="namads">
      ...
      <a>
       <img referrerpolicy='origin' id = 'rgvjsizpapfuwlaofukzjzpe' style = 'cursor:pointer' onclick = 'window.open("https://logo.samandehi.ir/Verify.aspx?id=395467&p=xlaopfvldshwaodsgvkajyoe", "Popup","toolbar=no, scrollbars=no, location=no, statusbar=no, menubar=no, resizable=0, width=450, height=630, top=30")' alt = 'logo-samandehi' src = 'https://logo.samandehi.ir/logo.aspx?id=395467&p=qftibsiyujynshwlwlbqyndt' />
      </a>

      <a href="javascript:">
       <img alt="" src="project_files/images/enamad.png"/>
      </a>
     </div>
