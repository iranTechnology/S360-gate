...
{*                        </li>*}
                        ...
                        <li>
                            ...
                            <ul class="nav-dropdown nav-submenu">
                                <li><a href="{$smarty.const.ROOT_ADDRESS}/page/alanya-hotels">هتل آلانیا</a></li>
                                <li><a href="{$smarty.const.ROOT_ADDRESS}/page/marmaris-hotels">هتل مارماریس</a>
                                </li>
                                <li><a href="{$smarty.const.ROOT_ADDRESS}/page/konya-hotels">هتل قونیه</a>
                                </li>
                                <li><a href="{$smarty.const.ROOT_ADDRESS}/page/cappadocia-hotels">هتل کاپادوکیا</a></li>
                            </ul>
                        </li>

                        <li>
                            <a href="{$smarty.const.ROOT_ADDRESS}/mag">مجله دنیز گشت</a>
                        </li>

                        <li>
                            <a href="{$smarty.const.ROOT_ADDRESS}/faq">پرسشهای متداول </a>
                        </li>
