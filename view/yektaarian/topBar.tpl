...
<div class="sup-menu-flex">
    <div class="sup-menu-flex-r">
        <a target="_parent" class="log-reg-sub" href="http://{$smarty.const.CLIENT_MAIN_DOMAIN}/fa/user/temp.php?irantech_parvaz=login">
            <div>
                <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
            ...
            <span class="site-bg-main-color">ورود به ناحیه کاربری</span>
        </a>
    </div>
    <div class="sup-menu-flex-l">
        <a target="_parent" class="log-reg-sub" href="http://{$smarty.const.CLIENT_MAIN_DOMAIN}/fa/user/temp.php?irantech_parvaz=register">
            <div>
                <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                     viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
