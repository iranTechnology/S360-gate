...
<header class="i_modular_menu header_area   {if $smarty.const.GDS_SWITCH neq 'mainPage' && $smarty.const.GDS_SWITCH neq 'page'} header_2 {/if}">
...
<nav class="navigation d-flex align-items-center">
    <div class="nav-header">
        <a class="d-flex align-items-center" href="https://{$smarty.const.CLIENT_MAIN_DOMAIN}">
          <img alt="{$obj->Title_head()}" class="__logo_class__" height="50px" src="project_files/images/logo.png"/>
        </a>
    </div>
    <div class="nav-menus-wrapper">
            <ul class="nav-menu">
            <li><a href="{$smarty.const.ROOT_ADDRESS}/page/flight">هواپیما</a></li>
            <li><a href="{$smarty.const.ROOT_ADDRESS}/page/tour">تور</a>
                ...
                <li><a href="javascript:">داخلی</a>
                    ...
                    <ul class="nav-dropdown">
                        ...
                        {/foreach}
                    <li><a href="{$smarty.const.ROOT_ADDRESS}/resultTourLocal/1-all/1-all/all/all/0">نمایش همه</a></li>
                    </ul>
                    {/if}
                </li>
                <li><a href="javascript:">خارجی</a>
                    ...
                    <ul class="nav-dropdown">
                        ...
                        {/foreach}
                        {*<li><a href="javascript:">نمایش همه</a></li>*}
                    </ul>
                    {/if}
                </li>
                </ul>
