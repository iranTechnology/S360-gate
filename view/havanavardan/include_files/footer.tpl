 ...
 <div class="footer_main container">
  <ul class="m-0 p-0 d-flex">
   <li class="col-12 col-md-6 my-4 col-lg-4 call">
    ...
    <div class="namads">
     <a href="https://farasa.cao.ir/sysworkflow/fa/modern/3810212626028ab03488017019616799/6464336316028ab04e3c618028352200.php">
      <img alt="Enamad1" src="https://www.iran-tech.com/under_construction/ava/ava2/images/certificate1.png"/>
     </a>
     <a href="https://caa.gov.ir/">
      <img alt="namad-1" src="https://www.iran-tech.com/under_construction/ava/ava2/images/certificate5.png"/>
     </a>
     <a referrerpolicy='origin' target='_blank' href='https://trustseal.enamad.ir/?id=494494&Code=eIo1QRuDx9UVp8jYqwvEBr2LABUHfDtY'><img referrerpolicy='origin' src='https://trustseal.enamad.ir/logo.aspx?id=494494&Code=eIo1QRuDx9UVp8jYqwvEBr2LABUHfDtY' alt='' style='cursor:pointer' code='eIo1QRuDx9UVp8jYqwvEBr2LABUHfDtY'></a>
     <a href="http://www.aira.ir/">
      <img alt="namad-3" src="https://www.iran-tech.com/under_construction/ava/ava2/images/certificate4.png"/>
     </a>
    </div>
   </li>
   <li class="d-none d-md-block col-12 col-md-6 my-4 col-lg-4">
    ...
    <div class="asan">
     <a class="asan_link" href="{$smarty.const.ROOT_ADDRESS}/page/flight">
      هواپیما
     </a>
     <a class="asan_link" href="{$smarty.const.ROOT_ADDRESS}/page/tour">
      تور
     </a>
     <a class="asan_link" href="{$smarty.const.ROOT_ADDRESS}/page/hotel">
      هتل
     </a>
     <a class="asan_link" href="{$smarty.const.ROOT_ADDRESS}/page/bus">
      اتوبوس
     </a>
     <a class="asan_link" href="{$smarty.const.ROOT_ADDRESS}/mag">
      وبلاگ
     </a>
     <a class="asan_link" href="{$smarty.const.ROOT_ADDRESS}/news">
      اخبار سایت
     </a>
