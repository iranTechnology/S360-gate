                ...
                <div class="container">
                    <div class="row">
                        <div class="parent-footer-iran d-flex flex-wrap w-100">
                            ...
                            <div class="item-footer col-lg-4 col-md-6 col-sm-12 col-12">
                                <div class="box-item-footer parent-item-footer parent-item-footer-responsive">
...
{*                                    </div>*}
                                    ...
                                    <div class="child-item-footer align-items-start">
                                        <div class='parent-address-tow'>
                                            ...
                                            <div class=''>
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><!--! Font Awesome Pro 6.3.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path d="M336 192c0-79.5-64.5-144-144-144S48 112.5 48 192c0 12.4 4.5 31.6 15.3 57.2c10.5 24.8 25.4 52.2 42.5 79.9c28.5 46.2 61.5 90.8 86.2 122.6c24.8-31.8 57.8-76.4 86.2-122.6c17.1-27.7 32-55.1 42.5-79.9C331.5 223.6 336 204.4 336 192zm48 0c0 87.4-117 243-168.3 307.2c-12.3 15.3-35.1 15.3-47.4 0C117 435 0 279.4 0 192C0 86 86 0 192 0S384 86 384 192zm-160 0a32 32 0 1 0 -64 0 32 32 0 1 0 64 0zm-112 0a80 80 0 1 1 160 0 80 80 0 1 1 -160 0z"/></svg>
                                                <span>
                                            خوزستان ، دزفول ، خیابان دکتر شریعتی ، پلاک159
                                    </span>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="item-footer col-lg-4 col-md-6 col-sm-12 col-12">
                                <div class="parent-namad box-item-footer text-right">
                                    ...
                                    <div class="namads">
                                        ...
                                        <a href="https://aira.ir/"><img src="project_files/images/certificate3.png" alt="namad-2"></a>
                                        <a referrerpolicy='origin'
                                           target='_blank'
                                           href='https://trustseal.enamad.ir/?id=459542&Code=j4RdhBHNuaH9ZJO4pDpHYA0rlVgkDtmr'>
                                            <img referrerpolicy='origin'
                                                 src='https://trustseal.enamad.ir/logo.aspx?id=459542&Code=j4RdhBHNuaH9ZJO4pDpHYA0rlVgkDtmr'
                                                 alt=''
                                                 style='cursor:pointer'
                                                 Code='j4RdhBHNuaH9ZJO4pDpHYA0rlVgkDtmr'>
                                        </a>
                                    </div>
            ...
            <div class="last_text col-12">
                <div class='container parent-iran-doka'>
                    <div class='parent-doka'>
                        <p>تمامی حقوق این وبسایت متعلق به شرکت دوکاتور میباشد.</p>
                    </div>
