...
$(document).ready(function () {
    ...
    $('#number_of_passengers').on('change', function (e) {
        ...
        while (i < itemInsu) {
            ...
            HtmlCode += "<div class='col-lg-2 col-md-3 col-6 col_search search_col nafarat-bime '>" +
                ...
                "<input placeholder='مسافر's date of birth " + i + "' autocomplete='off' type='text' name='txt_birth_insurance" + i + "' id='txt_birth_insurance" + i + "' class='shamsiBirthdayCalendar form-control' />" +
    ...
    $(".minus-nafar").click(function () {
        ...
        if (nafarnozad2 == 0 && nafarkoodak2 == 0) {
            let allNafarat = nafarbozorg2 + nafarkoodak2 + nafarnozad2;$(this).parents(".box-of-count-nafar").find(".text-count-nafar").text(allNafarat + " مسافر ");
        } else {
            let allNafarat = nafarbozorg2 + nafarkoodak2 + nafarnozad2;$(this).parents(".box-of-count-nafar").find(".text-count-nafar").text(allNafarat + " مسافر ");
        }
    });
