     ...
     <div class="item-footer col-lg-3 col-md-3 col-sm-4 col-12 order-foot1 text-center">
      <div class="parent-item-footer parent-item-footer-responsive">
       <div class="img-box-footer">
        <img alt="footer-logo" class="__logo_class__" src="project_files/images/logo-bottom.png"/>
       </div>
   ...
   <div class="container">
    <div class="parent-about-namad-footer">
     <div class="namads">
      ...
      <a referrerpolicy='origin' target='_blank' href='https://trustseal.enamad.ir/?id=709110&Code=tdlKkl3V228cT3sNHY8GmwMvO7H4zqfv'><img referrerpolicy='origin' src='https://trustseal.enamad.ir/logo.aspx?id=709110&Code=tdlKkl3V228cT3sNHY8GmwMvO7H4zqfv' alt='' style='cursor:pointer' code='tdlKkl3V228cT3sNHY8GmwMvO7H4zqfv'></a>
     </div>
