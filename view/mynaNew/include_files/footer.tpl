...
{assign var="phones" value="-"|explode:$smarty.const.CLIENT_PHONE}
  ...
  <div class="container">
   <div class="row">
    <div class="parent-footer-iran d-flex flex-wrap w-100">
     <div class="item-footer col-lg-2 col-md-4 col-sm-4 col-12 order-foot2">
     ...
     <div class="item-footer col-lg-2 col-md-4 col-sm-4 col-12">
      <div class="box-item-footer text-right">
       <h3>
        دانستنیها
       </h3>
     ...
     <div class="item-footer col-lg-2 col-md-4 col-sm-4 col-12 display-footer-none">
      <div class="box-item-footer text-right">
       <h3>
        آژانس ما
       </h3>
     ...
     <div class="item-footer col-lg-3 col-md-6 col-sm-4 col-12">
      <div class="box-item-footer text-right">
       <h3>
        دسترسی آسان
       </h3>
       <ul>
        ...
        <li>
         <a href="https://sadadpsp.ir/TollPayment/UploadFile">
     ...
     <div class="item-footer col-lg-3 col-md-6 col-sm-12 col-12 order-foot1 text-center">
      <div class="parent-item-footer parent-item-footer-responsive">
       ...
       <div class="child-item-footer">
        <a class="__phone_class__" href="tel:{$phones[3]}">
         {$phones[3]}
        </a>
       </div>
       ...
       <div class="__social_class__ footer-icon my-footer-icon">
        ...
        <a class="__whatsapp_class__ fa-brands fa-youtube footer_whatsapp" href="{if $whatsappHref}{$whatsappHref}{/if}" target="_blank">
        </a>
        <a class="__aparat_class__ footer_linkedin" href="{if $aparatHref}{$aparatHref}{/if}" target="_blank">
   ...
   <div class="container">
    <div class="parent-about-namad-footer">
     <div class="namads">
      ...
      <a href="https://sadadpsp.ir/TollPayment/UploadFile">
       <img alt="namad-4" src="project_files/images/certificate4.png"/>
      </a>
     </div>
 ...
 <div class="footer-mobile">
  ...
  <div aria-multiselectable="true" id="accordion-faq" role="tablist">
   ...
   <div class="panel panel-default card">
    <div class="panel-heading card-header" id="heading-faq-1" role="tab">
     <h4 class="panel-title mb-0 parent-accordion">
      <a aria-controls="Collapse-faq-4" aria-expanded="false" class="btn-link w-100 collapsed" data-parent="#accordion-faq" data-toggle="collapse" href="#Collapse-faq-4">
       دسترسی آسان
       <i class="fa icone-arrow">
       </i>
      </a>
    ...
    <div aria-labelledby="heading-faq-4" class="panel-collapse collapse" id="Collapse-faq-4" role="tabpanel" style="">
     <ul class="ul-footer-mobile">
      <li>
       <a href="https://mynatravel.ir">
        سامانه سپهر
  ...
  <div class="parent-item-footer parent-item-footer-responsive">
   ...
   {/foreach}
   <div class="__social_class__ footer-icon my-footer-icon">
    <a class="fab fa-telegram footer_telegram" href="{if $telegramHref}{$telegramHref}{/if}" target="_blank">
    </a>
    <a class="fab fa-instagram footer_instagram" href="{if $instagramHref}{$instagramHref}{/if}" target="_blank">
    </a>
    <a class="fa-brands fa-youtube footer_whatsapp" href="{if $whatsappHref}{$whatsappHref}{/if}" target="_blank">
    </a>
    <a class="footer_linkedin" href="{if $aparatHref}{$aparatHref}{/if}" target="_blank">
     <img alt="aparat" class="icon-img" src="project_files/images/aparat.png"/>
    </a>
   </div>
  </div>
