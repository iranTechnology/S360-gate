                ...
                <div class="nav-menus-wrapper">
                    <ul class="nav-menu align-to-right">
                        ...
                        <li>
                            ...
                            <ul class="nav-dropd{assign var="phones" value="-"|explode:$smarty.const.CLIENT_PHONE}own nav-submenu">
                        ...
                        <li>
                            <a href="{$smarty.const.ROOT_ADDRESS}/club">باشگاه مسافران</a>
                        </li>
                    </ul>
                </div>
                <div class="parent-btn-header">
                    <a class="__phone_class__ button btn-phone btn-style" href="tel:{$phones[3]}">
                        <span>{$phones[3]}</span>
