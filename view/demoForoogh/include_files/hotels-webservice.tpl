...
{if $foregin_hotels or $internal_hotels}
    <section class="hotels i_modular_hotels_webservice">
        <div class="container">
            <div class="title">
                <div class="box-right">
                    <div class="text-title">
                        <h5>هتل های داخلی و خارجی</h5>
                        <span>  مقایسه و انتخاب بهترین هتل‌های داخلی و خارجی برای تجربه‌ای به‌یادماندنی در سفرهای شما.  </span>
                    </div>
                </div>
                <a class="more-title" href="{$smarty.const.ROOT_ADDRESS}/page/hotel">
                ...
                <div class="parent-data-hotel-tab-demo">
                    <ul class="nav nav-pills" id="pills-tab2" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button aria-controls="hotel-khareji-demo" aria-selected="false" class="nav-link active"
                        ...
                        <li class="nav-item" role="presentation">
                            <button aria-controls="hotel-dakheli-demo" aria-selected="true" class="nav-link"
                    ...
                    <div class="parent-tab-tour">
                        <div class="tab-content" id="pills-tabContent2">
                            <div aria-labelledby="tab-hotel-dakheli-demo" class="tab-pane fade"
                                 id="hotel-dakheli-demo" role="tabpanel">
                                <div class="parent-grid-box-hotel">
                                    {foreach $internal_hotels as $item}
                                        <a class="hotel-card"
                                           href="{$smarty.const.ROOT_ADDRESS}/detailHotel/api/{$item['HotelIndex']}">
                                            ...
                                            <div class="parent-box-arrow-data">
                                                ...
                                                <div class="arrow-hotels">
                                                    <svg viewbox="0 0 320 512" xmlns="http://www.w3.org/2000/svg">
                                                        <!--! Font Awesome Pro 6.3.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                                                        <path d="M24 96C10.7 96 0 106.7 0 120V360c0 13.3 10.7 24 24 24s24-10.7 24-24V177.9L279 409c9.4 9.4 24.6 9.4 33.9 0s9.4-24.6 0-33.9L81.9 144H264c13.3 0 24-10.7 24-24s-10.7-24-24-24H24z"></path>
                                                    </svg>
                                                </div>
                                            </div>
                                        </a>
                            ...
                            <div aria-labelledby="tab-hotel-khareji-demo" class="tab-pane fade show active" id="hotel-khareji-demo"
                                 role="tabpanel">
                                <div class="parent-grid-box-hotel">
