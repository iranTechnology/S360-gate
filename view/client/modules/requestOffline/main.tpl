{assign var="requested_data" value=$moduleData|json_encode}

<h3>##RequestOfflineInformMe##</h3>
<button onclick='modalRequestOffline({$requested_data})' data-target="#ModalPublic" data-toggle="modal">
...
{literal}
    <script src="assets/modules/js/requestOffline.js"></script>
{/literal}