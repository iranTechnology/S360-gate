        ...
        <nav aria-label="breadcrumb" class="w-100">
            <ol class="parent-breadcrumb-item">
                ...
                <li class="breadcrumb-item">
                    <svg width="16" height="16" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><!--! Font Awesome Pro 6.3.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path d="M272.5 5.7c9-7.6 22.1-7.6 31.1 0L464 141.9V56c0-13.3 10.7-24 24-24s24 10.7 24 24V182.6l55.5 47.1c10.1 8.6 11.4 23.7 2.8 33.8s-23.7 11.3-33.8 2.8L512 245.5V432c0 44.2-35.8 80-80 80H144c-44.2 0-80-35.8-80-80V245.5L39.5 266.3c-10.1 8.6-25.3 7.3-33.8-2.8s-7.3-25.3 2.8-33.8l264-224zM112 204.8V432c0 17.7 14.3 32 32 32h48V312c0-22.1 17.9-40 40-40H344c22.1 0 40 17.9 40 40V464h48c17.7 0 32-14.3 32-32V204.8L288 55.5 112 204.8zM336 320H240V464h96V320z"></path></svg>
                    <a class="font-13 text-dark" href="https://safar360.com">صفحه اصلی</a>
                </li>

                <li class="breadcrumb-item active align-items-center d-flex">
                    <h1 class="d-flex font-13 mb-0 site-main-text-color" href="https://safar360.com/gds/fa/organization/">ثبت نام سازمانی</h1>
                </li>
            </ol>
        </nav>
    </div>
            ...
            {foreach $list_organization as $index => $item}
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="org-card">
                        ...
                        <button class="org-register-btn" onclick="orgRegisterModule.openModal({$item.id}, '{$item.title}')">
                            <span>ثبت نام</span>
                ...
                <div class="org-form-group">
                    ...
                    <div class="org-birthday-row">
                        <div class="org-birthday-col">
                            <select class="org-form-control org-birthday-select" id="org_birthday_year" name="birthday_year" required>
                        ...
                        <div class="org-birthday-col">
                            <select class="org-form-control org-birthday-select" id="org_birthday_month" name="birthday_month" required>
                        ...
                        <div class="org-birthday-col">
                            <select class="org-form-control org-birthday-select" id="org_birthday_day" name="birthday_day" required>
...
{literal}
    <script>
        ...
        const orgRegisterModule = {
            ...
            // باز کردن مودال
            openModal: function(organizationId, organizationTitle) {
