...
{*            <div class="passengerDetailReservationTour_aside_subTitle">*}
{*                <h3>فروشنده تور</h3>*}
{*                <h4>ممد اقا</h4>*}
{*            </div>*}
            <div class="passengerDetailReservationTour_aside_lastBox">
                ...
                {if $infoTour['prepayment_percentage'] neq 0}
                    ...
                    {else}
                        {assign var="prePaymentPrice" value=$objResult->prePaymentCalculate($smarty.post.totalPrice ,$infoTour['prepayment_percentage'])}
                    {/if}
...
{*                <p>##acceptrulesregulations##</p>*}
                {if $smarty.const.GDS_SWITCH !=  'submitRequest' }
                <div class="next_tour_n_">
                    <div class="passengersDetailLocal_next">
                        ...
                        <input type="button" onclick="checkPassengerTourLocal('{$smarty.now}', '{$smarty.post.passengerCount}')"
