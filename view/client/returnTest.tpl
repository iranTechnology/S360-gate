                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="success-text">
                                    <div class="success-text-title">خرید شما با موفقیت</div>
                                    <div class="success-text-info">
                                        <p>درخواست پیش رزرو شمابا شماره فاکتور برای آژانس کارگزار ارسال شده و به شما اطمینان میدهیم در اسرع وقت همکاران پشتیبانی از همین طریق ادامه رزرو را به شما اطلاع رسانی خواهند کرد.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="panel-return">
                                    <div class="panel-return-head">
                                        <span>بلیط هواپیما تهران به استانبول</span>
                                    </div>
                                    <div class="panel-return-content">
                                        <div><span>نوع پرداخت</span><span>اعتباری</span></div>
                                        <div><span>مبلغ پرداخت شده</span><span>4,422,000 ریال</span></div>
                                        <div><span>ساعت پرداخت</span><span>22:45</span></div>
                                        <div><span>کد رهگیری</span><span>2233523334</span></div>
                                        <div><span>شماره فاکتور</span><span>2233522423334</span></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-10">
                            <div class="change-price">
                                ...
                                <div class="change-price-info">
                                    <p>اگر به هر دلیلی مایل هستید بلیط را با قیمت بالاتری چاپ نموده و به مسافر ارائه دهید ، مبلفی که در نظر دارید بر روی بلیط افزایش قیمت داده شود را در کادر زیر وارد نموده و بلیط را چاپ نمایید</p>
                                    <p>یادآور می شویم این افزایش در حسابداری سیستم هیچ تاثیری ندارد و صرفا جهت راحت تر شدن شما جهت ساخت بلیط جدید در فوتوشاپ یا نرم افزار دیگر می باشد</p>
                                    <div class="change-price-input">
                                        <input placeholder="مبلغ مورد نظر خود را به ریال وارد نمایید" type="text">
                                        <button>ارسال</button>
                                    </div>
                                </div>
                            </div>
