...
<div class='d-flex flex-wrap w-100 parent-contactus'>
    ...
    <div class="header_top w-100 mt-4">
        <h3 class="site-main-text-color">##S360FeedBack##</h3>
    </div>
    ...
    <div class='d-flex flex-wrap align-items-start mt-lg-5 mt-5 w-100'>
        ...
        <div class='w-100'>
            <div class='d-flex flex-wrap'>
                <form id="feedback-form-id" class='d-flex flex-wrap w-100'>
                    ...
                    <button type="submit" class="btn btn-contactus btn-block btn-primary py-3 px-5 mx-auto mt-2 text-white site-main-button-color">##Register##</button>
                </form>
            </div>
        </div>
    </div>
