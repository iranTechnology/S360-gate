...
{if $objBank->transactionStatus neq 'failed' && $objBank->trackingCode neq ''}
    ...
    {assign var="data_update_credit" value=[
    'factor_number'=>$objBank->factorNumber,
    'tracking_code'=>$objBank->trackingCode
    ]}
    {load_presentation_object filename="creditDetail" assign="objCreditDetail"}

    {$objCreditDetail->updateIncreaseCreditByAgency($data_update_credit)}
                                ...
                                <div class="panel-return">
                                    ...
                                    <div class="panel-return-content">
                                        ...
                                        <div><span>##TrackingCode##</span><span>
                                             {$objBank->trackingCode}</span></div>
                                        <div>
                                            <span>##Invoicenumber##</span><span>{$objBank->factorNumber}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
