        ...
        <div class="col-lg-3 col-md-12 col-sm-12 col-12 train-sidebar col-padding-5">
            ...
            <div class="parent_sidebar">
                ...
                <div class="filtertip train-filter-change site-bg-main-color site-bg-color-border-bottom ">
                    ...
                    <a href="{$smarty.const.ROOT_ADDRESS}/trainResult/{$smarty.const.DEP_CITY}-{$smarty.const.ARR_CITY}/{$objResult->DatePrev($smarty.const.REQUEST_DATE)}/{$smarty.const.TYPE_WAGON}/{$smarty.const.ADULT}-{$smarty.const.CHILD}-{$smarty.const.INFANT}">
                    {/if}
                    ...
                    <a href="{$smarty.const.ROOT_ADDRESS}/trainResult/{$smarty.const.DEP_CITY}-{$smarty.const.ARR_CITY}/{$objResult->DateNext($smarty.const.REQUEST_DATE)}/{$smarty.const.TYPE_WAGON}/{$smarty.const.ADULT}-{$smarty.const.CHILD}-{$smarty.const.INFANT}">
...
<!--                            <div class="s-u-form-block s-u-num-inp s-u-num-inp-change">
                ...
                <span class="s-u-filter-title">
                    ...
                    {if $objResult->minPrice and $objResult->maxPrice}
                    <!-- pricefilter -->
...
{assign var="SearchData" value=['DepartureDate' => $smarty.const.REQUEST_DATE,'ReturnDate' =>$smarty.const.SEARCH_RETURN_DATE,'DepartureCity' => $smarty.const.DEP_CITY,'ArrivalCity'=>$smarty.const.ARR_CITY,'PassengerNumber'=>$smarty.const.PASSENGER_NUM,'TypeWagon'=>$smarty.const.TYPE_WAGON,'AdultCount'=>$smarty.const.ADULT,'ChildCount'=>$smarty.const.CHILD,'InfantsCount'=>$smarty.const.INFANT,'Coupe'=>$smarty.const.COUPE,'lang'=>$smarty.const.SOFTWARE_LANG,'PassengerCount'=>$smarty.const.PASSENGER_COUNT]}
<code style="display:none;">{$SearchData|json_encode}</code>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        trainResult('{$SearchData|json_encode}');
    });
