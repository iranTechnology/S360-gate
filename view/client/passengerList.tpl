            ...
            <div class="row">
                <div class="col-lg-3 position-static">
                    <div class="menu-profile-ris d-lg-none">
                        <a href="{$smarty.const.ROOT_ADDRESS}" class="logo_img"><img src='{$smarty.const.ROOT_ADDRESS_WITHOUT_LANG}/pic/{$smarty.const.CLIENT_LOGO}' alt='logo'></a>
                    ...
                    <div class="box-style">
                        <div class="box-style-padding">
                            <div class="passengers_header">
                                <h2 class="title mb-0">##ProfileListPassengers##</h2>
                                <button onclick="modalListForAddUser(event.currentTarget , {$profile['id']})" class="position-relative">
                            ...
                            {if $objDetail->passengers}
                            <div>
                                <div class="content-table table_style_parent mt-4">
                                    <table id="passengerList" class="table_style mb-3 table table-bordered">
                                        <thead>
                                        <tr>
                                            <th scope="col"><h2>##Name## <i></i></h2></th>
                                            <th scope="col"><h2>##Nation## <i></i></h2></th>
                                            <th scope="col"><h2>##NationalCode## <i></i></h2></th>
                                            <th scope="col"><h2>##DateOfBirth## <i></i></h2></th>
                                            <th scope="col"><h2>##Numpassport## <i></i></h2></th>
                                        ...
                                        {foreach key=key item=item from=$objDetail->passengers}
                                            <tr>
                                                <td data-content="##Name##">
                                                    {if $item['gender'] === "Male"}
                                                        <svg class='d-md-inline-flex d-none' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 512" style="color: #b2b2b2"><path d="M160 160H96C60.65 160 32 188.7 32 224v96c0 17.67 14.33 32 32 32v128c0 17.67 14.33 32 32 32h64c17.67 0 32-14.33 32-32v-128c17.67 0 32-14.33 32-32V224C224 188.7 195.3 160 160 160zM128 128c35.38 0 64-28.62 64-64s-28.62-64-64-64S64 28.62 64 64S92.63 128 128 128z"></path></svg>
                                                        <!--<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 512" style="color: #b2b2b2"><path d="M207.1 194.8l48.23 168.8C258.3 373.8 250.6 384 239.1 384h-47.99L192 480c0 17.67-14.33 32-32 32H96c-17.67 0-32-14.33-32-32l-.0002-96H16.01c-10.63 0-18.3-10.17-15.38-20.4l48.23-168.8C54.74 174.2 73.57 160 95 160h65.99C182.4 160 201.3 174.2 207.1 194.8zM128 128c35.38 0 64-28.62 64-64S163.4 0 128 0S63.1 28.62 63.1 64S92.63 128 128 128z"></path></svg>-->
                                                    {else}
                                                        <!--<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 512" style="color: #b2b2b2"><path d="M160 160H96C60.65 160 32 188.7 32 224v96c0 17.67 14.33 32 32 32v128c0 17.67 14.33 32 32 32h64c17.67 0 32-14.33 32-32v-128c17.67 0 32-14.33 32-32V224C224 188.7 195.3 160 160 160zM128 128c35.38 0 64-28.62 64-64s-28.62-64-64-64S64 28.62 64 64S92.63 128 128 128z"></path></svg>-->
                                                        <svg class='d-md-inline-flex d-none' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 512" style="color: #b2b2b2"><path d="M207.1 194.8l48.23 168.8C258.3 373.8 250.6 384 239.1 384h-47.99L192 480c0 17.67-14.33 32-32 32H96c-17.67 0-32-14.33-32-32l-.0002-96H16.01c-10.63 0-18.3-10.17-15.38-20.4l48.23-168.8C54.74 174.2 73.57 160 95 160h65.99C182.4 160 201.3 174.2 207.1 194.8zM128 128c35.38 0 64-28.62 64-64S163.4 0 128 0S63.1 28.62 63.1 64S92.63 128 128 128z"></path></svg>
                                                    {/if}
                                                    {if $item['name']=='' && $item['family']==''}
                                                    {$item['name_en']} {$item['family_en']}
                                                        {else}
                                                    {$item['name']} {$item['family']}
                                                    {/if}
                                                </td>
                                                <td data-content="##Nation##"> {if $item['is_foreign']==1}##Noiranian##{else}##Iranian##{/if}</td>
                                                <td data-content="##NationalCode##">{if $item['NationalCode']}{$item['NationalCode']}{else}---{/if}</td>
                                                <td data-content="##DateOfBirth##">
                                                    {if $item['is_foreign']==1}
                                                    {if $item['birthday']}{$item['birthday']}{else}---{/if}
                                                    {else}
                                                    {if $item['birthday_fa']}{$item['birthday_fa']}{else}---{/if}
                                                    {/if}
                                                </td>
                                                <td data-content="##Numpassport##">{if $item['passportNumber']}{$item['passportNumber']}{else}---{/if}</td>
                                                <td data-content="##Action##">
                                                    <div class="btns">
                                                        <button onclick="modalListForEditUser({$item['id']})" ><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.1.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M373.2 16.97C395.1-4.901 430.5-4.901 452.4 16.97L495 59.6C516.9 81.47 516.9 116.9 495 138.8L182.3 451.6C170.9 462.9 156.9 471.2 141.5 475.8L20.52 511.3C14.9 512.1 8.827 511.5 4.687 507.3C.5466 503.2-1.002 497.1 .6506 491.5L36.23 370.5C40.76 355.1 49.09 341.1 60.44 329.7L373.2 16.97zM429.8 39.6C420.4 30.22 405.2 30.22 395.8 39.6L341 94.4L417.6 170.1L472.4 116.2C481.8 106.8 481.8 91.6 472.4 82.23L429.8 39.6zM109.6 402.4L173.4 415.2L394.1 193.6L318.4 117L96.84 338.6L109.6 402.4zM70.51 370.2C69.08 373.2 67.88 376.3 66.93 379.5L39.63 472.4L132.4 445.1C135.7 444.1 138.8 442.9 141.8 441.5L92.86 431.7C86.53 430.4 81.58 425.5 80.31 419.1L70.51 370.2z"/></svg></button>
                                                        <button onclick="modalListForDeleteUser({$item['id']})" class="deleteVote"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--! Font Awesome Pro 6.1.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M144 400C144 408.8 136.8 416 128 416C119.2 416 112 408.8 112 400V176C112 167.2 119.2 160 128 160C136.8 160 144 167.2 144 176V400zM240 400C240 408.8 232.8 416 224 416C215.2 416 208 408.8 208 400V176C208 167.2 215.2 160 224 160C232.8 160 240 167.2 240 176V400zM336 400C336 408.8 328.8 416 320 416C311.2 416 304 408.8 304 400V176C304 167.2 311.2 160 320 160C328.8 160 336 167.2 336 176V400zM310.1 22.56L336.9 64H432C440.8 64 448 71.16 448 80C448 88.84 440.8 96 432 96H416V432C416 476.2 380.2 512 336 512H112C67.82 512 32 476.2 32 432V96H16C7.164 96 0 88.84 0 80C0 71.16 7.164 64 16 64H111.1L137 22.56C145.8 8.526 161.2 0 177.7 0H270.3C286.8 0 302.2 8.526 310.1 22.56V22.56zM148.9 64H299.1L283.8 39.52C280.9 34.84 275.8 32 270.3 32H177.7C172.2 32 167.1 34.84 164.2 39.52L148.9 64zM64 432C64 458.5 85.49 480 112 480H336C362.5 480 384 458.5 384 432V96H64V432z"/></svg></button>
                                                    </div>
                                                </td>
                                            </tr>
                                        {/foreach}
...
<!--                            <div class="d-flex d-md-none mt-4 flex-wrap">
                            ...
                            <div class="err404_style mt-4 d-flex justify-content-center align-items-center flex-column">
                                ...
                                <h2 class="title">##ThereNoPassengersList##</h2>
                                <p class="text-center px-4">##AddPassengersMakeAccessShopping##</p>
                                <button onclick="modalListForAddUser(event.currentTarget , {$profile['id']})" class="position-relative">
                                    ##ProfileAddPassenger##
                                    <div class="bouncing-loader bouncing-loader-none">
                                        <div></div>
    ...
    <script type="text/javascript">
      $(document).ready(function () {
        ...
        $('body').on('click' ,'.submitPassengerUpdateFormData' , function () {
          ...
          if (Passport_Number != "") {
            if (Passport_Number.toString().length > 9) {
              $.alert({
                title: useXmltag("UpdateProfile"),
                icon: 'fa fa-refresh',
                content: useXmltag("InvalidPassportNumber"),
                rtl: true,
                type: 'red',
              });
              error_pass_num = 1;
        ...
        $('body').on('click' ,'.submitPassengerAddFormData' , function () {
          ...
          $("#AddPassengerFormData").validate({
            ...
            messages: {
              ...
              passengerNationalCode: {
                'required': 'فیلد اجباری است',
                'minlength': 'لطفا شماره ملی درست وارد کنید',
                'maxlength': 'لطفا شماره ملی درست وارد کنید'
              },
            },
      ...
      function checkLetterPersian(evt, Input){
        var charCode = (evt.which) ? evt.which : event.keyCode
        if (charCode < 1570 || charCode > 1740) {
          if (charCode == 8 || charCode == 32 || charCode == 9) {
            $("#massege-input").remove()
          } else {
            if ($("#massege-input").length === 0){
              $('#' + Input).after(`<span id="massege-input" class="text-danger">لطفا متن فارسی وارد کنید</span>`)
            }
            return false;
          }
      ...
      function checkLetterEnglish(evt, Input){
        var charCode = (evt.which) ? evt.which : event.keyCode;
        if (charCode == 8 || charCode == 32 || charCode == 20) {
          ...
          if ($("#massege-input").length === 0){
            $('#' + Input).after(`<span id="massege-input" class="text-danger">لطفا متن انگلیسی وارد کنید</span>`)
          }
          return false;
        }
      }
      function checkNumber_profile(evt, Input) {
        var charCode = (evt.which) ? evt.which : event.keyCode;
        ...
        if ((charCode < 48 || charCode > 57) && (charCode < 96 || charCode > 105) && charCode != 229 && charCode != 67 && charCode != 65 && charCode != 88) {
          if ($("#massege-input").length === 0){
            $('#' + Input).after(`<span id="massege-input" class="text-danger">لطفا عدد وارد کنید</span>`)
          }
          return false
        }
