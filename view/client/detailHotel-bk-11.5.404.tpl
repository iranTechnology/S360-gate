...
<code style="display:none;color:red">{$smarty.post|json_encode}</code>
...
113 139 0 7 -207 10 -640 10 -433 0 -640 -3 -640 -10z"/>
        ...
        <div class="d-flex flex-wrap w-100">
            <div class="col-lg-9 col-md-12  col-sm-12 col-12 col-padding-5 right_hotel_section content-detailHotel">
                                    ...
                                    <form class="search-wrapper parent-research-external-hotel-detail-sidebar" action="" method="post">
                                        ...
                                        <div class="form-hotel-item form-hotel-item-searchBox-date">
                                            ...
                                            <div class="input">
                                                ...
                                                <input type="text" placeholder="##Wentdate##" id="startDateForeign" name="startDate"
                                                       value="{$startDate}"
                                        ...
                                        <div class="form-hotel-item form-hotel-item-searchBox-date">
                                            <div class="input">
                                                <i class="fa fa-calendar site-main-text-color"></i>
                                                <input type="text" placeholder="##Returndate##" id="endDateForeign" name="endDate"
                                                       value="{$endDate}"
                                        ...
                                        <div class="filtertip-searchbox filtertip-searchbox-box1 parent-research-internal-hotel-detail-sidebar">
                                            ...
                                            <div class="form-hotel-item  form-hotel-item-searchBox-date">
                                                ...
                                                <div class="input parent-box-input">
                                                    <div class="parent-box-calendar">
                                                        <i class="fa fa-calendar"></i>
                                                        <input type="text" placeholder="##Returndate##" id="endDate" name="endDateForHotelLocal"
