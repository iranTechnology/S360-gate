{load_presentation_object filename="apiLocal" assign="objApiLocal"}
{load_presentation_object filename="parvazBookingLocal" assign="objBook"}
{$objBook->setPortBank('privateGetWaySource7',$smarty.post.RequestNumber)}
{$objBook->sendUserToBank($smarty.post.RequestNumber['dept'])}
{assign var="charter724" value=$objApiLocal->ReserveByBankCharter724($smarty.post.RequestNumber['dept']) }
{if $charter724 eq false}
