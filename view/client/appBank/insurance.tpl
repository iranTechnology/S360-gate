        ...
        <div class="main-bank-box">
            ...
            {if $smarty.get.bankType neq 'credit'}
                ...
                <div class="txtAlertBank">
                    ...
                    ##Insuranceissuedpaymentreferringbankagain##
                </div>
            {/if}
        </div>
    </div>
...
{if $smarty.get.bankType neq 'credit'}
    {$objBook->setPortBankInsurance($smarty.get.bankType,$smarty.get.factorNumber)}
{/if}
...
{$objBank->calculateAmount('insurance', $smarty.get.factorNumber)}
{$objBank->executeBank('go')}

{if $objBank->failMessage eq ''}
    {$objBook->sendUserToBankForInsurance($smarty.get.factorNumber)}
{else}
