			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 padr0 padl0 marb40 Clr">
				<div class="main-bank-box">
					...
					<div class="s-u-update-popup-change">
						...
						<div class="s-u-bank-item s-u-bank-item-tiket-print">
							<a href="{$smarty.const.ROOT_ADDRESS}/{$linkView}&num={$objBookingNew->factor_number}" class="d-flex align-items-center justify-content-center gap-7 btn btn-success py-3 px-4 mbb-bank-title-green border-0 text-white" target="_blank">
								<i class="fas fa-print"></i>
								<p class="s-u-bank-title text-white">##PrintWatcher##  </p>
							</a>
						</div>
						{*								{/if}*}
						{*						{/if}*}
