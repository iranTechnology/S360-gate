...
<input type="hidden" value="Local" id="TypeZoneFlight">
<form method="post" id="formAjax" action="">
    ...
    <input type="hidden" value='' name="PostPassenger" id="PostPassenger">
</form>
...
<script src="assets/js/vueScripts/flightInternal.js"></script>
