      ...
      <div class="">
        <div class="parent-search-tour">
          ...
          <div class="box-tour">
            ...
            <div class="w-100 d-flex justify-content-center align-items-center h-100" style="font-size:19px" v-if="!tour_loading && filteredTours.length === 0 && !$store.state.isCounter">در این مقصد توری برای نمایش وجود ندارد</div>
            <div class="w-100 d-flex justify-content-center align-items-center h-100" style="font-size:19px" v-else-if="!tour_loading && filteredTours.length === 0 && $store.state.isCounter">در این مسیر توری برای نمایش به شما تخصیص داده نشده است</div>
...
export default {
  ...
  async mounted() {
    await this.$store.dispatch('isCounter')
    await this.setData()
    await this.doSearch()
  },
  methods: {
