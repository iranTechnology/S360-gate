  ...
  each_flight.is_private == 'private' ? 'border-is-private' : ''
    ...
    >
      <div class="international-available-info">
        <div class="international-available-item-right-Cell my-slideup">
          <div class="right_busin_div">
            <div class="site-bg-main-color" v-if="each_flight.seat_class_en == 'business'">
             ...
             <div class="site-bg-main-color" v-if="each_flight.seat_class_en == 'premium_economy'">
                <span class="iranM ">{{ each_flight.seat_class }}</span>
             </div>
          </div>

          <airline-out-put-flight :flight="each_flight"></airline-out-put-flight>
          <info-out-put-flight :flight="each_flight" :data_search="data_search"></info-out-put-flight>
        ...
        <price-flight :flight="each_flight" :data_search="data_search" :type='`twoWay`'></price-flight>
          ...
          <div>
            <div class=" international-available-panel-min">
              <ul class="tabs">
                ...
                <li class="tab-link site-border-top-main-color"  :data-tab="`tab-3-${key_flight}`"
              ...
              <div :id="`tab-3-${key_flight}`" class="tab-content w-100" v-show="each_flight.source_id=='14'">
...
<script>
import airlineOutPutFlight from "./airlineFight";
import infoOutPutFlight from "./outPutFlight";
...
import detailDepartFlight from "../interantionalFlight/detailDepartFlight";
import detailReturnFlight from "../interantionalFlight/detailReturnFlight";
