<template>
    <div class="international-available-airlines-info ">
        <div class="airlines-info txtLeft origin-city">
            <span class="open city-name-flight">{{ each_return_flight.departure_name}}( {{ each_return_flight.departure_code}})</span>
<!--            <span class="openB airport-name-flight"> {{ each_return_flight.airport_departure_name}}</span>-->
            <div class="date-time">
            <span class="time-flight">
                <div class="date-time">
                    <span class="time-flight">
                           {{ each_return_flight.departure_time }}
                    </span>
                </div>
                </span>
            </div>
              ...
              <span class="iranL txt13 position-bottom--new d-none d-md-block" style="bottom: -12px;" >
               ...
               <div class="airline-line">
                       ...
                       <div class="plane-icon">
                           <span v-html="icon_svg_info_return_flight_2"></span>
                       </div>

                       <div class="loc-icon-destination">
                           <span v-html="icon_svg_info_return_flight_3"></span>
                       </div>
...
<!--               </div>-->
        ...
        <span class="open city-name-flight">
            {{ each_return_flight.arrival_name}}( {{ each_return_flight.arrival_code }})
        </span>
<!--            <span class="openB airport-name-flight">-->
<!--            {{ each_return_flight.airport_arrival_name}}-->
<!--        </span>-->
            <div class="date-time">
            <span class="time-flight">
                   {{ each_return_flight.arrival_time }}
            </span>
            </div>
        </div>
    </div>
