...
const store = new Vuex.Store({
    ...
    mutations: {
        ...
        setTimeArrivalFilter(state, arrival_time_filter) {
            state.timeArrivalFilter = arrival_time_filter;
        },
        setTransitAirports(state, transit_airports_filter) {
            state.transitAirports = transit_airports_filter;
        },
        setTransitDuration(state, transit_duration_filter) {
            state.transitDuration= transit_duration_filter;
        },
        ...
        setBaggageFilter(state, baggage_filter) {
            state.baggageFilter = baggage_filter;
        },
        ...
        async getFlight({ commit }, payload) {
            ...
            await axios
                ...
                .then(function (response) {
                    ...
                    commit("setTimeArrivalFilter", response.data.data.arrival_time_filter);
                    commit("setTransitAirports", response.data.data.transit_airports);
                    commit("setTransitDuration", response.data.data.transit_duration);
                    ...
                    commit("setBaggageFilter", response.data.data.baggage_filter);
