...
{assign var="params_charge_credit_member" value=["price"=>$smarty.post.price,"factorNumber"=>$smarty.post.factorNumber]}
{$objmemberCredit->increaseChargeAccount($params_charge_credit_member)}
...
{$objBank->calculateAmount('charge_credit_member',$smarty.post.factorNumber,$smarty.post.price)}
