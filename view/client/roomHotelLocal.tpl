...
{*        </div>*}
        <div class="box-hotel--new right_hotel_section">
            <div class="internal-hotel-name">
                    ...
                    <div class="hotel-name hotel-name_detail">
                        ...
                        <div class="parent-hotel-stars-address">
                            ...
                            <div class="internal-hotel-address {if $isExternal eq 'no'}txtRight{/if}">
                                <span class="address-text-reservation">
                                 {if $smarty.const.SOFTWARE_LANG eq 'fa'}
...
{*                    </div>*}
            ...
            <div class="parent-navigation-list-hotel">
                <ul>
                    <li><a onclick="clickScroll('formHotelReserve')" href="javascript:">انتخاب اتاق</a></li>

                    <li><a onclick="clickScroll('facilities-section')" href="javascript:">امکانات اتاق</a></li>

                    <li><a onclick="clickScroll('detail-section')" href="javascript:">معرفی هتل</a></li>
                    <li><a onclick="clickScroll('detail-section')" href="javascript:">قوانین و مقررات</a></li>
                    <li><a onclick="clickScroll('hotelFeaInnerId-reservation')" href="javascript:">مشاهده نقشه</a></li>
                </ul>
            </div>
            ...
            {if $typeApplication eq 'reservation' && $isShowReserve neq 'no'}
                ...
                {assign var="typeApplication" value=$typeApplication}
                    ...
                    <div class="parent-data-reservation">
