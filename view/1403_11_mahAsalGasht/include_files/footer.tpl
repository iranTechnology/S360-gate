     ...
     <div class="item-footer col-lg-3 col-md-6 col-sm-12 col-12 order-foot3">
      <div class="box-item-footer">
       ...
       <ul>
        ...
        <li>
         <a href="{$smarty.const.ROOT_ADDRESS}/agencyList">
          <i class="fa-sharp fa-solid fa-square">
          </i>
          ﻧﻤﺎﯾﻨﺪگی ﻫﺎ
         </a>
        ...
        <li>
         <a href="{$smarty.const.ROOT_ADDRESS}/page/helpFile">
          <i class="fa-sharp fa-solid fa-square">
          </i>
          ﻓﺎﯾﻞ ﻫﺎی راﻫﻨﻤﺎ
         </a>
      ...
      <div class="box-item-footer parent-contact-information">
       ...
       <div class="namads">
        ...
        <a  target="_blank" rel="nofollow">
         <img referrerpolicy='origin' id = 'rgvjjzpergvjapfufukzsizp' style = 'cursor:pointer' onclick = 'window.open("https://logo.samandehi.ir/Verify.aspx?id=373569&p=xlaojyoexlaodshwgvkapfvl", "Popup","toolbar=no, scrollbars=no, location=no, statusbar=no, menubar=no, resizable=0, width=450, height=630, top=30")' alt = 'logo-samandehi' src = 'https://logo.samandehi.ir/logo.aspx?id=373569&p=qftiyndtqftiujynwlbqbsiy' />
        </a>
        <a referrerpolicy='origin' target='_blank' href='https://trustseal.enamad.ir/?id=533657&Code=kHJGfxCcYHorStyKT5zPH14UjFp4jjZi'><img referrerpolicy='origin' src='https://trustseal.enamad.ir/logo.aspx?id=533657&Code=kHJGfxCcYHorStyKT5zPH14UjFp4jjZi' alt='' style='cursor:pointer' code='kHJGfxCcYHorStyKT5zPH14UjFp4jjZi'></a>
       </div>
      </div>
     </div>
    </div>
