<div class="col-xl-2 col-lg-6 col-sm-6 col-12 col_search search_col col_with_route">
    <div class="form-group origin_start -mt-20">
        <i class="fas fa-map-marker-alt fa-lg mr-2"></i>

        <input autocomplete="off" class="form-control inputSearchForeign iata-origin-international-js" id="iata_origin_international" name="iata_origin_international" onclick='displayCityListExternal("origin" , event)' placeholder="مبدأ" type="text"/>
