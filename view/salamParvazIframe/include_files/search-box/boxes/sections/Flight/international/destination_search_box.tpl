<div class="col-xl-2 col-lg-6 col-sm-6 col-12 col_search search_col">
<div class="form-group d-flex align-items-center ">
    <i class="fas fa-map-marker-alt fa-lg mr-2"></i>

    <span class="destnition_start">
<input autocomplete="off" class="inputSearchForeign form-control iata-destination-international-js" id="iata_destination_international" name="iata_destination_international" onclick='displayCityListExternal("destination" , event)' placeholder="مقصد " type="text"/>
</span>
