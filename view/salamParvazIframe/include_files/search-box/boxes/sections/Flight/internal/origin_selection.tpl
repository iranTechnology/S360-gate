<div class="col-xl-2 col-lg-6 col-sm-6 col-12 col_search col_with_route ">
<div class="form-group d-flex align-items-center border-left-origin -mt-20">
    <i class="fas fa-map-marker-alt fa-lg mr-2"></i>

    <div class="form-group origin_start">
<input autocomplete="off" class="form-control inputSearchLocal route_origin_internal-js" style="border-left:none !important;" id="route_origin_internal" name="route_origin_internal" onclick="displayCityList('origin')" placeholder="مبدأ" type="text"/>
