...
<input autocomplete="off" class="inputSearchForeign form-control route_destination_internal-js" id="route_destination_internal" name="route_destination_internal" onclick="displayCityList('destination')" placeholder="مقصد" type="text"/>
