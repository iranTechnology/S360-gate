...
<li><em class="number_adult international-number-adult-js">1</em> بزرگسال ،</li>
...
<input autocomplete="off" class="countParent international-count-parent-js" id="adult1" max="5" min="0" name="adult1" readonly="" type="number" value="1"/>
