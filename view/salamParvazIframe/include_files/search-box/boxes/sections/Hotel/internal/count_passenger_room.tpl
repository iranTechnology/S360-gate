<div class="col-xl-2 col-lg-6 col-md-6 col-sm-6 col-12 col_search">
<div class="form-group from-group-count-passenger-room d-flex align-items-center">
...
<li><em class="number_adult internal-number-adult-js">1</em> بزرگسال ،</li>
...
<input autocomplete="off" class="countParent internal-count-parent-js" id="adult1" max="5" min="0" name="adult1" readonly="" type="number" value="1"/>
