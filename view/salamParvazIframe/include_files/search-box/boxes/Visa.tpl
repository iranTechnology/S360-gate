    ...
    <div class="d-flex flex-wrap gap-search-box">
        <div class="d-flex flex-wrap searchbox-style-visa">
            <form data-action="https://s360online.iran-tech.com/" method="post" name="gdsVisa"
                ...
                <div class="col-lg-1 col-md-4 col-sm-6 col-12 btn_s col_search mr-auto  p-1">
                    <button type="button" onclick="searchActiveVisa(false , 'https://salamparvaz.ir')" class="btn theme-btn seub-btn b-0 btn-visa-style">
                        <span>##Search##</span>
                    </button>
                </div>
            </form>
