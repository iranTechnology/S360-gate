 ...
 <div class="col-md-12 col-12">
  <div class="row">
   <form class="d_contents" data-action="://s360online.iran-tech.com/" id="gds_local_bus" method="post" name="gds_local_bus" target="_blank">
    ...
    <div class="col-lg-2 col-md-6 col-sm-6 col-12 btn_s col_search d-flex">
     <button class="btn theme-btn seub-btn b-0" onclick="searchBus('https://salamparvaz.ir')" type="button">
<span>
 جستجو
</span>
     </button>
