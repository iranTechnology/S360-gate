...
{load_presentation_object filename="shahikaParvaz" assign="obj_main_page" subName="customers"}
...
<head>
    ...
    <script type="text/javascript" src="assets/all-js/jquery-3.4.1.min.js"></script>
