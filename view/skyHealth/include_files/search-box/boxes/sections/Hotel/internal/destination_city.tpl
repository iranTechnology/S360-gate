...
<input autocomplete="off" class="inputSearchForeign w-100 form-control" id="autoComplateSearchIN" name="autoComplateSearchIN" onclick="openBoxPopular('hotel')" onkeyup="searchCity('hotel')" placeholder="انتخاب شهر" type="text" value=""/>
