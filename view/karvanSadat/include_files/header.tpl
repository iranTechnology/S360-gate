{load_presentation_object filename="karvanSadat" assign="obj_main_page" subName="customers"}
...
<head>
    ...
    {if $smarty.const.GDS_SWITCH eq 'mainPage' || $smarty.const.GDS_SWITCH eq 'page'}
        ...
        <link href="{$smarty.const.ROOT_LIBRARY}/{$StyleSheetMain}.php" media="screen" rel="stylesheet"
              type="text/css" />
