<div class="section_boxs">
    <div class="container">
        <div class="row">
            <div class="col-lg-3 col-md-6 margin-bottom-mobile">
                <div class="links_box">
                    ...
                    <div class="captin_box"><p>دنیای پر رقابت امروز، تنها شرکت هایی موفق خواهند بود که در مسیر شناخت
                            نیاز مسافران خود گام برداشته باشند.</p></div>
                    <div class="links_btn"><a href="{$smarty.const.ROOT_ADDRESS}/loginUser"
                                              class="cta"><span>ورود </span></a><a
                                href="{$smarty.const.ROOT_ADDRESS}/registerUser"
                                class="cta "><span>ثبت نام </span></a></div>
                </div>
            </div>
                ...
                <div class="links_box date_convert shamsiConvertDate">
                    ...
                    <div class="captin_box">
                        <div class="form__group field">
                            <button type="button" id="shamsiConvertButton" onclick="convertJalaliToMiladi()" class="form__label btn_abs">تبدیل
                            </button>
                            <input value="" type="text" readonly="" class="form__field  convertShamsiMiladiCalendar"
                                   placeholder="تبدیل به میلادی" name="txtShamsiCalendar" id="txtShamsiCalendar">
                        </div>
                        <div class="resultdate" id="showJalaliResult"></div>
                        <div class="form__group field">
                            <button type="button" id="miladiConvertButton" onclick="convertMiladiToJalali()" class="form__label btn_abs">تبدیل
                            </button>
                            <input type="text" readonly="" class="form__field  convertMiladiShamsiCalendar"
                                   placeholder="تبدیل به شمسی" name="txtMiladiCalendar" id="txtMiladiCalendar">
                        </div>
                        <div class="resultdate" id="showMiladiResult"></div>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 meteorology margin-top-mobile">
                <div class="links_box">
                    <div class=" flatbox">
                    ...
                    <div class="captin_box"><p>توسط این بخش می تواند منطقه یا مناطق جغرافیایی را جهت نمایش وضعیت آب
                            هوایی انتخاب نمایید.تا در زمان گردش بیشترین لذت را از مسافرت خود داشته باشید.</p></div>
                    <div class="links_btn"><a href="{$smarty.const.ROOT_ADDRESS}/weather" class="cta SMWeather"><span>هواشناسی </span></a>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 exchange_rate margin-top-mobile">
                <div class="links_box">
                    ...
                    <a class="ttt SMChange" href="{$smarty.const.ROOT_ADDRESS}/currency"> نرخ ارز</a>
                    <div class="captin_box"><p>توسط این بخش شما می توانید بروز ترین  نرخ لحظه ای ارزهای
                            انتخابی خود را بر اساس ارز مرجع،مشاهده نمایید. تا در زمان گردش بیشترین لذت را از مسافرت خود
                            داشته باشید.
                        </p></div>
                    <div class="links_btn"><a href="{$smarty.const.ROOT_ADDRESS}/currency" class="cta SMChange"><span>نرخ ارز </span></a>
                    </div>
                </div>
            </div>
        </div>
