                    ...
                    <div>
                        <ul class="nav nav-pills mb-3" id="search_flight-tab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button aria-controls="search_flight_internal" aria-selected="true" class="nav-link active" data-target="#search_flight_internal" data-toggle="pill" id="search_flight_internal-tab" role="tab" type="button">
                            ...
                            <li class="nav-item" role="presentation">
                                <button aria-controls="search_flight_internation" aria-selected="false" class="nav-link" data-target="#search_flight_internation" data-toggle="pill" id="search_flight_internation-tab" role="tab" type="button">
                            ...
                            <div aria-labelledby="{$city['main']['Departure_CityEn']}-tab" class="__i_modular_nc_item_class_0 tab-pane fade {if $i==1} show active {/if}" id="{$city['main']['Departure_CityEn']}" role="tabpanel">
                                <div class="search_flight_grid">
                                    ...
                                    {foreach $city['sub_cities'] as $sub_city}
                                        ...
                                        <div class="__final_destination_0 flightSearchBox" data-target="#calenderBox" data-toggle="modal" onclick="calenderFlightSearch('{$city['main']['Departure_Code']}','{$sub_city['Departure_Code']}')">
