{assign var="countries" value=$obj_main_page->countryInsurance()}
                        <div class="__box__ tab-pane {if $active} active {/if}  {if  $smarty.const.GDS_SWITCH eq 'page'} active {/if}" id="Insurance">
...
<select aria-hidden="true" class="select2 select2-hidden-accessible insurance-destination-country-js" data-placeholder="نام کشور مقصد" id="insurance_destination_country" name="insurance_destination_country" tabindex="-1">
...
<div class="col-lg-3 col-md-4 col-sm-6 col-12 col_search p-1">
<div class="form-group">
<select aria-hidden="true" class="select2 travel-time-js select2-hidden-accessible" data-placeholder="انتخاب مدت سفر" id="travel_time" name="travel_time" tabindex="-1">
<option value="">##ChoseOption##...</option>
...
<div class="form-group">
<select aria-hidden="true" class="select2 passengers-count-js select2-hidden-accessible number-of-passengers-js" data-placeholder="انتخاب تعداد مسافر" id="number_of_passengers" name="number_of_passengers" tabindex="-1">
<option value="">##ChoseOption##...</option>
{for $i=1 to 9}
