...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const buttons = Hotel.querySelectorAll('.btn-switch-searchBox');
    const inputOneWay = document.getElementById('international_hotel');
    const inputReturn = document.getElementById('internal_hotel');
    ...
    buttons.forEach(button => {
        button.addEventListener('click', function() {
            ...
            // تغییر وضعیت disabled بر اساس دکمه کلیک‌شده
            if (this.textContent === 'هتل داخلی') {
                inputOneWay.style.display = 'none';
                inputReturn.style.display = 'flex';
            } else if (this.textContent === 'هتل خارجی') {
                inputOneWay.style.display = 'flex';
                inputReturn.style.display = 'none';
            }
        });
    });

    // تنظیم اولیه بر اساس دکمه active
    const activeButton = Hotel.querySelector('.btn-switch-searchBox.active');
    if (activeButton.textContent === 'هتل داخلی') {
        inputOneWay.style.display = 'none';
    }
});

document.addEventListener('DOMContentLoaded', function() {
    const Hotel = document.getElementById('exclusiveTour');
    const buttons = Hotel.querySelectorAll('.btn-switch-searchBox');
    const inputOneWay = document.getElementById('international_exclusive_tour');
    const inputReturn = document.getElementById('internal_exclusive_tour');
    ...
    buttons.forEach(button => {
        button.addEventListener('click', function() {
            ...
            // تغییر وضعیت disabled بر اساس دکمه کلیک‌شده
            if (this.textContent === 'داخلی') {
                inputOneWay.style.display = 'none';
                inputReturn.style.display = 'flex';
            } else if (this.textContent === 'خارجی') {
                inputOneWay.style.display = 'flex';
                inputReturn.style.display = 'none';
            }
        });
    ...
    // تنظیم اولیه بر اساس دکمه active
    const activeButton = Hotel.querySelector('.btn-switch-searchBox.active');
    if (activeButton.textContent === 'داخلی') {
        inputOneWay.style.display = 'none';
    }
});
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const buttons = Tour.querySelectorAll('.btn-switch-searchBox');
    const inputOneWay = document.getElementById('international_tour');
    const inputReturn = document.getElementById('internal_tour');
    ...
    buttons.forEach(button => {
        button.addEventListener('click', function() {
            ...
            // تغییر وضعیت disabled بر اساس دکمه کلیک‌شده
            if (this.textContent === 'تور داخلی') {
                inputOneWay.style.display = 'none';
                inputReturn.style.display = 'flex';
            } else if (this.textContent === 'تور خارجی') {
                inputOneWay.style.display = 'flex';
                inputReturn.style.display = 'none';
            }
        });
    ...
    // تنظیم اولیه بر اساس دکمه active
    const activeButton = Tour.querySelector('.btn-switch-searchBox.active');
    if (activeButton.textContent === 'تور داخلی') {
        inputOneWay.style.display = 'none';
    }
});
...
const baseStarCount = 15; // Base count of stars per layer
