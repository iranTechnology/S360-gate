...
'mainPage' =>'MainPagePic','exclusiveTour' => 'exclusiveTourPic']}
...
<script>
    ...
    if($(window).width() > 576){
       ...
       $('.Europcar-tab-pic').click(function () {$('.banner-safiran').css('background-image' , 'url("{/literal}{$specialEuropcarPic}{literal}")')});
        ...
        {if $exclusiveTourPic}
        {literal}
       $('.exclusiveTour-tab-pic').click(function () {$('.banner-safiran').css('background-image' , 'url("{/literal}{$exclusiveTourPic}{literal}")')});
        {/literal}
        {/if}
        {literal}
