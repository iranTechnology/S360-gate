...
{*                            <li>*}
{*                                <a href="{$smarty.const.ROOT_ADDRESS}/page/tour">پکیج</a>*}
...
{*                            </li>*}
                            <li>
                                <a href="{$smarty.const.ROOT_ADDRESS}/page/exclusiveTour">
                                    تور
                                </a>
                            </li>
                            ...
                            <li>
                                <a href="https://tele.myporsetareh.ir">
                                    تلسکوپ
                                </a>
                            </li>
                            <li>
                                <a href="https://apstick.ir/Spa/B2C/fa-IR/BookingV2/RefundSearch">
                                    سامانه استرداد
                                </a>
                            </li>
                            {*                            <li>*}
                ...
                <div class="parent-btn-header">
                    <a class="__phone_class__ button btn-phone"
                       href="tel:07644490380">
                        <span>076-44490380</span>
