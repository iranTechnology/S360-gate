<section id='installmentCalculator' class="installmentCalculator">
    <div class="container">
        <div class="installmentCalculator_box ">
            <div class="title-center-demo">
                <div class="">
                    ...
                    <p>
                        با محاسبه‌گر اقساط ما، سفر رویایی‌تان را به راحتی و با پرداخت‌های ماهانه برنامه‌ریزی کنید.
                    </p>
                </div>
            </div>
            ...
            <div class='installmentCalculator_box-parent'>
                <div class="col-lg-6 col-12">
                    <div class="installmentCalculator_box_div1">
                        <input type="hidden" id='initial_payment' name='initial_payment' value='20'>
                        <div>
                            <div class="header">
                                <h3>تعداد اقساط</h3>
                            ...
                            <div dir="ltr">
                                <input  onchange="getInfoCalculator()" id='installments' data-rangeslider="" max="10" min="4" type="range" value="0"/>
                            </div>
                        </div>
                        <div>
                            <div class="header">
                            ...
                            <div dir="ltr">
                                <input onchange="getInfoCalculator()" id='price' data-rangeslider2="" max="200" min="10" step="10" type="range" value="0"/>
                            </div>
                        </div>
                    </div>
                </div>
