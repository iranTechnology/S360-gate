<div class="__box__ tab-pane
     {if $smarty.const.GDS_SWITCH eq 'page' || $active_tab eq 'exclusiveTour'} active show {/if}"
     id="exclusiveTour">
                ...
                <div class="d-flex flex-wrap gap-mobile">
                    ...
                    <div class="col-lg-2 col-md-6 col-sm-6 col-12 col_search date_search p-1">
                        <div class="parent-input-search-box">
                            ...
                            <input readonly="" type="text"
                                   class="checktest returnCalendar return_input internal-arrival-date-exclusive-tour-js" id="internal-arrival-date-exclusive-tour-js" name="internal-arrival-date-exclusive-tour-js" placeholder="تاریخ برگشت">
                        </div>
                    </div>
                ...
                <div class='d-flex flex-wrap gap-mobile'>
                    ...
                    <div class="col-lg-2 col-md-6 col-sm-6 col-12 col_search date_search p-1">
                        <div class="parent-input-search-box ">
                            ...
                            <label class="caption-input-search-box">تاریخ پرواز برگشت را انتخاب کنید</label>
                            <input readonly="" type="text" class=" return_input2  returnCalendar international-arrival-date-exclusive-tour-js" id="international-arrival-date-exclusive-tour-js" placeholder="تاریخ برگشت">
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-6 col-sm-6 col-12 col_search p-1">
