...
{*{assign var="info" value=$objAgency->AgencyInfoByIdMember($objSession->getUserId())}*}
{assign var="info" value=$objAgency->subAgencyInfo()}
{if $obj_main_page->isLogin()}
    ...
    <div class="sup-menu-flex sup-menu-flex-login">
        ...
        {/if}
        {if $check_is_counter && !empty($info['sepehr_username'])}
            <a href="https://bittrip.ai/">
                <i><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"><!--! Font Awesome Pro 6.3.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path d="M460.7 231.7l61.5-35.5-80-138.6L380.7 93.1l80 138.6zM329.4 99.6c-6.2-14.6-.6-31.9 13.5-40.1L432.1 8C447.4-.8 467 4.4 475.8 19.7l96 166.3c8.8 15.3 3.6 34.9-11.7 43.7l-89.2 51.5c-15.3 8.8-34.9 3.6-43.7-11.7l-.5-.8-42.6 23.1c.6 4 .9 8.1 .9 12.3c0 20.1-7.4 38.5-19.7 52.5l49.9 122.4c5 12.3-.9 26.3-13.2 31.3s-26.3-.9-31.3-13.2l-47-115.3c-6 1.5-12.3 2.2-18.8 2.2s-12.8-.8-18.8-2.2l-47 115.3c-5 12.3-19 18.2-31.3 13.2s-18.2-19-13.2-31.3l44.3-108.8L150.5 418c-15.2 8.2-34.3 2.9-42.9-12.1l-.7-1.3L62.7 430.1c-11.5 6.6-26.2 2.7-32.8-8.8L4.1 376.4c-6.6-11.5-2.7-26.2 8.8-32.8l44.1-25.5L53 311.4c-8.6-14.9-3.9-33.8 10.6-43L329.4 99.6zm73.3 127.5l-49.5-85.7L102.3 300.7l39.1 67.7L227 322.1c-1.3-5.8-2-11.9-2-18.1c0-44.2 35.8-80 80-80c22.7 0 43.2 9.5 57.8 24.7l39.9-21.6zM305 336a32 32 0 1 0 0-64 32 32 0 1 0 0 64z"/></svg></i>
                ##TelescopeMarket##
            </a>
        {/if}
