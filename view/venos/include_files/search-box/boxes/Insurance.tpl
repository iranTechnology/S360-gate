...
<div class="tab-pane {if {$tab_detail['tab_href']} eq 'Insurance'}active{/if}" id="Insurance">
            ...
            <form data-action="https://s360online.iran-tech.com/" method="post" target="_blank"
                ...
                <div class="col-lg-2 col-md-3 col-sm-6 col-12 col_search search_btn_insuranc p-1">
                    <button type="button" onclick="searchInsurance()"
                            class="btn theme-btn seub-btn b-0 d-flex align-items-center justify-content-center">
                        <span>جستجو</span>
