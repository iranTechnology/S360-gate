{load_presentation_object filename="venos" assign="obj_main_page" subName="customers"}
...
<head>
    ...
    {literal}
        ...
        <script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
          ...
          })(window,document,'script','dataLayer','GTM-MK3CMMLR');</script>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-MK3CMMLR"
