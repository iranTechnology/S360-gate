        ...
        <div class="row">
            <div class="col-lg-3 col-sm-6 service_item">
                <div class="service-item site-bg-main-color">
                    ...
                    <span class="service-item-title">الضمان</span>
                    <p>يتم فحص جميع خدماتنا من مرحلة البحث إلى مرحلة الشراء بعناية خاصة ، في حالة حدوث أي أخطاء ناتجة عن
                        عملنا ، سنقوم بتعويض جميع الأضرار التي لحقتكم. </p>
                </div>
            </div>
            <div class="col-lg-3 col-sm-6 service_item">
                <div class="service-item site-bg-main-color">
                    ...
                    <span class="service-item-title">دعم على مدار 24 ساعة </span>
                    <p>في أي وقت من الـ 24 ساعة في اليوم وأينما كنت في العالم ، سترانا من خلال الدردشة والمكالمة
                        الهاتفية حتى تتمكن من التأكد من شرائك. </p>
                </div>
            </div>
            <div class="col-lg-3 col-sm-6 service_item">
                <div class="service-item site-bg-main-color">
                    ...
                    <span class="service-item-title">أفضل سعر</span>
                    <p>بحث قصير يؤكد لك أن أسعارنا والخدمات التي نقدمها هي الأنسب والأفضل. </p>
                </div>
            </div>
            <div class="col-lg-3 col-sm-6 service_item">
                <div class="service-item site-bg-main-color">
                    ...
                    <span class="service-item-title">خبرة</span>
                    <p>أكثر من نصف قرن من الخبرة في تقديم الخدمات السياحية وبيع التذاكر وتقديم الجولات وإصدار التأشيرات
                        في إيران وخارجها. </p>
                </div>
            </div>
        </div>
