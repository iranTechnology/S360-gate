...
{load_presentation_object filename="avaParvazEn" assign="obj_main_page" subName="customers"}
...
<link href="project_files/images/favicon.png" rel="shortcut icon" type="image/x-icon"/>
    ...
    <link rel="stylesheet" href="project_files/css/header.css"><link rel="stylesheet" href="project_files/css/bootstrap.min.css">
...
<link rel="stylesheet" href="project_files/css/owl.carousel.min.css"><link rel="stylesheet" href="project_files/css/tabs.css"><link rel="stylesheet" href="project_files/css/select2.css">
