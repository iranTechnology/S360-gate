...
<div class="tab-pane  {if  $smarty.const.GDS_SWITCH eq 'page'}active{/if}" id="Tour">
    ...
    <div id="internal_tour" class="internal-tour-js">
                ...
                <form data-action="https://s360online.iran-tech.com/" class="d_contents" method="post"
                    ...
                    <div class="col-lg-2 col-md-6 col-sm-6 col-12 btn_s col_search">
                        <button type="button" onclick="searchInternalTour()" class="button_searchBox w-100">
    ...
    <div id="international_tour" class="international-tour-js" style='display: none;'>
                ...
                <form data-action="https://s360online.iran-tech.com/" class="d_contents" method="post"
                    ...
                    <div class="col-lg-2 col-md-6 col-sm-6 col-12 btn_s col_search">
                        <button type="button" onclick="searchInternationalTour()" class="button_searchBox w-100">
                            <span>جستجو</span>
                        </button>
                    </div>
                </form>
