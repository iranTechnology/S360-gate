    ...
    <ul class="m-0 p-0 d-flex">
     ...
     <a class="__mobile_class__" href="tel:{$smarty.const.CLIENT_MOBILE}">
      ...
      <div class="__social_class__ footer_icons">
       <a class="__instagram_class__ fab fa-instagram footer_instagram" href="{if $telegramHref}{$instagramHref}{/if}">
       ...
       <a class="__whatsapp_class__ fab fa-whatsapp footer_whatsapp" href="{if $telegramHref}{$whatsappHref}{/if}">
        <svg viewbox="0 0 448 512" xmlns="http://www.w3.org/2000/svg">
         <!--! Font Awesome Pro 6.1.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
       ...
       <a class="__telegram_class__ fab fa-telegram footer_telegram" href="{if $telegramHref}{$telegramHref}{/if}">
      ...
      <div class="namads">
       ...
       <a href="javascript:">
        <img alt="namad-1" src="project_files/images/certificate5.png"/>
       </a>
       <a href="javascript:">
        <img alt="namad-2" src="project_files/images/certificate3.png"/>
       </a>
       <a href="javascript:">
        <img alt="namad-3" src="project_files/images/certificate4.png"/>
       </a>
      </div>
     </li>
     <li class="d-none d-md-block col-12 col-md-6 my-4 col-lg-4">
      ...
      <div class="asan">
       ...
       <a class="asan_link" href="{$smarty.const.ROOT_ADDRESS}/weather">
        meteorology
       </a>
       <a class="asan_link" href="{$smarty.const.ROOT_ADDRESS}/aboutIran">
       ...
       <a class="asan_link" href="{$smarty.const.ROOT_ADDRESS}/iranVisa">
        Iran visa
       </a>
      </div>
     </li>
