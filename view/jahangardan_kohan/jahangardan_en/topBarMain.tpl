...
{literal}
    <script  type="text/javascript" src="https://www.parvaz.ir/fa/user/js/jquery-3.4.1.min.js"></script>
    <script type="text/javascript">
        ...
        function signout() {
            $.post('https://online.parvaz.ir/gds/user_ajax.php',
                {flag: 'signout'},
                function (data) {
                    window.top.location.href ="https://www.parvaz.ir/fa/user/home.php";
                }
            )
        }
    </script>
