...
{load_presentation_object filename="atiyeGasht" assign="obj_main_page" subName="customers"}
...
<head>
    ...
    <link rel="icon" type="image/png" sizes="64x64" href="project_files/images/favicon.png">
