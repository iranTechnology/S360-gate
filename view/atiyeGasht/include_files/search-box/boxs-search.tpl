...
{*
<div class="__box__ tab-pane active" id="Train">
...
<div class="__box__ tab-pane" id="Tour">
    ...
    <div id="internal_tour" class="internal-tour-js w-100">
        <h5 class="title_searchBox">رزرو تور داخلی</h5>
        <div class="col-12">
            <div class="row">
    ...
    <div id="international_tour" class="international-tour-js w-100">
        <h5 class="title_searchBox">رزرو تور خارجی</h5>
        <div class="col-12">
            <div class='row'>
                <form data-action="https://s360online.iran-tech.com/" class="d_contents" method="post"
