<div class="col-lg-2 col-md-6 col-sm-6 col-12 col_search">
    <div class="select inp-s-num adt box-of-count-passenger box-of-count-passenger-js">
        ...
        <div class="box-of-count-passenger-boxes box-of-count-passenger-boxes-js">
            <span class="text-count-passenger text-count-passenger-js">1 بزرگسال ,0 کودک</span>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 col-6">
                        <div class="num-of-count-passenger">
                            <i class="fa fa-plus counting-of-count-passenger add-to-count-passenger-js" data-train="yes"></i>
                            ...
                            <i class="fa fa-minus counting-of-count-passenger minus-to-count-passenger-js" data-train="yes"></i>
                        </div>
                    </div>
                </div>
            </div>
