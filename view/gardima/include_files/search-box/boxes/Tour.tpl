...
<button class="btn theme-btn seub-btn b-0" onclick="searchInternalTour(true)" type="button">
<span>
جستجو
 </span>
</button>
...
<div class="col-lg-2 col-md-6 col-sm-6 col-12 btn_s col_search p-1">
<button class="btn theme-btn seub-btn b-0" onclick="searchInternationalTour(true)" type="button">
<span>
جستجو
 </span>
</button>
