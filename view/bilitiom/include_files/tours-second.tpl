        ...
        <div class="container">
            ...
            <div class="parent-tab-tour">
                <div class="tab-content" id="pills-tabContent">
                    <div aria-labelledby="tab-tour-dakheli" class="tab-pane fade  " id="tour-dakheli"
                         role="tabpanel">
                        <div class="__tour__internal__special__ owl-carousel owl-theme owl-tour-safiran">
                                            ...
                                            <div class="text">
                                                <h3>
                                                    <a class="__title_class__"
                                                       href="{$smarty.const.ROOT_ADDRESS}/detailTour/{$item['id_same']}/{$item['tour_slug']}">{$item['tour_name']}</a>
...
<span class="__date_class__">{assign var="year" value=substr($item['start_date'], 0, 4)}
    ...
    {$year}/{$month}/{$day}
                                                ...
                                                <div class="star d-flex clearfix more_tour">
                                                    <h4 class="___price_class__ price">{$item['min_price']['discountedMinPriceR']|number_format}<i>ریال</i></h4>
                                                    <a href="{$smarty.const.ROOT_ADDRESS}/detailTour/{$item['id_same']}/{$item['tour_slug']}"><span>مشاهده جزئیات</span></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div aria-labelledby="tab-tour-khareji" class="tab-pane fade show active" id="tour-khareji" role="tabpanel">
                        <div class="__tour__external__special__ owl-carousel owl-theme owl-tour-safiran">
