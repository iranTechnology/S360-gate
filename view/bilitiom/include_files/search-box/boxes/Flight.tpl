<div class="__box__ tab-pane active" id="Flight_internal">
    <div class="_internal d_flex flex-wrap internal-flight-js" id="internal_flight">
        <form class="d_contents" id="internal_flight_form" method="post" name="internal_flight_form" target="_blank">
            <div class="col-md-12 col-xs-12 col-sm-12 d-ceckboxs px-1">
                <div class="cntr">
                    <label class="btn-radio select-type-way-js" data-type="internal" for="rdo-10">
                        <input checked="" class="internal-one-way-js" id="rdo-10" name="select-rb2" type="radio"
                               value="1" />
            ...
            <div class="col-lg-2 col-md-6 col-sm-6 col-12 col_search col_with_route p-1">
                <div class="form-group">
                    <div class="form-group origin_start">
                        <input autocomplete="off" class="form-control inputSearchLocal route_origin_internal-js"
                               id="route_origin_internal" name="route_origin_internal"
                               onclick="displayCityList('origin')" placeholder="مبدأ ( شهر )" type="text" />
                        <input class="origin-internal-js" data-border-red="#route_origin_internal"
                               id="route_origin_internal" name="route_origin_internal" placeholder="مبدأ" type="hidden"
                               value="" />
                        <div class="resultUlInputSearch list-show-result list-origin-airport-internal-js"
                             id="list_airport_origin_internal">
                        </div>
                        <div class="resultUlInputSearch list-show-result list_popular_origin_internal-js"
                             id="list_origin_popular_internal">
                        </div>
                    </div>
                </div>
...
<input autocomplete="off" class="inputSearchForeign form-control route_destination_internal-js"
       id="route_destination_internal" name="route_destination_internal" onclick="displayCityList('destination')"
       placeholder="مقصد ( شهر )" type="text" />
</span>
                    <input class="destination-internal-js" data-border-red="#route_destination_internal"
                           id="route_destination_internal" name="route_destination_internal" placeholder="مقصد"
                           type="hidden" value="" />
                    <div class="resultUlInputSearch list-show-result list-destination-airport-internal-js"
                         id="list_destination_airport_internal">
                    </div>
                    <div class="resultUlInputSearch list-show-result list_popular_destination_internal-js"
                         id="list_destination_popular_internal">
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-6 col-12 col_search date_search p-1">
                <div class="form-group">
                    <input class="deptCalendar form-control went departure-date-internal-js"
                           id="departure_date_internal" name="departure_date_internal" placeholder="تاریخ رفت"
                           readonly="" type="text" />
                    <i class="fa-solid fa-calendar-days"></i>
                </div>
                <div class="form-group">
                    <input class="checktest returnCalendar form-control return_input internal-arrival-date-js"
                           disabled="" id="arrival_date_internal" name="arrival_date_internal" placeholder="تاریخ برگشت"
                           readonly="" type="text" />
                    <i class="fa-solid fa-calendar-days"></i>
                </div>
            </div>
            <div class="col-lg-2 col-md-6 col-sm-6 col-12 col_search p-1">
                <div class="select inp-s-num adt box-of-count-passenger box-of-count-passenger-js">
                    <input class="internal-adult-js" id="count_adult_internal" name="count_adult_internal" type="hidden"
                           value="1" />
                    <input class="internal-child-js" id="count_child_internal" name="count_child_internal" type="hidden"
                           value="0" />
                    <input class="internal-infant-js" id="count_infant_internal" name="count_infant_internal"
                           type="hidden" value="0" />
                        ...
                        <div class="col-xs-12 cbox-count-passenger-ch adult-number-js">
                            <div class="row">
                                <div class="col-xs-12 col-sm-6 col-6">
                                    <div class="type-of-count-passenger"><h6> بزرگسال </h6>
                                        (بزرگتر از ۱۲ سال)
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-6">
                                    <div class="num-of-count-passenger">
                                        ...
                                        <i class="number-count-js number-count counting-of-count-passenger" data-min="1"
                                           data-number="1" data-search="internal" data-type="adult">1</i>
                                ...
                                <div class="col-xs-12 col-sm-6 col-6">
                                    <div class="num-of-count-passenger"><i
                                        ...
                                        <i class="number-count-js number-count counting-of-count-passenger" data-min="0"
                                           data-number="0" data-search="internal" data-type="child">0</i>
                                        <i class="fa fa-minus counting-of-count-passenger minus-to-count-passenger-js"></i>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-6 col-6">
                                    <div class="num-of-count-passenger">
                                        <i class="fa fa-plus counting-of-count-passenger add-to-count-passenger-js"></i>
                                        <i class="number-count-js number-count counting-of-count-passenger" data-min="0"
                                           data-number="0" data-search="internal" data-type="infant">0</i>
                                        <i class="fa fa-minus counting-of-count-passenger minus-to-count-passenger-js"></i>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="select inp-s-num adt box-of-count-passenger box-of-count-passenger-js">
                    ...
                    <div class="cbox-count-passenger cbox-count-passenger-js">
                        ...
                        <div class="col-xs-12 cbox-count-passenger-ch child-number-js">
                            <div class="row">
                                <div class="col-xs-12 col-sm-6 col-6">
                                    <div class="type-of-count-passenger"><h6> کودک </h6>(بین 2
                                        الی 12 سال)
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-6">
                        ...
                        <div class="col-xs-12 cbox-count-passenger-ch infant-number-js">
                            <div class="row">
                                <div class="col-xs-12 col-sm-6 col-6">
                                    <div class="type-of-count-passenger"><h6> نوزاد </h6>(کوچکتر
                                        از 2 سال)
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-6 col-6">
