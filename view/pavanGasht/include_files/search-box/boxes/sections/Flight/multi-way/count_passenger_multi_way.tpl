<div class="col-lg-2 col-md-6 col-sm-6 col-12 col_search p-1">
    <div class="inp-s-num adt box-of-count-passenger box-of-count-passenger-js">
        <input type="hidden" class="multi-adult-js" name="adult_number_multi"
               id="count_adult_multi" value="1">
        <input type="hidden" class="multi-child-js" name="child_number_multi"
               id="count_child_multi" value="0">
        <input type="hidden" class="multi-infant-js" name="infant_number_multi"
               id="count_infant_multi" value="0">
                    ...
                    <div class="col-xs-12 col-sm-6 col-6">
                        <div class="num-of-count-passenger">
                            ...
                            <i class="number-count-js number-count counting-of-count-passenger"
                               data-number="1" data-min="1" data-search="multi"
                               data-type="adult">1</i>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 col-6">
                        <div class="num-of-count-passenger">
                            <i class="fa fa-plus counting-of-count-passenger add-to-count-passenger-js"></i>
                            <i class="number-count-js number-count counting-of-count-passenger"
                               data-number="0" data-min="0" data-search="multi"
                               data-type="child">0</i>
                            <i class="fa fa-minus counting-of-count-passenger minus-to-count-passenger-js"></i>
                        </div>
                    </div>
