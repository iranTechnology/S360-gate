...
<div class="__box__ tab-pane active" id="Flight_internal">
    <div {if $page['slug'] eq 'flight-foreign'} style='display: none' {/if} class="d_flex flex-wrap internal-flight-js " id="internal_flight">
        <form class="d_contents" id="internal_flight_form" method="post" name="internal_flight_form" target="_blank">

            <div class="col-md-12 col-xs-12 col-sm-12 mt-0 mt-sm-5 mt-md-4 mt-lg-4 mt-xl-4 mt-xxl-4 d-ceckboxs">
                <div class="align-right {if $page['slug'] neq 'flight-foreign' && $page['slug'] neq 'flight-iran'}cntr{else}mb-3{/if}">
...
<div class="__box__ tab-pane" id="Flight_external">
    <div  id="international_flight" class="d_flex _external flex-wrap international-flight-js">

    <form class="d_contents" id="external_flight_form" method="post" name="external_flight_form" target="_blank">
                        {*            mt-lg-4                       *}
            <div class="col-md-12 col-xs-12 col-sm-12 mt-0 mt-sm-5 mt-md-4 mt-lg-4 mt-xl-4 mt-xxl-4 d-ceckboxs">
                <div class="cntr">
...
{*            <div class="col-lg-2 col-md-3 col-sm-6 col-12 btn_s col_search margin-center p-1">*}
{*                <button class="btn theme-btn seub-btn b-0" onclick="searchFlight('external')" type="button"><span>جستجو</span></button>*}
{*            </div>*}
