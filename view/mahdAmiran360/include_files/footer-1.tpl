      ...
      <div class="col-lg-4 col-md-6 col-sm-12 col-12 p-0">
       <div class="parent-namad">
        ...
        <div class="namads">
         ...
         <a referrerpolicy='origin' target='_blank' href='https://trustseal.enamad.ir/?id=473437&Code=FrVILpUCqnnsc8GLyBaTHz4h4fQrRkI4'><img referrerpolicy='origin' src='https://trustseal.enamad.ir/logo.aspx?id=473437&Code=FrVILpUCqnnsc8GLyBaTHz4h4fQrRkI4' alt='' style='cursor:pointer' code='FrVILpUCqnnsc8GLyBaTHz4h4fQrRkI4'></a>
        </div>
       </div>
      </div>
     </div>
