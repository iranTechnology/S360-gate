...
<section class="i_modular_menu gym" id="gym-box">
    <div class="container">
        <div class="parent-gym">
            <div class="gym-text">
                <h3>باشگاه همسفران سفر 360</h3>
                <p>به باشگاه سفر360 خوش آمدید، جایی که همه ی سفرها به یاد ماندنی می شوند. اینجا مکانی است برای

                    شما که در ماجراجویی های خود، سفر360 را انتخاب کرده اید.</p>
                <p>در این باشگاه منحصر به فرد، خدمات و امکاناتی وجود دارند که تجربه ی سفرهای با سفر360 را به اوج

                    می رسانند.

                    شما به عنوان یک همسفر ویژه، بازیگر اصلی این ماجرا هستید. به ما بپیوندید و با سفر360، به
