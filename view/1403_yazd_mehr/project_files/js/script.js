...
$(document).ready(function () {
    ...
    $('#number_of_passengers').on('change', function (e) {
        ...
        var i = 1;
        while (i < itemInsu) {
            HtmlCode += "<div class='col-lg-2 col-md-3 col-6 col_search search_col nafarat-bime '>" + "<div class='form-group'>" + "<input placeholder='تاریخ تولد مسافر " + i + "' autocomplete='off' type='text' name='txt_birth_insurance" + i + "' id='txt_birth_insurance" + i + "' class='shamsiBirthdayCalendar form-control' />" + "<i class='fal fa-calendar-alt'></i>" + "</div>" + "</div>";
            i++;
        }
    ...
    $('body').on('click', '.btn_add_room', function (e) {
        ...
        $(this).parents(".myhotels-rooms").find(".close").removeClass("d-none");
