...
$(document).ready(function () {
    ...
    $(".plus-nafar").click(function () {
        ...
        if (nafarnozad == 0 && nafarkoodak == 0) {
            let allNafarat = nafarbozorg + nafarkoodak + nafarnozad;$(this).parents(".box-of-count-nafar").find(".text-count-nafar").text(allNafarat + " passenger ");
        } else {
            let allNafarat = nafarbozorg + nafarkoodak + nafarnozad;$(this).parents(".box-of-count-nafar").find(".text-count-nafar").text(allNafarat + " passenger ");
        }
    });
    $(".minus-nafar").click(function () {
        ...
        if (nafarnozad2 == 0 && nafarkoodak2 == 0) {
            let allNafarat = nafarbozorg2 + nafarkoodak2 + nafarnozad2;$(this).parents(".box-of-count-nafar").find(".text-count-nafar").text(allNafarat + " passenger ");
        } else {
            let allNafarat = nafarbozorg2 + nafarkoodak2 + nafarnozad2;$(this).parents(".box-of-count-nafar").find(".text-count-nafar").text(allNafarat + " passenger ");
        }
    });
    ...
    $('body').on('click', '.myroom-hotel-item .close', function () {
        ...
        $('.myroom-hotel-item').each(function () {
            ...
            $(this).find('.myroom-hotel-item-title').html('<span class="close"><i class="fal fa-trash-alt"></i></span> room ' + numberText );
