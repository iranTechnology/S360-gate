        ...
        <div class="box-tabs-parent">
            <ul class="nav nav-pills ul-tabs" id="tours-tab" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="tour-dakheli-tab" data-toggle="pill" data-target="#pills-tour-dakheli" type="button" role="tab" aria-controls="pills-tour-dakheli" aria-selected="true">Internal</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="tour-khareji-tab" data-toggle="pill" data-target="#pills-tour-khareji" type="button" role="tab" aria-controls="pills-tour-khareji" aria-selected="false">Foreign</button>
                </li>
            </ul>
                            ...
                            <div class="square-flip">
                                <div class="tour-view">
                                    ...
                                    <div class="square-container2">
                                        <div class="box-title">
                                            <h4>{$item['tour_name_en']} Tour</h4>
                                            <h6>{$item['min_price_a']} / per persons</h6>
                                        </div>
                                    </div>
                                </div>
                                <div class="tour-back-white">
                                    <div class="square-container">
                                        ...
                                        <a href="{$smarty.const.ROOT_ADDRESS}/detailTour/{$item['id']}/{$item['tour_slug']}" class="tour-details">Tour details</a>
                                    </div>
                                </div>
                            </div>
                        {/foreach}
                            ...
                            <div class="square-flip">
                                ...
                                <div class="tour-back-white">
                                    <div class="square-container">
                                        <h4>{$item['tour_name_en']} Tour</h4>
                                        <h6>{$item['min_price_a']} / per persons</h6>
                                        <span>{$item['description']|truncate:300}</span>
                                        <div class="tour-list">
                                            <div class="tour-list-item">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.3.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path d="M464 256A208 208 0 1 1 48 256a208 208 0 1 1 416 0zM0 256a256 256 0 1 0 512 0A256 256 0 1 0 0 256zM232 120V256c0 8 4 15.5 10.7 20l96 64c11 7.4 25.9 4.4 33.3-6.7s4.4-25.9-6.7-33.3L280 243.2V120c0-13.3-10.7-24-24-24s-24 10.7-24 24z"/></svg>
                                                <span> {$item['night'] + 1} Days</span>
