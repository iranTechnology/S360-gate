            ...
            <div class="">
                <div class="owl-carousel owl_tour_local owl-rtl owl-loaded owl-drag">
                    <div class="owl-stage-outer">
                        <div class="owl-stage" style="transform: translate3d(0px, 0px, 0px); transition: all 0.25s ease 0s; width: 313px;">
                            <div class="owl-item active" style="width: 311.75px; margin-left: 1px;">
                                {foreach $special_tours as $tour}
                                    ...
                                    <div class="single_place">
                                        <div class="thumb">
                                            ...
                                            <a href="{$smarty.const.ROOT_ADDRESS}/detailTour/{$tour['id']}/{$tour['tour_name_en']}" class="prise">
                                                <div class="package__details__inner">
                                                    <p>شروع قیمت از</p>
                                                    <p class="packg__prize">{$tour['min_price_r']|number_format}                                                    تومان<span></span>
                                                    </p>
                                                </div>
                                            </a>
                                        </div>
                                        <div class="place_info">
                                            <a href="{$smarty.const.ROOT_ADDRESS}/detailTour/{$tour['id']}/{$tour['tour_name_en']}">
                                                <h3>{$tour['tour_name']}</h3>
                                            </a>

                                            <div class="rating_days flex-wrap d-flex justify-content-between">
                                            <span class="w-100"><i class="fa fa-clock"></i> مدت تور : <em>{$tour['night']} شب </em>
                                            </span>
                                                <span class="w-100">
