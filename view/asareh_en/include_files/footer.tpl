...
{assign var="about"  value=$objAbout->getData('en')}
                        ...
                        <div class="parent-footer-iran d-flex flex-wrap w-100">
                            <div class="item-footer col-lg-4 col-md-6 col-sm-12 col-12  order-foot1">
                                <div class="parent-item-footer parent-item-footer-responsive">
                                    ...
                                    <div class="child-item-footer">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><!--! Font Awesome Pro 6.3.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path d="M64 48c-8.8 0-16 7.2-16 16V448c0 8.8 7.2 16 16 16H288c8.8 0 16-7.2 16-16V64c0-8.8-7.2-16-16-16H64zM0 64C0 28.7 28.7 0 64 0H288c35.3 0 64 28.7 64 64V448c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V64zM144 400h64c8.8 0 16 7.2 16 16s-7.2 16-16 16H144c-8.8 0-16-7.2-16-16s7.2-16 16-16z"/></svg>
                                    ...
                                    {if $additional_data}
                                        {foreach $additional_data as $index => $item}
                                            ...
                                            and ($item['body'] neq $smarty.const.CLIENT_MOBILE)
                                            and ($item['body'] neq $smarty.const.CLIENT_PHONE)
                                            and $index < 1}
                                                <div class="child-item-footer">
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><!--! Font Awesome Pro 6.3.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path d="M64 48c-8.8 0-16 7.2-16 16V448c0 8.8 7.2 16 16 16H288c8.8 0 16-7.2 16-16V64c0-8.8-7.2-16-16-16H64zM0 64C0 28.7 28.7 0 64 0H288c35.3 0 64 28.7 64 64V448c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V64zM144 400h64c8.8 0 16 7.2 16 16s-7.2 16-16 16H144c-8.8 0-16-7.2-16-16s7.2-16 16-16z"/></svg>
                                                    <a href="tel:{$item['body']}" class="">
                                                        {$item['body']}
                                                    </a>
                                                </div>
                                            {/if}
                                    ...
                                    <div class="d-block d-md-none child-item-footer">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><!--! Font Awesome Pro 6.1.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M318.7 268.7c-.2-36.7 16.4-64.4 50-84.8-18.8-26.9-47.2-41.7-84.7-44.6-35.5-2.8-74.3 20.7-88.5 20.7-15 0-49.4-19.7-76.4-19.7C63.3 141.2 4 184.8 4 273.5q0 39.3 14.4 81.2c12.8 36.7 59 126.7 107.2 125.2 25.2-.6 43-17.9 75.8-17.9 31.8 0 48.3 17.9 76.4 17.9 48.6-.7 90.4-82.5 102.6-119.3-65.2-30.7-61.7-90-61.7-91.9zm-56.6-164.2c27.3-32.4 24.8-61.9 24-72.5-24.1 1.4-52 16.4-67.9 34.9-17.5 19.8-27.8 44.3-25.6 71.9 26.1 2 49.9-11.4 69.5-34.3z"/></svg>
                                        <a href="https://dukatour.com/gds/en/app/" class="">
                                            IOS Application
                                        </a>
                                    </div>
                                    <div class="d-block d-md-none child-item-footer">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><!--! Font Awesome Pro 6.1.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M420.55,301.93a24,24,0,1,1,24-24,24,24,0,0,1-24,24m-265.1,0a24,24,0,1,1,24-24,24,24,0,0,1-24,24m273.7-144.48,47.94-83a10,10,0,1,0-17.27-10h0l-48.54,84.07a301.25,301.25,0,0,0-246.56,0L116.18,64.45a10,10,0,1,0-17.27,10h0l47.94,83C64.53,202.22,8.24,285.55,0,384H576c-8.24-98.45-64.54-181.78-146.85-226.55"/></svg>
                                        <a href="https://dukatour.com/apk/dukaTourEn.apk" class="">
                                            Android Application
                                        </a>
                                    </div>
                                    <div class="footer-icon my-footer-icon">
                                        ...
                                        {foreach $socialLinks as $key => $socialMedia}
                                            {if $socialMedia['social_media'] == 'instagram'}
                                                <a target="_blank" href="{$socialMedia['link']}" class=" footer_instagram">
                                            ...
                                            {if $socialMedia['social_media'] == 'whatsapp'}
                                                <a target="_blank" href="{$socialMedia['link']}" class=" footer_whatsapp">
                                            ...
                                            {if $socialMedia['social_media'] == 'telegram'}
                                                <a target="_blank" href="{$socialMedia['link']}" class=" footer_telegram">
                                            ...
                                            {/if}
                                            {if $socialMedia['social_media'] == 'linkdin'}
                            ...
                            <div class="item-footer col-lg-4 col-md-6 col-sm-12 col-12  display-footer-none">
                                <div class="box-item-footer text-right">
                                    ...
                                    <ul>
                                        <li>
                                            <a href="{$smarty.const.ROOT_ADDRESS_WITHOUT_LANG}/en/iranVisa">
                                                Iran visa
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{$smarty.const.ROOT_ADDRESS_WITHOUT_LANG}/en/orderServices">
                                                Service request
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{$smarty.const.ROOT_ADDRESS_WITHOUT_LANG}/en/weather">
                                                Meteorology
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{$smarty.const.ROOT_ADDRESS_WITHOUT_LANG}/en/clock">
                                                countries clock
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{$smarty.const.ROOT_ADDRESS_WITHOUT_LANG}/en/recommendation">
                                                travelogue
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{$smarty.const.ROOT_ADDRESS_WITHOUT_LANG}/en/aboutIran">Introduction Iran</a>
                                        </li>
                                        <li>
                                            <a href="{$smarty.const.ROOT_ADDRESS_WITHOUT_LANG}/en/news">
                                                site News
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{$smarty.const.ROOT_ADDRESS_WITHOUT_LANG}/en/agencyList">
                                                Agencies
                                            </a>
                                        </li>
{*                                        <li>*}
{*                                            <a href="{$smarty.const.ROOT_ADDRESS_WITHOUT_LANG}/en/contactUs">*}
{*                                                Contact us*}
{*                                            </a>*}
{*                                        </li>*}
                                        <li>
                                        ...
                                        <li>
                                            <a href="https://dukatour.com/apk/dukaTourEn.apk">
                                                Android Application
                                            </a>
                                        </li>
{*                                        <li>*}
{*                                            <a href="{$smarty.const.ROOT_ADDRESS_WITHOUT_LANG}/en/page/hotel">*}
{*                                                Dubai  Hotel*}
{*                                            </a>*}
{*                                        </li>*}
{*                                        <li>*}
{*                                            <a href="{$smarty.const.ROOT_ADDRESS_WITHOUT_LANG}/en/page/tour">*}
{*                                                Dubai  Tour*}
{*                                            </a>*}
{*                                        </li>*}
                                    </ul>
                            ...
                            <div class="item-footer col-lg-4 col-md-6 col-sm-12 col-12 order-foot2">
                                <div class="parent-namad box-item-footer text-right">
                                    ...
                                    <div class="namads">
                                        ...
                                        <a href="javascript:"><img src="project_files/images/enamad.png" alt="namad-2"></a>
                                    </div>
            ...
            <div class="last_text col-12">
                <a class="last_a" href="https://www.iran-tech.com/">Tourism website design </a>
                <p class="last_p_text">: Iran technology</p>
            </div>
            <a href="javascript:" class="fixicone" id="scroll-top" >
