            ...
            <nav id="navigation1" class="navigation">
                <div class="nav-header">
                    <a class="nav-brand" href="https://{$smarty.const.CLIENT_DOMAIN}/{$smarty.const.SOFTWARE_LANG}">
                        ...
                        <div class="logo-caption">
                            <h1>
                                <span class="top-span"> Dukatour  </span>
                                <span class="sum-span">travel agency</span>
                            </h1>
                        </div>
                    </a>
                </div>
                <div class="nav-menus-wrapper ">
                    <ul class="nav-menu align-to-right">
                        <li>
                            <a class="link-header" href="https://{$smarty.const.CLIENT_DOMAIN}/{$smarty.const.SOFTWARE_LANG}">Home</a>
                        </li>
                        <li>
                            <a href="javascript:">Dubai Tour</a>
                            <ul class="nav-dropdown nav-submenu ">
                                {foreach $dubaiTours as $item}
                                    <li>
                                        <a href="{$smarty.const.ROOT_ADDRESS_WITHOUT_LANG}/en/detailTour/{$item['id']}/{$item['tour_slug']}">{$item['tour_name_en']}</a>
                                    </li>
                                {/foreach}
                            </ul>
                        </li>
                        <li>
                            <a href="javascript:">Dubai  Hotel</a>
                            <ul class="nav-dropdown nav-submenu ">
                        ...
                        <li>
                            <a href="{$smarty.const.ROOT_ADDRESS_WITHOUT_LANG}/en/resultEntertainment/all/all/all&is_request=1">Tourism Services</a>
                        </li>
                        <li>
                            <a href="{$smarty.const.ROOT_ADDRESS_WITHOUT_LANG}/en/mag">Blog</a>
                        </li>
                        <li>
                            <a href="javascript:"> Our agency</a>
                            <ul class="nav-dropdown nav-submenu ">
                                <li><a href="{$smarty.const.ROOT_ADDRESS_WITHOUT_LANG}/en/page/documents">documents and forms</a></li>
                                <li><a href="{$smarty.const.ROOT_ADDRESS_WITHOUT_LANG}/en/UserTracking">track order</a></li>
                                <li><a href="{$smarty.const.ROOT_ADDRESS_WITHOUT_LANG}/en/aboutUs">about us</a></li>
                                <li><a href="{$smarty.const.ROOT_ADDRESS_WITHOUT_LANG}/en/contactUs">contact us</a></li>
                                <li><a href="{$smarty.const.ROOT_ADDRESS_WITHOUT_LANG}/en/faq">common questions</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
                <div class="parent-btn-header">
                    ...
                    <a class="main-navigation__button2 button  btn-user " href="javascript:">
                        <span>
                            {include file="`$smarty.const.FRONT_THEMES_DIR`asareh_en/topBarName.tpl"}
                        </span>
                    ...
                    <div class="main-navigation__sub-menu2 arrow-up p-0">
                        ...
                        {include file="`$smarty.const.FRONT_THEMES_DIR`asareh_en/topBar.tpl"}
...
{*                            <li>*}
{*                                <a href="https://dukatour.ir/">*}
{*                                <span>*}
{*                                  <img src="project_files/images/language-icon-fa.png" alt="img">*}
{*                                    fa*}
{*                              </span>*}
{*                                </a>*}
{*                            </li>*}
