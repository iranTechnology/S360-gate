...
{*                            <li>*}
{*                                <a href="{$smarty.const.ROOT_ADDRESS}/lottery">*}
{*                                    بسته تخفیفات*}
{*                                </a>*}
{*                            </li>*}
                            <li>
                            ...
                            <li>
                                ...
                                <ul class="nav-dropdown">
                                    ...
                                    <li>
                                        <a href="https://charge.sep.ir/Charge">

                                            خرید شارژ، بسته اینترنتی و پرداخت کلیه قبوض
                                    ...
                                    <ul class="ul-menu-passengers">
                                        <li>
                                            ...
                                            <a
                                                    ...
                                                    {if $obj_main_page->isLogin()} href="{$smarty.const.ROOT_ADDRESS}/club"
                                                    {else}
                ...
                <div class="parent-btn-header">
                    ...
                    <a class="__phone_class__ button btn-phone"
                       href="tel:{$smarty.const.CLIENT_PHONE}">
                        <span>02166260003 - {$smarty.const.CLIENT_PHONE}</span>
