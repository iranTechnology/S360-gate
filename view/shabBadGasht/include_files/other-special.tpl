    ...
    <div class="container">
        ...
        <div class="parent-app-demo">
            <div class="items-app-demo">
                ...
                <a class="" href="/apk/shabBadGasht.apk">
            ...
            <div class="items-app-demo">
                ...
                <a class="" href="{$smarty.const.ROOT_ADDRESS_WITHOUT_LANG}/app">
        ...
        <div class="parent-app-demo-responsive">
            <div class="app-text-demo-responsive">
                ...
                <p>
                    ...
                    با استفاده از اپلیکیشن شب باد گشت در هر کجا که هستید جهان در
