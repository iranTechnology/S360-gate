...
{load_presentation_object filename="shabBadGasht" assign="obj_main_page" subName="customers"}
...
<link href="project_files/images/favicon.png" rel="shortcut icon" type="image/x-icon"/>
    ...
    <link rel="stylesheet" href="project_files/css/rangeslider.css">
...
{*        <script type="text/javascript" src="assets/datepicker-new/datepicker-declarations.js"></script>*}
    ...
    {literal}
        <script type="text/javascript">
            !function(){var i="tuV1Qe",a=window,d=document;function g(){var g=d.createElement("script"),s="https://www.goftino.com/widget/"+i,l=localStorage.getItem("goftino_"+i);g.async=!0,g.src=l?s+"?o="+l:s;d.getElementsByTagName("head")[0].appendChild(g);}"complete"===d.readyState?g():a.attachEvent?a.attachEvent("onload",g):a.addEventListener("load",g,!1);}();
        </script>
    {/literal}
