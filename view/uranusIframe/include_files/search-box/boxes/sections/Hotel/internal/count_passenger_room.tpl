<div class="col-lg-3 col-md-6 col-sm-12 col-12 col_search p-1">
    <div class="form-group">
        <div class="hotel_passenger_picker internal-hotel-passenger-picker-js">
            <div class="passenger-div" onclick="openCountPassenger('internal')">
            <p class="p-0 m-0 d-md-none">تعداد اتاق و مهمان</p>
                <div class="d-flex align-items-center hotel-parent-passenger" style="justify-content:inherit">
                <p class="p-0 m-0 parent-svg-search-box-p">
                    <i class="parent-svg-input-search-box p-0 mr-0 parent-svg-input-search-box-date">
                ...
                <div class="d-flex align-items-center hotel-child-passenger" style="gap:5px">
                <ul class="passenger-count">
                    <li><em class="number_adult internal-number-adult-js">2</em> بزرگسال ،</li>
                    <li class="li_number_baby d-none"><em class="number_baby internal-number-child-js">0</em> کودک ،</li>
                    <li><em class="number_room_po internal-number-room-js">1</em>اتاق</li>
                </ul>

            <p class="m-0 "><i class="fas fa-caret-down down-count-passenger"></i></p>
                </div>
                </div>
            </div>
