<div class="col-lg-4 col-md-6 col-sm-12 col-12 col_search search_col p-1">
    <div class="destination_start">
        <div class="s-u-in-out-wrapper raft raft-change change-bor w-100 parent-input-search-box">
            ...
            <input id="autoComplateSearchIN" name="autoComplateSearchIN"
                   class="inputSearchForeign w-100 border-0 bg-none" type="text" value=""
                   placeholder='مقصد یا نام هتل را وارد کنید'
                   autocomplete="off"
