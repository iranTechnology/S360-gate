<div class="col-lg-2 col-md-12 col-sm-12 col-12 col_search col_search_flight col_with_route p-1">
    <div class="form-group">
        <div class="form-group origin_start">
            ...
            <input autocomplete="off" class="form-control inputSearchLocal route_origin_internal-js"
                   id="route_origin_internal" name="route_origin_internal" onclick="displayCityList('origin')"
                   placeholder="مبدأ را انتخاب کنید" type="text" />
            <input class="origin-internal-js" data-border-red="#route_origin_internal" id="route_origin_internal"
                   name="route_origin_internal" placeholder="مبدأ" type="hidden" value="" />
