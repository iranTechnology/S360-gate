<div class="col-lg-3 col-md-6 col-sm-12 col-12 col_search p-1">
    <div class="select inp-s-num adt box-of-count-passenger box-of-count-passenger-js">
        <input class="internal-adult-js" id="count_adult_internal"
               name="count_adult_internal" type="hidden" value="1" />
        <input class="internal-child-js" id="count_child_internal"
               name="count_child_internal" type="hidden" value="0" />
        <input class="internal-infant-js" id="count_infant_internal"
               name="count_infant_internal" type="hidden" value="0" />
                    ...
                    <div class="col-xs-12 col-sm-6 col-6">
                        <div class="num-of-count-passenger">
                            ...
                            <i class="number-count-js number-count counting-of-count-passenger"
                               data-min="1" data-number="1" data-search="internal"
                               data-type="adult">1</i>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 col-6">
                        <div class="num-of-count-passenger"><i
                            ...
                            <i class="number-count-js number-count counting-of-count-passenger"
                               data-min="0" data-number="0" data-search="internal"
                               data-type="child">0</i>
                            <i class="fa fa-minus counting-of-count-passenger minus-to-count-passenger-js"></i>
                        </div>
                    </div>
