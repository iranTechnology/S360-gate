<div class="col-lg-2 col-md-12 col-sm-12 col-12 col_search search_col col_search_flight p-1">
    <div class="form-group">
                ...
                <input autocomplete="off" class="inputSearchForeign form-control route_destination_internal-js" id="route_destination_internal" name="route_destination_internal" onclick="displayCityList('destination')" placeholder="مقصد را انتخاب کنید" type="text"/>
