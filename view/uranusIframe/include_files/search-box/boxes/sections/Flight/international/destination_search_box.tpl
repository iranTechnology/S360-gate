...
<div class="col-lg-2 col-md-12 col-sm-12 col-12 col_search_flight col_search search_col p-1">
    <div class="form-group">
                ...
                <input autocomplete="off" class="inputSearchForeign form-control iata-destination-international-js"
                       ...
                       onclick='displayCityListExternal("destination" , event)' placeholder="مقصد را انتخاب کنید" type="text" />
                </span>
