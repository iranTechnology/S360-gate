<div class="col-lg-2 col-md-12 col-sm-12 col-12 col_search search_col col_search_flight col_with_route p-1">
    <div class="form-group origin_start">
        ...
        <input autocomplete="off"
               ...
               id="iata_origin_international" name="iata_origin_international"
               onclick='displayCityListExternal("origin" , event)'
               placeholder="مبدأ را انتخاب کنید" type="text" />
        <input class="origin-international-js"
               data-border-red="#iata_origin_international" id="origin_international"
               name="iata_origin_international" type="hidden" value="" />
        <div class="resultUlInputSearch list-show-result list-origin-airport-international-js"
             id="list_airport_origin_international">
        </div>
        <div class="resultUlInputSearch list-show-result list_popular_origin_external-js"
             id="list_origin_popular_external">
        </div>
    </div>
    <button class="switch_routs" name="button"
            onclick="reversDestination('international')" type="button">
