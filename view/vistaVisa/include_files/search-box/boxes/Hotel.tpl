<div class="__box__ tab-pane {if  $smarty.const.GDS_SWITCH eq 'page'}active{/if}" id="Hotel">
    <div class="d-flex flex-wrap gap-search-box">
        ...
        <div id="internal_hotel" class="_internal d_flex flex-wrap internal-hotel-js w-100">
        ...
        <div id="international_hotel" class="_external flex-wrap international-hotel-js w-100">
