<div class="col-lg-2 col-md-6 col-sm-6 col-12 col_search p-1">
 <div class="parent-input-search-box" style="opacity: 0.3;">
  ...
  <div class="caption-input-search-box">مبدأ تورهای خارجی</div>
  <input type="text" class=" " disabled placeholder="کشور مبدا: ایران">
