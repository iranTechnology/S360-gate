...
<label class="switch-label switch-label-on" for="btn_switch_Hotel_international">هتل خارجی</label>
...
<label class="switch-label switch-label-off" for="btn_switch_Hotel_internal">هتل داخلی</label>
