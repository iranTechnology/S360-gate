<div class="col-md-12 col-xs-12 col-sm-12 d-ceckboxs p-0">
    <div class="cntr">
        <label class="btn-radio select-type-way-js btn-radio-international" data-type="international" for="rdo-3" data-text='یک طرفه'>
        ...
        <label class="btn-radio select-type-way-js btn-radio-international" data-type="international" for="rdo-4" data-text='رفت و برگشت'>
