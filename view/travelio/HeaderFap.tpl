                            ...
                            <div class="megamenu-panel fadeIn animated  ">
                                <div class="megamenu-lists">
                                    <ul class="megamenu-list list-col-3">
                                        ...
                                        <li><a href="https://{$smarty.const.CLIENT_MAIN_DOMAIN}{$mainPage}/weather" class="SMWeather" target="_blank"> ##S360Weather## </a></li>
                    ...
                    <div class="nav-search">
                        <div class="top__user_menu">
                            <button class="main-navigation__button2">
                                ...
                                {include file="`$smarty.const.FRONT_THEMES_DIR`irantechs360/topBarName.tpl"}
                            ...
                            <div class="main-navigation__sub-menu2 arrow-up" style="display: none">
                                ...
                                {include file="`$smarty.const.FRONT_THEMES_DIR`irantechs360/topBar.tpl"}
