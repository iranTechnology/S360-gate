                    ...
                    <ul class="nav-menu ">
                        ...
                        <li class=""><a href="javascript:;">##Tour##</a>
                            <ul class="nav-dropdown first_child_menu  fadeIn animated">
                                ...
                                <li><a href="{$smarty.const.ROOT_ADDRESS}/page/tours">##TourSearch##</a></li>
...
{*                        <li id="hotels_m" class=""><a class="smoothScrollTo TabScroll " data-target="#hotel-tab"*}
{*                                                      href="{$smarty.const.ROOT_ADDRESS}/page/train"> ##Train## </a></li>*}
{*                        <li id="hotels_m" class=""><a class="smoothScrollTo TabScroll " data-target="#hotel-tab"*}
{*                                                      href="{$smarty.const.ROOT_ADDRESS}/page/bus"> ##Bus## </a></li>*}
...
{*                                        <li><a href="{$smarty.const.ROOT_ADDRESS}/aboutCountry" > ##S360IntroduceCountries## </a></li>*}
                                    ...
                                    <ul class="megamenu-list list-col-3">
                                        ...
                                        <li><a href="/en/#shamsiConvertDate" data-target=".shamsiConvertDate" class="smoothScrollTo"> ##S360ConvertDate## </a></li>
...
<div class="float-sm">
    <div class="fl-fl float-gp">
        <a href="{if $telegramHref}{$telegramHref}{else}javascript:;{/if}" target="_blank"><i class="fab fa-telegram"></i>Join us!</a>
    </div>
    <div class="fl-fl float-rs">
        <a href="tel:{$smarty.const.CLIENT_MOBILE}" target="_blank"><i class="fab fa-whatsapp"></i>contact us!</a>
    </div>
    <div class="fl-fl float-ig">
        <a href="{if $instagramHref}{$instagramHref}{else}javascript:;{/if}" target="_blank"><i class="fab fa-instagram"></i>Follow us!</a>
    </div>
</div>
<div class="left_text_">
    <div class="contact_popup">
        <div style="direction:rtl" class="popup_content">
            <div class="phone">##SoftwareDemo##</div>
        </div>
    </div>
    <div class="tejari">##NonCommercial##</div>
</div>
