    ...
    <path d="M250,246.5c-97.85,0-186.344-40.044-250-104.633V250h500V141.867C436.344,206.456,347.85,246.5,250,246.5z"></path>
        ...
        <footer class="footer">
            <div class="footer_top">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-6 col-md-6 col-lg-6 col_foo">
                        ...
                        <div class="col-xl-6 col-md-6 col-lg-6 col_foo foo_contact">
                            ...
                            <div class="address footer_widget">
                                ...
                                <div class="contact_info_text">
                                    ...
                                    <a href="mailto:{$smarty.const.CLIENT_EMAIL}" target="_top"
                        ...
                        <div class="col-12 ">
                            <div class="col_namads">
                                <a target="_blank" rel="nofollow" href="https://www.cao.ir/paxrights">
                                    <img src="project_files/{$smarty.const.SOFTWARE_LANG}/images/certificate1.png"
                                         alt="">
                                </a>
                                <a target="_blank" rel="nofollow" href="https://www.cao.ir/">
                                    <img src="project_files/{$smarty.const.SOFTWARE_LANG}/images/certificate2.png"
                                         alt="">
                                </a>
                                <a target="_blank" rel="nofollow" href="http://aira.ir/images/final3.pdf">
                                    <img src="project_files/{$smarty.const.SOFTWARE_LANG}/images/certificate3.png"
                                         alt="">
                                </a>
