...
<div class="section_hotel popular_destination_area">
    <div class="container">
        <ul class="nav nav-tabs" id="tabsHotel" role="tablist">
            <li class="nav-item">
                <a class="nav-link active show" id="Hotel_F-tab" data-toggle="tab" href="#Hotel_F" role="tab"
                   aria-controls="Hotel_F" aria-selected="false">
                    ##foreigneHotel##
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="Hotel_L-tab" data-toggle="tab" href="#Hotel_L"
        ...
        <div class="tab-content" id="tabsHotelContent">
            <div class="tab-pane" id="Hotel_L" role="tabpanel" aria-labelledby="Hotel_L-tab">
                <div class="row">
            ...
            <div class="tab-pane fade show active" id="Hotel_F" role="tabpanel" aria-labelledby="Hotel_F-tab">
                <div class="row">
                    <div class="owl_4 owl-carousel">
