...
{load_presentation_object filename="vistaVisa" assign="obj_main_page" subName="customers"}
...
<head>
    ...
    <link rel="stylesheet" href="project_files/css/profile.css">
    <link rel="stylesheet" href="project_files/css/public.css">
