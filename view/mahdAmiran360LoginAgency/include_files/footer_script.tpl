...
<script src="project_files/js/custom.js" type="text/javascript"></script>
<script src="project_files/js/jquery-confirm.min.js" type="text/javascript"></script>
<script src="project_files/js/jquery.dataTables.min.js" type="text/javascript"></script>
<script src="project_files/js/jquery.form.js" type="text/javascript"></script>
<script src="project_files/js/jquery-asTabs.js" type="text/javascript"></script>
