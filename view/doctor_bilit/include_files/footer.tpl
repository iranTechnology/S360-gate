                            ...
                            <div class="item-footer col-lg-3 col-md-3 col-sm-4 col-12 order-foot1 text-center">
                                <div class="box-item-footer text-right">
                                    ...
                                    <div class="child-item-footer">
                                        ...
                                        تلفن:
                                        <a class="__phone_class__" href="tel:02191031980">
                                            02191031980
                                        </a>
                                    </div>
                                    <div class="child-item-footer">
                                        ...
                                        موبایل:
                                        <a class="__mobile_class__" href="tel:09120701145">
                                            09120701145
                                        </a>
                                    </div>
                                    <div class="child-item-footer">
                ...
                <div class="footer-namad">
                    <div class="container">
                        <div class="parent-about-namad-footer">
                            <div class="namads">
                                <a referrerpolicy="origin" target="_blank" href="https://trustseal.enamad.ir/?id=284561&Code=g7IFrIk7u0QvNZ8a3ZI2"><img referrerpolicy="origin" src="https://Trustseal.eNamad.ir/logo.aspx?id=284561&Code=g7IFrIk7u0QvNZ8a3ZI2" alt="" style="cursor:pointer" id="g7IFrIk7u0QvNZ8a3ZI2"></a>
                               
                               <a target="_blank" href="https://www.mcth.ir/"><img src="project_files/images/namad1.png" alt="namad"></a>
                                <a target="_blank" href="https://www.cao.ir/paxrights"><img src="project_files/images/namad2.png" alt="nama2"></a>
                                <a target="_blank" href="https://www.cao.ir/"><img src="project_files/images/namad3.png" alt="nama3"></a>
                                <a target="_blank" href="http://aira.ir/"><img src="project_files/images/nama4.png" alt="nama4"></a>
                                <a href="javascript:"><img referrerpolicy='origin' id = 'rgvjjxlzrgvjesgtfukzesgt' style = 'cursor:pointer' onclick = 'window.open("https://logo.samandehi.ir/Verify.aspx?id=313060&p=xlaorfthxlaoobpdgvkaobpd", "Popup","toolbar=no, scrollbars=no, location=no, statusbar=no, menubar=no, resizable=0, width=450, height=630, top=30")' alt = 'logo-samandehi' src = 'https://logo.samandehi.ir/logo.aspx?id=313060&p=qftinbpdqftilymawlbqlyma' /></a>
                            </div>
    ...
    بازگشت به بالا
                ...
                <div class="parent-item-footer parent-item-footer-responsive">
                    ...
                    <div class="child-item-footer align-items-start">
                        ...
                        آدرس:
                        <span class="__address_class__">
                                          تهران، تهران پارس محله خاک سفید، خیابان شهید منصور زهدی امین، خیابان 20 متری ولیعصر190شرقی، پلاک 87، طبقه همكف
                                       </span>
                    </div>
                    <div class="child-item-footer">
                        <i class="fa-light fa-phone">
                    ...
                    <div class="child-item-footer">
                        ...
                        ایمیل:
                        <a class="__email_class__" href="mailto:info@drbilit.ir">
                            info@drbilit.ir
                        </a>
                    </div>
{*                    <div class="child-item-footer">*}
