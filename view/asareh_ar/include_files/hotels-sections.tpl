...
{assign var='internal_hotels' value=$obj_main_page->getHotelReservation($internal_tour_params)}
...
<section class="hotel">
    <div class="container">
        <div class="title">
            ...
            <a href="{$smarty.const.ROOT_ADDRESS_WITHOUT_LANG}/ar/page/hotel" class="read-more">
        ...
        <div class="box-tab-hotel">
            <ul class="nav nav-pills ul-tabs" id="pills-tab-hotel" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="tab-hotel1" data-toggle="pill" data-target="#hotels1" type="button" role="tab" aria-controls="hotels1" aria-selected="true">داخلي</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="tab-hotel2" data-toggle="pill" data-target="#hotels2" type="button" role="tab" aria-controls="hotels2" aria-selected="false">أجنبي</button>
                </li>
            </ul>
                            ...
                            <div class="item">
                                <a href="{$smarty.const.ROOT_ADDRESS}/roomHotelLocal/reservation/{$item['id']}/{$item['name_en']|strip:'-'}" class="box-ture">
                                    <div class="box-hotel-img">
                                        <img src="{$item['logo']}"
                                             alt="{$item['name_en']}" class="w-me het-me">                                    </div>
