...
{assign var="internal_hotel_params" value=['Count'=> '6', 'type' =>'internal']}


{assign var='internal_hotels' value=$obj_main_page->getHotelWebservice($internal_hotel_params)}
<section class='hotel'>
    <div class='container'>
        <h2 class="title"> هتل ترنج گشت </h2>

        <div class="owl-carousel owl-theme owl-hotels">
            {foreach $internal_hotels as $item}
                <div class="item">
                    <a href="{$smarty.const.ROOT_ADDRESS}/detailHotel/api/{$item['HotelIndex']}" class="hotel-item-link">
