...
<div class="tab-pane  {if $smarty.const.GDS_SWITCH eq 'page' && $active_tab eq 'Insurance' && $client['MainService'] eq 'Insurance'} active {/if} " id="Insurance" role="tabpanel" aria-labelledby="insurance-tab">
    <div class="col-md-12 col-12">
        <div class="row  ">
            <form data-action="https://s360online.iran-tech.com/" method="post" target="_blank"
                ...
                <div class="col-lg-2 col-md-6 col-sm-6 col-12 col_search search_btn_insuranc">
