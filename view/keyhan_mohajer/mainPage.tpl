...
<main>
    {include file="include_files/search-box-1.tpl"}
    {include file="include_files/public.tpl"}
    {include file="include_files/FAQ-1.tpl"}
    {include file="include_files/user-comments.tpl"}
