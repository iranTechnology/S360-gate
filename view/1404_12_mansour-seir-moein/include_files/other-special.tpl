        ...
        <div class="title-center-demo">
            <div class="">
                <h2>
                    ...
                    <span>اپلیکیشن ﻣﻨﺼﻮر ﺳﯿﺮ ﻣﻌﯿﻦ</span>
                </h2>
                <p>

                    با دانلود اپلیکیشن ما، بهترین تجربه گردشگری را در دستان خود داشته باشید. از آخرین اخبار، تخفیف‌ها،
                    خرید آسان بلیط ، رزرو هتل و جاذبه‌های برتر هر مقصد مطلع شوید.

                </p>
            </div>
        </div>
        <div class="parent-app-demo">
            <div class="items-app-demo">
                <div class="box-app-demo">
                    <div class="parent-icon-app">
                    ...
                    <div class="text-box-app">
                        <h3>دسترسی آسان به اطلاعات گردشگری</h3>
                        <p>

                            تمام اطلاعات مورد نیاز خود را به راحتی در اپلیکیشن ما پیدا کنید. از نقشه‌ها و مسیرها تا ساعت
                            بازدید و قیمت‌ها.
                ...
                <div class="box-app-demo">
                    ...
                    <div class="text-box-app">
                        <h3> به‌روز رسانی مداوم اخبار و رویدادها</h3>
                        <p>

                            با دریافت نوتیفیکیشن‌های فوری، همیشه از آخرین اخبار و رویدادهای گردشگری باخبر باشید. هیچ
                            رویداد مهمی را از دست ندهید.
                ...
                <div class="box-app-demo">
                    ...
                    <div class="text-box-app">
                        <h3> پیشنهادات ویژه و تخفیف‌ها</h3>
                        <p>

                            از تخفیف‌ها و پیشنهادات ویژه ما برای سفرها و تورهای مختلف بهره‌مند شوید. سفرهای اقتصادی را
                            تجربه کنید.
                ...
                <div class="box-app-demo">
                    ...
                    <div class="text-box-app">
                        <h3> رزرو آنلاین هتل و بلیط</h3>
                        <p>

                            با چند کلیک ساده هتل و بلیت سفر خود را رزرو کنید. تجربه‌ای سریع و بدون دردسر را با ما داشته
                            باشید.

                        </p>
                    </div>
                </div>
                <a class="" href="https://mansourtrip.ir/apk/mansour-seir.apk">
                    <img alt="img-app" src="project_files/images/googleplay-new.png" />
                </a>
            </div>
            <div class="img-app-demo">
                <img alt="img-app" src="project_files/images/app-demo4.png" />
            </div>
            <div class="items-app-demo">
                <div class="box-app-demo">
                    <div class="parent-icon-app">
                    ...
                    <div class="text-box-app">
                        <h3>راهنمای جامع سفر</h3>
                        <p>

                            راهنماهای جامع سفر برای هر مقصد گردشگری در دسترس شماست. با اطلاعات دقیق و کامل سفر کنید.
                ...
                <div class="box-app-demo">
                    ...
                    <div class="text-box-app">
                        ...
                        <p>
                            ...
                            نظرات و امتیازات کاربران دیگر را بخوانید و تصمیم‌گیری آگاهانه‌تری داشته باشید. از تجربیات
                            دیگران بهره ببرید.
                ...
                <div class="box-app-demo">
                    ...
                    <div class="text-box-app">
                        <h3>برنامه‌ریزی سفرهای سفارشی</h3>
                        <p>

                            با امکانات سفارشی‌سازی اپلیکیشن، سفرهای خود را با توجه به نیازها و سلیقه‌های خاص خود
                            برنامه‌ریزی کنید. تجربه‌ای منحصربه‌فرد داشته باشید.
                ...
                <div class="box-app-demo">
                    <div class="parent-icon-app">
                        <svg viewbox="0 0 576 512" xmlns="http://www.w3.org/2000/svg">
                            <!--! Font Awesome Pro 6.3.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                            <path d="M96 120c0-22.1 17.9-40 40-40H296c13.3 0 24-10.7 24-24s-10.7-24-24-24H136c-48.6 0-88 39.4-88 88v42c-27.6 7.1-48 32.2-48 62V416c0 35.3 28.7 64 64 64H320c35.3 0 64-28.7 64-64V399 241 224c0-35.3-28.7-64-64-64H96V120zM64 208H320c8.8 0 16 7.2 16 16V416c0 8.8-7.2 16-16 16H64c-8.8 0-16-7.2-16-16V224c0-8.8 7.2-16 16-16zM520.3 460.5c5.1 2.3 10.6 3.5 16.2 3.5c21.8 0 39.5-17.7 39.5-39.5v-209c0-21.8-17.7-39.5-39.5-39.5c-5.6 0-11.1 1.2-16.2 3.5L416 226.4V279l112-50.4V411.4L416 361v52.6l104.3 46.9zM80 264c0 13.3 10.7 24 24 24H280c13.3 0 24-10.7 24-24s-10.7-24-24-24H104c-13.3 0-24 10.7-24 24z"></path>
                        </svg>
                    </div>
                    <div class="text-box-app">
                        <h3>محتوای چندرسانه‌ای جذاب</h3>
                        <p>

                            ویدئوها، تصاویر و مقالات جذاب در مورد جاذبه‌های گردشگری را مشاهده کنید. به صورت بصری و
                            چندرسانه‌ای با مقصدها آشنا شوید.

                        </p>
                    </div>
                </div>
                <a class="" href="https://mansourtrip.ir/gds/app">
                    <img alt="img-app" src="project_files/images/appstor.png" />
                </a>
            </div>
        </div>
        <div class="parent-app-demo-responsive">
            <div class="app-text-demo-responsive">
                <h4 class=""> سریع‌تر و مطمئن‌تر به سفر بروید </h4>
                <p>

                    با استفاده از اپلیکیشن سفر 360 در هر کجا که هستید جهان در
                ...
                <div class="parent-btn-app">
                    <a class="" href="https://mansourtrip.ir/apk/mansour-seir.apk">
                        <img alt="app" src="project_files/images/googleplay-new.png" />
                    </a>
                    <a class="" href="https://mansourtrip.ir/gds/app">
                        <img alt="app" src="project_files/images/appstor.png" />
                    </a>
                </div>
            </div>
        </div>
