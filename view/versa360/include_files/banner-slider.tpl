...
<script>
    ...
    if($(window).width() > 576){
        ...
        {literal}
      $('#Flight-tab').click(function () {$('.baner-searchbox').css('background-image' , 'url("{/literal}{$specialFlight['files']['main_file']['src']}{literal}")')});
        {/literal}
        {/if}
        {if $specialHotel['files']['main_file']['src']}
        {literal}
      $('#Hotel-tab').click(function () {$('.baner-searchbox').css('background-image' , 'url("{/literal}{$specialHotel['files']['main_file']['src']}{literal}")')});
        {/literal}
        {/if}
