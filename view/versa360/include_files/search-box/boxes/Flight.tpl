...
|| ($smarty.const.GDS_SWITCH eq 'page' && $active_tab eq 'internalFlight')}active show{/if}"
    ...
    <div id="flight_multi_way" class='flight-multi-way-js'>
        ...
        <form class="d_contents" id="gds_portal" name="gds_portal">
            ...
            <div class="col-lg-4 d-lg-block d-none btn_s col_search margin-bottom">
                <button type="button" class="btn button w-100 h-100 seub-btn b-0"
                        onclick="severalPathFlight()">
                    <span>جستجو</span>
                </button>
            </div>
            <div data-name="additional_external_flight"
                 class="col-12 p-0 pt-1 d-flex flex-wrap parent_multiTrack additional-flight-multi-way-js">
            ...
            <div class="d-sm-none d-block col-12 btn_s col_search">
                <button type="button" class="btn_multiTrack seub-btn b-0"
                        onclick="newAdditionalExternal($(this))">
                    <span class="d-flex align-items-center justify-content-center">افزودن پرواز </span>
                </button>
            </div>
            <div class="d-lg-none d-block col-md-6 col-12 btn_s col_search">
                <button type="button" class="btn button w-100 h-100 seub-btn b-0"
