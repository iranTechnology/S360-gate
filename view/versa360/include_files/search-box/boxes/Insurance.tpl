...
<div class="tab-pane {if $smarty.const.GDS_SWITCH eq 'page' && $active_tab eq $client['MainService']}active{/if}"
    ...
    <div class="col-md-12 col-12">
        <div class="row">
            <form data-action="https://s360online.iran-tech.com/"  method="post"  class="d_contents">
                <div class="col-lg-6 col-md-4 col-sm-6 col-12 col_search margin-bottom">
                ...
                <div class="nafaratbime count-passengers-js">
                    <div class="col-lg-6 col-md-4 col-sm-6 col-12 col_search search_col nafarat-bime margin-bottom passenger-age-div-js">
                        <div class="form-group">
                ...
                <div class="col-lg-6 col-md-4 col-sm-6 col-12 col_search search_btn_insuranc">
