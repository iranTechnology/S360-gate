<div class="col-lg-4 col-md-4 col-sm-4 col-12 col_search search_col">
    <div class="form-group destination_start">
        ...
        <input placeholder="مقصد ( نام شهر یا فرودگاه )" id="multi_1_destination_airport" type="hidden" value="" name="multi_1_destination_airport" class="multi-1-destination-international-js destination-iata-multi-js">
