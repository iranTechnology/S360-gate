<div class="col-lg-4 col-md-6 col-sm-6 col-12 col_search search_col margin-bottom">
    <div class="form-group destination_start">
        ...
        <input id="multi_0_destination_airport" type="hidden" value=""
               ...
               name="multi_0_destination_airport" class="multi-0-destination-international-js destination-iata-multi-js">
