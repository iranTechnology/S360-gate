                    ...
                    <ul class="nav-menu align-to-right">
                        <li>
                            ...
                            <ul class="nav-dropdown nav-submenu">
                                ...
                                <li><a href="{$smarty.const.ROOT_ADDRESS}/page/international-tour">تور های خارجی</a></li>
                            </ul>
                        </li>

                        <li><a href="{$smarty.const.ROOT_ADDRESS}/page/popular-destinations">مقاصد پر طرفدار</a></li>
