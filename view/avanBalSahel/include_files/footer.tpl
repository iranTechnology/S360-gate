  ...
  <div class="container">
   <div class="row">
    <div class="parent-footer-iran d-flex flex-wrap w-100">
     <div class="item-footer col-lg-4 col-md-4 col-sm-4 col-12 order-foot2">
      <div class="box-item-footer text-right">
       ...
       <ul>
        ...
        <li>
         <a href="javascript:" class="goToNewsletter">
          عضویت در خبرنامه
         </a>
        </li>
       </ul>
     ...
     <div class="item-footer col-lg-4 col-md-4 col-sm-4 col-12">
      <div class="box-item-footer text-right">
       <h3>
        آژانس ما
       </h3>
     ...
     <div class="item-footer col-lg-4 col-md-4 col-sm-4 col-12 order-foot1 text-center">
   ...
   <div class="panel panel-default card">
    ...
    <div aria-labelledby="heading-faq-3" class="panel-collapse collapse" id="Collapse-faq-3" role="tabpanel">
     <ul class="ul-footer-mobile">
      <li>
       <a href="https://{$smarty.const.ROOT_ADDRESS}/page/tour">
        رزرو تور
       </a>
      </li>
      <li>
       <a href="https://{$smarty.const.ROOT_ADDRESS}/UserTracking">
        پیگیری خرید
       </a>
      </li>
      <li>
