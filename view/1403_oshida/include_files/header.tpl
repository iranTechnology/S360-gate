{load_presentation_object filename="oshida" assign="obj_main_page" subName="customers"}
...
<head>
    ...
    <link rel="stylesheet" href="project_files/css/menu.css">
    <link rel="stylesheet" href="project_files/css/animate.css">


    {* todo: this use only in main-page*}
    <script type="text/javascript" src="project_files/js/jquery.js"></script>
