<div class="tab-pane {if $client['order_number'] eq '1'}active{/if}" id="internationalHotel">
    ...
    <div id="international_hotel" class="flex-wrap international-hotel-js">
        <form target="_blank" data-action="https://s360online.iran-tech.com/" class="d_contents"  method="post" id="international_hotel_form">
            ...
            <div class="col-lg-2 col-md-3 col-sm-6 col-12 btn_s col_search">
                <input type="hidden" id="nights_hotel" name="nights_hotel" value="" placeholder='Check-out date' class='nights-hotel-js'>
    ...
    <input type='hidden' id="type_section" name="type_section" class="type-section-js" value="external">
</div>
