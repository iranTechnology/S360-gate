...
<div class="tab-pane {if $client['order_number'] eq '1'}active{/if}" id="{$client['MainService']}">
    ...
    <div id="flight_multi_way" class="row flight-multi-way-js">
        <input type="hidden" class="count-path-js" value="2">
            ...
            <div class="col-lg-2 d-lg-block  btn_s col_search">
                <button type="button" class="btn theme-btn seub-btn b-0"
