                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 col-6">
                        <div class="num-of-count-passenger">
                            ...
                            <i class="number-count-js number-count counting-of-count-passenger" data-number="1" data-min="1" data-value="train-adult" data-type="adult">1</i>
            ...
            <div class="col-xs-12 cbox-count-passenger-ch child-number-js">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 col-6">
                        <div class="num-of-count-passenger">
                            <i class="fa fa-plus counting-of-count-passenger add-to-count-passenger-js"></i>
                            <i class="number-count-js number-count counting-of-count-passenger" data-number="0" data-min="0" data-value="train-child" data-type="adult">0</i>
                            <i class="fa fa-minus counting-of-count-passenger minus-to-count-passenger-js"></i>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xs-12 cbox-count-passenger-ch infant-number-js">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 col-6">
                        <div class="num-of-count-passenger">
                            <i class="fa fa-plus counting-of-count-passenger add-to-count-passenger-js"></i>
                            <i class="number-count-js number-count counting-of-count-passenger" data-number="0" data-min="0" data-value="train-adult" data-type="adult">0</i>
                            <i class="fa fa-minus counting-of-count-passenger minus-to-count-passenger-js"></i>
                        </div>
                    </div>
                </div>
