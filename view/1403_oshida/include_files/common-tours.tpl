                            ...
                            {foreach $internalTours as $item}
                                <div class="item">
                                    <div class="project">
                                        ...
                                        <div class="text">
                                            <h3>
                                                <a href="javascript:">{$item['tour_name']}</a>
                                            </h3>
                                            <span
                                            ...
                                            <div class="star d-flex clearfix more_tour"><h4 class="price"> {$item['min_price_r']} <i>تومان </i>
                                                </h4><a href="{$smarty.const.ROOT_ADDRESS}/detailTour/{$item['id']}/{$item['tour_name_en']}"><span>مشاهده جزئیات</span></a>
                                            </div>
                                        </div>
