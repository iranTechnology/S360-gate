<div class="tab-pane {if  $smarty.const.GDS_SWITCH eq 'page' || $client['order_number'] == '1'} active {/if}" id="Visa">
    <div class="empty-div">
    </div>
        ...
        <div class="row  ">
            <form data-action="https://s360online.iran-tech.com/" method="post" name="gdsVisa"
                  id="gdsVisa" target="_blank" class="d_contents">
                        {include file="./sections/visaOld/continent_visa.tpl"}
                        {include file="./sections/visaOld/country_visa.tpl"}
                        {include file="./sections/visaOld/type_visa.tpl"}
                        {include file="./sections/visaOld/passenger_count.tpl"}
