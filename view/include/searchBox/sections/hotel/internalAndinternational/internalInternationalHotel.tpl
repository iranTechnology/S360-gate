        ...
        <form class="d_contents" data-action="https://s360online.iran-tech.com/" id="hotel_search_form" method="post" target="_blank">
                ...
                <div class="form-group destination_start">
                    <div class="inputSearchForeign-box inputSearchForeign-pad_Fhotel w-100">
                        <div class="s-u-in-out-wrapper raft raft-change change-bor">
                            <input autocomplete="off" class="inputSearchForeign w-100 form-control" id="autoComplateSearchIN_2" name="autoComplateSearchIN" onclick="openBoxPopular('externalHotel')" onkeyup="searchCityInternalAndExternal('externalHotel')" placeholder="انتخاب شهر" type="text" value=""/>
            ...
            <div class="col-lg-2 col-md-6 col-sm-6 col-12 col_search search_col">
                <div class="form-group">
                    <input autocomplete="off" class="init-shamsi-datepicker form-control check-in-date-js" data-type="internal" id="startDateForHotelLocal" name="startDateForHotelLocal" placeholder="تاریخ ورود" readonly="" type="text"/>
            ...
            <div class="col-lg-2 col-md-6 col-sm-6 col-12 col_search search_col">
                <div class="form-group">
                    <input autocomplete="off" class="init-shamsi-return-datepicker form-control check-out-date-internal-js" data-type="internal" id="endDateForHotelLocal" name="endDateForHotelLocal" placeholder="تاریخ خروج" readonly="" type="text"/>
                    <i class="fal fa-calendar-alt"></i>
                </div>
            </div>
