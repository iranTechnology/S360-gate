...
{*{if $smarty.server.REMOTE_ADDR == '93.118.161.174'}*}
{*{$objSession->getTypeUser()}*}
{*{$check_is_counter}*}
{*{$typeMember}*}
{*{$objSession->IsLogin()}*}
{*{/if}*}
{if $objSession->IsLogin() and $objSession->getTypeUser() eq 'agency'}
    <div class="sup-menu-flex sup-menu-flex-login">
        ...
        <a class="" href="{$smarty.const.ROOT_ADDRESS}/agencyProfile">
        ...
        <a href="{$smarty.const.ROOT_ADDRESS}/counterLeague">
