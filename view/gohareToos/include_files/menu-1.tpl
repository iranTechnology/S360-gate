...
<header class="i_modular_menu header_area {if $smarty.const.GDS_SWITCH neq 'mainPage'}header2 {/if}  {if $smarty.const.GDS_SWITCH neq 'mainPage' && $smarty.const.GDS_SWITCH neq 'page'} header-page {/if} ">
                    ...
                    <ul class="nav-menu">
                        ...
                        <li><a href="javascript:">دانستنیها</a>
                            <ul class="nav-dropdown">
                                ...
                                <li><a href="{$smarty.const.ROOT_ADDRESS}/personnel">پرسنل</a></li>
                            </ul>
                        </li>
