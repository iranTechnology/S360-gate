    ...
    <div class="container">
        <div class="parent-app row d-flex flex-wrap align-items-center">
            <div class="app-text col-lg-6 col-md-6-12 col-sm-12 col-12 text-right">
                <h3> اپلیکیشن سفر یار گوهر توس </h3>
                <h4 class="mt-3"> سریع‌تر و مطمئن‌تر به سفر بروید </h4>
                <p>
                    با استفاده از اپلیکیشن سفریار گوهر توس در هر کجا که هستید جهان در
...
{*                    </a>*}
                ...
                <img class="app-mobile" src="project_files/images/appImg-ris.png" alt="app-img">
            </div>
