...
{if $objSession->IsLogin() }
    ...
    <div class="sup-menu-flex sup-menu-flex-login">
        <div>
            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                {if $check_is_counter neq 1}
                    <a class="sup-menu-flex_a" target="_parent" href="{$smarty.const.ROOT_ADDRESS}/profile">
        ...
        <a class="" target="_parent" href="{$smarty.const.ROOT_ADDRESS}/profile">
        ...
        <a target="_parent" href="{$smarty.const.ROOT_ADDRESS}/userBook">
        ...
        <a target="_parent" href="{$smarty.const.ROOT_ADDRESS}/passengerList">
        ...
        {if $check_is_counter neq true}
            <a target="_parent" href="{$smarty.const.ROOT_ADDRESS}/transactionUser">
        ...
        {/if}
{*        <a target="_parent" href="{$smarty.const.ROOT_ADDRESS}/club">*}
...
{*            {/if}*}
{*            {if isset($about_user['about_title_customer_club'])}*}
