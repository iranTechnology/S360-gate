...
{*with category*}
{*{assign var="search_array" value=['section'=>'mag','category'=>1,'limit'=>'6']}*}
        ...
        <div class="container">
            <div class="title-demo">
                <div class="text-title-demo">
                    <h2>مقالات مفید</h2>
                    <p>
                        دانستنی‌ها و تجربه‌های جذاب گردشگری برای سفری هوشمندانه‌تر
                    </p>
                </div>
                <a class="more-title-demo" href="{$smarty.const.ROOT_ADDRESS}/mag">
