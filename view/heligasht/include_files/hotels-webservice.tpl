...
{*                            <button aria-controls="hotel-khareji-demo" aria-selected="false" class="nav-link"*}
...
{*                        </li>*}
{*                        <li class="nav-item" role="presentation">*}
{*                            <button aria-controls="hotel-dakheli-demo" aria-selected="true" class="nav-link active"*}
...
{*                            <div aria-labelledby="tab-hotel-dakheli-demo fade show active"*}
{*                                 class="tab-pane fade __hotel__internal__" id="hotel-dakheli-demo"*}
{*                                 role="tabpanel">*}
                                <div class="owl-carousel owl-theme owl-hotels">
                                    {foreach $internal_hotels as $item}
                                        <div class="item __i_modular_nc_item_class_0">
                                            <a class="hotel-card __link__"
...
{*                            </div>*}
{*                            <div aria-labelledby="tab-hotel-khareji-demo" class="tab-pane __hotel__external__"*}
{*                                 id="hotel-khareji-demo" role="tabpanel">*}
{*                                <div class="owl-carousel owl-theme owl-hotels">*}
