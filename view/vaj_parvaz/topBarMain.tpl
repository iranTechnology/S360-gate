...
<head>
    ...
    {if $smarty.const.SOFTWARE_LANG eq 'en'}
        <link rel="stylesheet" type="text/css"
              href="https://vaj.ir/en/user/GlobalFile/css/register.css">
    {else}
        <link rel="stylesheet" type="text/css"
              href="https://vaj.ir/fa/user/GlobalFile/css/register.css">
    {/if}
    <style>
        html{
            height: 100%;
...
{literal}
    ...
    <script type="text/javascript">
        ...
        function signout() {
            $.post('https://online.vaj.ir/gds/user_ajax.php',
                {flag: 'signout'},
                function (data) {
                    window.top.location.href ="https://vaj.ir/fa/user/home.php";
                }
            )
        }
    </script>
