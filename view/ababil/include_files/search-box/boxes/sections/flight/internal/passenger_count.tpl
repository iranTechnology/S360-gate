                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 col-6">
                        <div class="num-of-count-passenger">
                            <i class="fa fa-plus counting-of-count-passenger add-flight-to-count-passenger-js internal-count-passenger-js"></i>
                            <i class="number-count-js number-count counting-of-count-passenger" data-number="1" id="bozorgsal" data-min="1" data-search="internal" data-type="adult">1</i>
                            <i class="fa fa-minus counting-of-count-passenger minus-flight-to-count-passenger-js"></i>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 col-6">
                        <div class="num-of-count-passenger"><i
                                    class="fa fa-plus counting-of-count-passenger add-flight-to-count-passenger-js internal-count-passenger-js"></i>
                            <i class="number-count-js number-count counting-of-count-passenger" data-number="0" data-min="0" data-search="internal" data-type="infant">0</i>
                            <i class="fa fa-minus counting-of-count-passenger minus-flight-to-count-passenger-js"></i>
                        </div>
                    </div>
                </div>
