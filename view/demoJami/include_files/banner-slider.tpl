   ...
   $(document).ready(function() {
    ...
    if($(window).width() > 576){
       ...
       $('#Flight-tab').click(function () {
          ...
          $('.banner-site').css('background-image', 'url("{/literal}{$specialPic.flight.src}{literal}")');
       ...
       $('#Flight_external-tab').click(function () {
          $('.banner-site').css('background-image', 'url("{/literal}{$specialPic.ExternalFlight.src}{literal}")');
       });
        {/literal}
        {/if}
       ...
       $('.Hotel-tab-pic').click(function () {
          $('.banner-site').css('background-image', 'url("{/literal}{$specialPic.hotel.src}{literal}")');
       ...
       $('.Train-tab-pic').click(function () {
          $('.banner-site').css('background-image', 'url("{/literal}{$specialPic.train.src}{literal}")');
       });
        {/literal}
        {/if}
       ...
       $('.Bus-tab-pic').click(function () {
          $('.banner-site').css('background-image', 'url("{/literal}{$specialPic.bus.src}{literal}")');
       ...
       $('.Tour-tab-pic').click(function () {
          $('.banner-site').css('background-image', 'url("{/literal}{$specialPic.tour.src}{literal}")');
       ...
       $('.Insurance-tab-pic').click(function () {
          $('.banner-site').css('background-image', 'url("{/literal}{$specialPic.insurance.src}{literal}")');
       ...
       $('.Visa-tab-pic').click(function () {
          $('.banner-site').css('background-image', 'url("{/literal}{$specialPic.visa.src}{literal}")');
       ...
       $('.Entertainment-tab-pic').click(function () {
          $('.banner-site').css('background-image', 'url("{/literal}{$specialPic.entertainment.src}{literal}")');
       });
        {/literal}
        {/if}
...
{*<div class="banner-site">*}
    <div class="container h-100">
        <div class="banner-site" id="banner-site">
{*             {if $banners[0].pic != ''}style="background-image:url('{$banners[0].pic}');"{/if}>*}
...
{*<div class=" banner-site">*}
{*    <!--                        <img class="__image_class__" src="images/bg.jpg" alt="img-banner">-->*}
{*</div>*}