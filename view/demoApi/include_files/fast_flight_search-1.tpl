...
<section class="i_modular_fast_search_flight search_flight d-flex py-5">
    <div class="container">
        <div class="title">
        ...
        <div class="tab-content" id="search_flight-tabContent">
            ...
            <div aria-labelledby="search_flight_internation-tab" class="__fast_flight_search__external__multi_city__ tab-pane fade" id="search_flight_internation" role="tabpanel">
                <ul class="__origin__cities__ nav nav-pills m-0 p-0" id="search_flight_internation-div-tab" role="tablist">
                    <li class="__i_modular_nc_item_class_0 nav-item" role="presentation">
                        <button aria-controls="Tehran" aria-selected="true" class="__button__ nav-link  show active " data-target="#Tehran" data-toggle="pill" id="Tehran-tab" role="tab" type="button">تهران</button>
                    </li>
                ...
                <div class="__destination__cities__ tab-content" id="search_flight_internation-div-tabContent">
                            ...
                            <div aria-labelledby="{$cities['main']['DepartureCityEn']}-tab" class="__i_modular_nc_item_class_0 tab-pane fade {if $i==1} show active {/if}" id="{$cities['main']['DepartureCityEn']}" role="tabpanel">
                                <div class="search_flight_grid">
                                    ...
                                    {foreach $cities['sub_cities'] as $sub_city}
                                        ...
                                        <div class="__final_destination_0 flightSearchBox" data-target="#calenderBox" data-toggle="modal" onclick="calenderFlightSearch('{$cities['main']['DepartureCode']}','{$sub_city['DepartureCode']}')">
                    ...
                    <div class="search_flight_grid">
                        {assign 'cities' ['ISTALL' => functions::Xmlinformation('S360ISTALL'),'DXB' => functions::Xmlinformation('S360DXB'),'BON' => functions::Xmlinformation('S360BON') ,'DXBALL' => functions::Xmlinformation('S360DXBALL'), 'LONALL' => functions::Xmlinformation('S360YXUALL'), 'NJF' => functions::Xmlinformation('S360NJF')]}
                        {foreach $cities as $item}
                    <a class="__final_destination_0 flightSearchBox" target='_blank'  href='{$smarty.const.ROOT_ADDRESS}/international/1/IKA-{$item@key}/{$objDate->tomorrow()}/1-0-0'>
                        ...
                        <h5 class="__destination__ col-4"> {$item}</h5>
                    </a>
                        {/foreach}
