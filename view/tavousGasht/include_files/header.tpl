...
{load_presentation_object filename="tavousGasht" assign="obj_main_page" subName="customers"}
...
<link href="project_files/images/favicon.png" rel="shortcut icon" type="image/x-icon"/>
    ...
    <link rel="stylesheet" href="assets/all-css/bootstrap.min.css">
...
<link rel="stylesheet" href="assets/all-css/owl.carousel.min.css"><link rel="stylesheet" href="project_files/css/jquery.easy_slides.css"><link rel="stylesheet" href="project_files/https://cdnjs.cloudflare.com/ajax/libs/animate.css/4.1.1/animate.min.css">
