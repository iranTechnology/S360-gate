...
<div class="i_modular_searchBox searchBoxContent" id="Insurance-parent">
 <div class="__box__ position-relative" id="Insurance">
   ...
   <div class="row">
    <form class="d_contents" data-action="://s360online.iran-tech.com/" id="gdsInsurance" method="post" name="gdsInsurance" target="_blank">
     ...
     <div class="count-passenger count-passengers-js">
      <div class="col-lg-6 col-md-4 col-sm-6 col-12 p-sm-3 p-1 col_search search_col nafarat-bime passenger-age-div-js">
       <div class="form-group">
     ...
     <div class="col-lg-6 col-md-3 col-sm-6 col-12 col_search search_btn_insuranc p-sm-3 p-1 d-flex align-items-center">
      <button type="button"
