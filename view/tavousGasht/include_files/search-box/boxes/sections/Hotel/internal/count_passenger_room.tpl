...
<span  onclick="itemsRoom($(this),'internal')" class="close d-none">
<i>
                        ...
                        <div class="myroom-hotel-item-info internal-my-room-hotel-item-info-js">
                            <div class="myroom-hotel-item-tedad my-room-hotel-bozorgsal">
                                ...
                                <div>
                                    ...
                                    <input autocomplete="off" class="countParent internal-count-parent-js" id="adult1" max="5" min="0" name="adult1" readonly="" type="text" value="2"/>
                            ...
                            <div class="myroom-hotel-item-tedad my-room-hotel-bozorgsal">
                                ...
                                <div>
                                    ...
                                    <input autocomplete="off" class="countChild internal-count-child-js" id="child1" max="5" min="0" name="child1" readonly="" type="text" value="0"/>
