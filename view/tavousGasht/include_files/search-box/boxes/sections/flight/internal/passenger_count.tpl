    ...
    <div class="inp-s-num adt box-of-count-passenger box-of-count-passenger-js">
        ...
        <div
                class="box-of-count-passenger-boxes box-of-count-passenger-boxes-js"  >
                              <span
                                      class="text-count-passenger text-count-passenger-js" >1 بزرگسال ,0 کودک ,0 نوزاد</span >
            <span
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 col-6">
                        <div class="num-of-count-passenger">
                            ...
                            >1</i>
                            <i
                                    class="fa fa-minus counting-of-count-passenger minus-to-count-passenger-js"></i>
                        </div>
                    </div>
                </div>
            </div>
