...
<div class="col-lg-6 col-md-6 col-sm-6 col-12 col_search p-sm-3 p-1">
    <div class="form-group">
        <select data-placeholder="مكان تحویل"
                name="delivery_place_rent_car1"
                id="delivery_place_rent_car1"
                class="select2_in select2-hidden-accessible select-delivery-place-rent-car-js1"
