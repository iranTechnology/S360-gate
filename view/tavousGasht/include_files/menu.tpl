...
<header class="i_modular_menu header_area">
            ...
            <nav class="navigation d-flex align-items-center">
                <div class="nav-header">
                    <a class="d-flex" href="https://{$smarty.const.CLIENT_MAIN_DOMAIN}">
                        <img alt="" src="project_files/images/logo.png" />
                    </a>
                </div>
                <div class="nav-menus-wrapper">
                    <ul class="nav-menu">
                        ...
                        <li><a href="{$smarty.const.ROOT_ADDRESS}/page/Europcar">اجاره خودرو</a></li>
                        <li><a href="{$smarty.const.ROOT_ADDRESS}/page/TravelMaker">سفرساز</a></li>
                        <li><a href="{$smarty.const.ROOT_ADDRESS}/pay">پرداخت</a></li>
                    </ul>
                </div>
                <div class="box_button_header">
                    <a class="button_header d-md-flex"  href="tel:{$smarty.const.CLIENT_PHONE}">
    ...
    <div class="res-menu">
        ...
        <a href="{$smarty.const.ROOT_ADDRESS}/page/flight">
            <i class="fa-light fa-plane-circle-check"></i>
            پرواز
        </a>
