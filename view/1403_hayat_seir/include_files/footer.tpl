...
{if $smarty.const.GDS_SWITCH neq $smarty.const.ConstPrintHotel && $smarty.const.GDS_SWITCH neq $smarty.const.ConstPrintTicket && $smarty.const.GDS_SWITCH neq $smarty.const.ConstPrintHotelReservation && $smarty.const.GDS_SWITCH neq $smarty.const.ConstPrintHotelReservationAhuan}
 ...
 <li class="call">
  ...
  <div class="__social_class__ footer_icons">
   <a class="__instagram_class__ footer_instagram" href="{if $telegramHref}{$instagramHref}{/if}">
   ...
   <a class="__whatsapp_class__ footer_whatsapp" href="{if $telegramHref}{$whatsappHref}{/if}">
    <svg viewbox="0 0 448 512" xmlns="http://www.w3.org/2000/svg">
     <!--! Font Awesome Pro 6.1.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
 ...
 <li>
 <h6 href="{$smarty.const.ROOT_ADDRESS}/mag">
  وبلاگ
 </h6>
 <div class="i_modular_blog easy_access blog">
 {if $articles}

  {foreach $articles as $key => $article}
   <a class="__i_modular_nc_item_class_0 easy_access_link flex-column text-right" href="{$article['link']}">
    <p class="__title_class__ mb-1">
     {$article['title']}
    </p>
    <p class="__date_class__ m-0">
     {$article['created_at']}
    </p>
   </a>
  {/foreach}
 {/if}
  ...
  <li>
   ...
   <div class="easy_access">
    <a class="easy_access_link" href="{$smarty.const.ROOT_ADDRESS}/page/tour">
     تور
    </a>
    <a class="easy_access_link" href="{$smarty.const.ROOT_ADDRESS}/page/hotel">
     هتل ها
    </a>
    <a class="easy_access_link" href="{$smarty.const.ROOT_ADDRESS}/mag">
     وبلاگ
    </a>
    <a class="easy_access_link" href="{$smarty.const.ROOT_ADDRESS}/faq">
     پرسشهای متداول
    </a>
    <a class="easy_access_link" href="{$smarty.const.ROOT_ADDRESS}/page/forms">
     فرم ها
    </a>
    <a class="easy_access_link" href="{$smarty.const.ROOT_ADDRESS}/rules">
     قوانین و مقررات
    </a>
    <a class="easy_access_link" href="{$smarty.const.ROOT_ADDRESS}/contactUs">
     تماس با ما
    </a>
    <a class="easy_access_link" href="{$smarty.const.ROOT_ADDRESS}/aboutUs">
     درباره ما
    </a>
   </div>
  </li>
  <li class="d-flex flex-column aboutUs">
   ...
   <div class="namads">
    ...
    <a href="javascript:">
     <img alt="namad-2" src="project_files/images/Enamad1.png"/>
    </a>
    <a href="javascript:">
     <img alt="namad-3" src="project_files/images/Enamad2.png"/>
    </a>
   </div>
  </li>
  </ul>
