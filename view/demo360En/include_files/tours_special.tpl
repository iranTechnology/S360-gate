                        ...
                        <div class="parent-text-tour">
                            ...
                            <div class="price-tour">
                                ...
                                <div class="start-tour">
                                    ...
                                    <span>4.8</span>
                                    <span class="reviews">320 Reviews</span>
                                </div>
                                *}
                                <div class="start-price">
                                    <span>Starting Price</span>
                                    <span class="number-price">{$item['min_price']['discountedMinPriceR']|number_format} Rial</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="parent-text-tour">
                            ...
                            <div class="price-tour">
                                ...
                                <div class="start-tour">
                                    <i class="fa-solid fa-star"></i>
                                    <span>7.7</span>
                                    <span class="reviews">52 Reviews</span>
                                </div>
                                *}
                                <div class="start-price">
                                    <span>Starting Price</span>
