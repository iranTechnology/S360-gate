        ...
        <div class="container">
            <div class="title-demo">
                <div class="text-title-demo">
                    <h2>Popular Tours</h2>
                    <p>
                        Traveling around the world, with both domestic and international tours, to enjoy the beauties of the world.
                    </p>
                </div>
...
{*                                                    <span class="city-tour">iran</span>*}
...
{*                                                    <span class="__city_class__ city-tour">{$item['destination_city_name']}</span>*}
                                                    ...
                                                    <div class="night-tour">
                                                        <i class="fa-sharp fa-solid fa-clock"></i>
                                                        <span class="__day_class__">{$item['night'] + 1}</span> day and <span class="__night_class__">{$item['night']}</span> night
                                        ...
                                        {/if}
                                                                    ...
                                                                    {if $item['min_price_a'] && $item['min_price_a'] != 0}
                                                                        ...
                                                                        {$item['min_price_a']|number_format} {$item['currency_type_en']}
                                                                    {/if}
                                                                    <span>
                                                            </span>
                                                        </div>
