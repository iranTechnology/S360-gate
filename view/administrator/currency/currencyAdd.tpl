            ...
            <div class="white-box">
                ...
                <form id="InsertCurrency" method="post">
                    ...
                    <div class="form-group col-sm-6 has-info">
                        ...
                        <input type="text" class="form-control" name="CurrencyPrice" id="CurrencyPrice" placeholder="قیمت ارز را وارد نمائید">
                    </div>
                    <div class="form-group col-sm-6 has-info">
                        <label for="CurrencyShortName" class="control-label">نام کوتاه ارز </label>
                        <input type="text" class="form-control" name="CurrencyShortName" id="CurrencyShortName" placeholder="برای مثال دلار : USD">
