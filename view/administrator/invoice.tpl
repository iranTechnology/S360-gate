        ...
        <div class="col-sm-12">
            <div class="white-box">
                ...
                <form id="SearchTicketHistory" method="post"
                    ...
                    <div class="form-group col-sm-6">
                        <label for="RequestNumber" class="control-label">وضعیت</label>
                                ...
                                <td>
                                    ...
                                    {if $item.status neq 'payed'}
                                        <span data-toggle="popover" title="پرداخت شد؟" data-placement="top"
                                            ...
                                            <a onclick="ModalSetHotelInvoice('{$item.tracking_code}');return false" data-toggle="modal" data-target="#ModalPublic"
