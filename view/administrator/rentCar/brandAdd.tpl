...
<div class="container-fluid">
    <div class="row bg-title">
        <div class="col-lg-6 col-sm-3 col-md-6 col-xs-12">
            <ol class="breadcrumb FloatRight">
                ...
                <li class="active">افزودن برند جدید</li>
            </ol>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    ...
    <div class="row">
        <form data-toggle="validator" id="add_car_brand" method="post"  enctype="multipart/form-data">
            <input type='hidden' value='insertRentCarBrand' id='method' name='method'>
                ...
                <div class="d-flex flex-wrap gap-10">
                    ...
                    <div class="bg-white d-flex flex-wrap rounded w-100 ">
                        <div class='d-flex justify-content-between align-content-center flex-wrap w-100'>
                            <h4 class='d-flex flex-wrap font-bold m-0 py-3 px-4'>افزودن برند جدید</h4>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group">
                                <label class="control-label" for="title">نام انگلیسی برند </label>
                                <span class='btn btn-info btn-outline fa fa-question-circle font-16 ml-3 my-3 p-2 rounded-max tooltip-info'
                                      data-toggle="tooltip" data-placement="top" title=""
                                      data-original-title=" نام انگلیسی برند را وارد نمائید"></span>
                                <input type="text" class="form-control" name="title_en" id="title_en"
                                       placeholder="نام انگلیسی برند را وارد نمایید">
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group">
