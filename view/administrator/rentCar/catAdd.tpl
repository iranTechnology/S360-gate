...
<div class="container-fluid">
    <div class="row bg-title">
        <div class="col-lg-6 col-sm-3 col-md-6 col-xs-12">
            <ol class="breadcrumb FloatRight">
                ...
                <li class="active">درج دسته بندی جدید خودرو</li>
            </ol>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    ...
    <div class="row">
        <form data-toggle="validator" id="add_category" method="post"  enctype="multipart/form-data">
            <input type='hidden' value='insertRentCarCategory' id='method' name='method'>
