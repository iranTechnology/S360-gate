            ...
            <div class="white-box">
                ...
                <div class="table-responsive">
                    <form data-toggle="validator" id="form_data" method="post"  enctype="multipart/form-data">
                                ...
                                {foreach key=key item=item from=$list_car}
                                    ...
                                    <tr id="del-{$item.id}">
                                        ...
                                        <td class="align-middle">{$item.title}</td>
                                         ...
                                         <td class="align-middle"><img src='{$item.pic_medium}' width='50' height='50'> </td>
                                        ...
                                        <td class="align-middle">
                                            <a href="carEdit&id={$item.id}" class=""><i
                                                        ...
                                                        data-original-title="ویرایش خودرو"></i>
                                            </a>
                        ...
                        <input   class="btn btn-info" type="button" onclick='change_order_item()' value="تغییر ترتیب"  title="تغییر ترتیب" style='margin: 20px 0 0 0;' />
