...
{elseif $smarty.const.SOFTWARE_LANG eq 'en'}
    {assign var="languages" value=['en'=>'English','fa'=>'فارسی','ar'=>'العربیه','ru'=>'روسی']}
{elseif $smarty.const.SOFTWARE_LANG eq 'ar'}
    {assign var="languages" value=['ar'=>'العربیه','fa'=>'فارسی','en'=>'English','ru'=>'روسی']}
{elseif $smarty.const.SOFTWARE_LANG eq 'ru'}
    {assign var="languages" value=['ru'=>'روسی','fa'=>'فارسی','en'=>'English','ar'=>'العربیه']}
{/if}
...
<head>
    ...
    <link href="assets/css/select2v4.min.css" rel="stylesheet"
          type="text/css"/>
    ...
    <link href="assets/css/ldbtn.min.css" rel="stylesheet" type="text/css">
    ...
    <script src="assets/js/select2v4.min.js"
    ...
    <script>
        ...
        var adminFile   = "{$smarty.const.FOLDER_ADMIN}";
...
{*                </ul>*}
            ...
            {if $smarty.const.TYPE_ADMIN eq '1'}
                <ul class="nav navbar-top-links navbar-right pull-right"
                    style="border-left: 1px solid rgba(0,0,0,.08);">
                    <li class="dropdown">
                        <a class="profile-pic " data-target="OnlineServer7Price"
                           target="_blank">
                            اعتبار سرور 7 :

                            <span id="Source7Credit" class="ActiveBadge"> ... </span>
                        </a>
                    </li>
                </ul>
            {/if}
            ...
            {if $smarty.const.TYPE_ADMIN eq '1'}
                <ul class="nav navbar-top-links navbar-right pull-right"
                    style="border-left: 1px solid rgba(0,0,0,.08);">
                    <li class="dropdown">
                        <a class="profile-pic " data-target="OnlineEghamatPrice"
                           target="_blank">
                            اعتبار اقامت :
...
{*                <pre>{$smarty.session|print_r}</pre>*}
                ...
                {else}
                    {assign var="session_agency_partner" value=false}
                {/if}
...
<script src="assets/js/jalali.js" type="text/javascript"></script>
...
<script src="assets/js/datepicker-declarations.js" type="text/javascript"></script>
