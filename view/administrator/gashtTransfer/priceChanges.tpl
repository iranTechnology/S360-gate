{load_presentation_object filename="gashtPriceChanges" assign="objPriceChanges"}
...
<div class="container-fluid">
    <div class="row bg-title">
        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
            ...
            <ol class="breadcrumb FloatRight">
                ...
                <li>تنظیمات</li>
                <li class="active">تغییرات قیمت گشت و ترانسفر</li>
            </ol>
        </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="white-box">
                <h3 class="box-title m-b-0">لیست تغییرات قیمت گشت و ترانسفر</h3>
                <p class="text-muted m-b-30">با تعیین مقدار در این قسمت، تمام گشت و ترانسفرها به این مقدار افزایش قیمت خواهند داشت</p>
                            ...
                            {foreach key=keyCounter item=itemCounter from=$objCounterType->list}
                                ...
                                <td>
                                    <div class="input-group">
                                        <input type="text" value="{$priceVal}" class="form-control text-right gashtPriceChanges" />
...
<div class="i-section">
    <div class="i-info">
        <span> ویدیو آموزشی بخش  تغییر قیمت گشت و ترنسفر   </span>
    </div>
...
<script type="text/javascript" src="assets/JsFiles/gashtPriceChanges.js"></script>