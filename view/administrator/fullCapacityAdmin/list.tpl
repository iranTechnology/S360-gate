...
{assign var="list_item" value=$objFullCapacityAdmin->listFullCapacityAdmin()}
    ...
    <div class="row bg-title">
        <div class="col-xs-12">
            ...
            <ol class="breadcrumb FloatRight">
                ...
                <li  class="active" ><a href="{$smarty.const.ROOT_ADDRESS_WITHOUT_LANG}/itadmin/fullCapacityAdmin/list">لیست تصاویر نتایج جستجو ادمین</a></li>
            </ol>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-12">
            <div class="white-box">
                ...
                <a href="{$smarty.const.ROOT_ADDRESS_WITHOUT_LANG}/itadmin/fullCapacityAdmin/add"
                ...
                <h3 class="box-title m-b-0">لیست تصاویر نتایج جدید ادمین</h3>
                            ...
                            {foreach key=key item=item from=$list_item}
                                ...
                                <tr id="del-{$item.id}">
                                    ...
                                    <td class="align-middle">
                                        <a href="#"
                                           onclick="updateStatusFullCapacityAdmin('{$item.id}'); return false">
                                            {if $item.is_active}
                                    ...
                                    <td class="align-middle">
                                       ...
                                       <button class="btn btn-sm btn-outline btn-danger deleteFullCapacityAdmin"
                                               data-id="{$item.id}">
...
<script type="text/javascript" src="assets/JsFiles/fullCapacityAdmin.js"></script>
{/if}
