{load_presentation_object filename="fullCapacityAdmin" assign="objFullCapacity"}
{assign var="info_pic" value=$objFullCapacity->getFullCapacityAdmin($smarty.get.id)}
...
<div class="container-fluid">
    <div class="row bg-title">
        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
            <ol class="breadcrumb FloatRight">
                ...
                <li>
                    <a href="{$smarty.const.ROOT_ADDRESS_WITHOUT_LANG}/itadmin/fullCapacityAdmin/list">
                        لیست تصاویر
                    </a>
                </li>
                <li class='active'>
    ...
    <div class="row">
        <form data-toggle="validator" id="edit_full_capacity" method="post"  enctype="multipart/form-data">
            <input type='hidden' value='updateFullCapacityAdmin' id='method' name='method'>
            <input type='hidden' value='fullCapacityAdmin' id='className' name='className'>
