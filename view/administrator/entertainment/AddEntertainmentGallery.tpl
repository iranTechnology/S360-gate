...
{/if}
{assign var="EntertainmentData" value=$objEntertainment->GetEntertainmentData('',$CorrectLevel)}
    ...
    <div class="row bg-title">
        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
            <ol class="breadcrumb FloatRight">
                ...
                <li>
                    <a href="{$smarty.const.ROOT_ADDRESS_WITHOUT_LANG}/itadmin/entertainment/main&level={$EntertainmentCategory['CategoryId']}&deep=1">{$EntertainmentCategory['CategoryTitle']}</a>
                </li>
                <li>
                    <a href="{$smarty.const.ROOT_ADDRESS_WITHOUT_LANG}/itadmin/entertainment/EntertainmentList&level={$EntertainmentData['category_id']}">{$EntertainmentSingleCategories['CategoryTitle']}</a>
                </li>

                <li class="active"><a
                            href="{$smarty.const.ROOT_ADDRESS_WITHOUT_LANG}/itadmin/entertainment/AddEntertainmentGallery&level={$CorrectLevel}">ویرایش
                        گالری</a></li>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="white-box col-md-12">
                <h3 class="box-title m-b-0"> اضافه کردن عکس برای تفریحات</h3>
...
<script type="text/javascript">
  myDropzone.on('sending', function(file, xhr, formData) {
    ...
    formData.append('id', '{$CorrectLevel}')
  })
  myDropzone.on('success', function(file, response) {
    GetEntertainmentGalleryData("{$CorrectLevel}")
