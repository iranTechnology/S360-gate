                    ...
                    <div class="table-responsive">
                        <table id="gashtHistory" class="table table-striped text-center">
                            ...
                            <tr>
                                ...
                                <th>مبدا<br>مقصد<br/>تاریخ حرکت<br/>ساعت حرکت</th>
                            ...
                            {foreach key=key item=item from=$bookList}
                                ...
                                <tr id="del-{$item.id}">
                                    ...
                                    <td>
                                        {$item['OriginName']}<hr style="margin:3px">{$item['DestinationCity']}<hr style="margin:3px">
                                        {$item['DateMove']}<hr style="margin:3px">{$item['TimeMove']}
                                    </td>

                                    <td>{$item['BaseCompany']}</td>
