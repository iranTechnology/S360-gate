{load_presentation_object filename="lotteries" assign="objLotteries"}
        ...
        <div class="col-sm-12">
            <div class="white-box">
                <a class="btn btn-primary rounded"
                   href="{$smarty.const.ROOT_ADDRESS_WITHOUT_LANG}/itadmin/lottery/insert">
                ...
                <div class="table-responsive table-bordered">
                    <table id="myTable" class="table table-striped table-hover">
                        ...
                        {foreach $objLotteries->getLotteries() as $lottery}
