...
{assign var="contactList" value=$objcontact->GetData('lastminute')}
    ...
    <div class="row bg-title">
        <div class="col-xs-12">
            ...
            <ol class="breadcrumb FloatRight">
                ...
                <li  class="active" ><a href="{$smarty.const.ROOT_ADDRESS_WITHOUT_LANG}/itadmin/contactUs/main">دقیقه نودی</a></li>
            </ol>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-12">
            <div class="white-box">
                <h3 class="box-title m-b-0">لیست دقیقه نودی </h3>

                <p class="text-muted m-b-30"> در لیست زیر شما میتوانید لیست همه درخواست دقیقه نودی های مشتری ها را مشاهده نمائید</p>
