                    ...
                    <div class="form-group col-sm-12 DynamicFineData fine-box">
                        <div class="row FineItem" data-target="BaseFineDataDiv">
                            ...
                            <div class="form-group col-sm-2"><label>تا ساعت </label> <input
                                        ...
                                        value=""></div>
                            <div class="form-group col-sm-2"><label>از  صدور </label> <input
                                        type="number" class="form-control" data-field="from_issuance_hour"
                                        name="FineData[0][from_issuance_hour]" placeholder="از  صدور"
                                        value=""></div>
                            ...
                            <div class="form-group col-sm-1">
                                ...
                                <input type="number"
                                       ...
                                       name="FineData[0][fine_percentage]"
                            ...
                            <div class="form-group col-sm-2">
                                ...
                                <input type="text"
                                       ...
                                       name="FineData[0][fine_description]"
                                       placeholder="توضیحات"
                                       value=""
                                       onkeyup="toggleFineFields($(this))"
                                       onchange="toggleFineFields($(this))">
                            ...
                            <div class="form-group col-sm-2">
                                <label>توضیحات اینگیلیسی</label>
                                <input type="text"
                                       class="form-control fine_description_en"
                                       data-field="fine_description_en"
                                       name="FineData[0][fine_description_en]"
                                       placeholder="توضیحات اینگیلیسی"
                                       value=""
                                       onkeyup="toggleFineFields($(this))"
                                       onchange="toggleFineFields($(this))">
                            </div>
