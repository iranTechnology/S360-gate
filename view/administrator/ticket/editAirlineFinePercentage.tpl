...
{load_presentation_object filename="airLineFineController" assign="objAirlineFine"}
{assign var="fineData" value=$objAirlineFine->getAirlineFineData($smarty.get.id)}
                        ...
                        {foreach $fineData[0].fine_percentages as $index => $fp}
                            <div class="row FineItem" data-target="BaseFineDataDiv">
                                ...
                                <div class="form-group col-sm-1">
                                    <label> از صدور </label>
                                    <input type="number" class="form-control" data-field="from_issuance_hour" name="FineData[{$index}][from_issuance_hour]" value="{$fp.from_issuance_hour}">
                                </div>
                                <p class="form-group col-sm-1" style="padding-top: 30px;">قبل از پرواز.</p>
                                <div class="form-group col-sm-1">
                                    <label>درصد جریمه</label>
                                    <input type="number"
                                           class="form-control fine_percentage"
                                           data-field="fine_percentage"
                                           name="FineData[{$index}][fine_percentage]"
                                           value="{$fp.fine_percentage}"
                                           placeholder="درصد جریمه"
                                           onkeyup="toggleFineFields($(this))"
                                           onchange="toggleFineFields($(this))">
                                </div>

                                <div class="form-group col-sm-2">
                                    <label>توضیحات</label>
                                    <input type="text"
                                           class="form-control fine_description"
                                           data-field="fine_description"
                                           name="FineData[{$index}][fine_description]"
                                           value="{$fp.fine_description}"
                                           placeholder="توضیحات"
                                           onkeyup="toggleFineFields($(this))"
                                           onchange="toggleFineFields($(this))">
                                </div>
                                ...
                                <div class="form-group col-sm-2">
                                    ...
                                    <input type="text"
                                           class="form-control fine_description_en"
                                           data-field="fine_description_en"
                                           name="FineData[{$index}][fine_description_en]"
                                           value="{$fp.fine_description_en}"
...
<script>
   $(document).ready(function () {
      $(".fine_percentage, .fine_description, .fine_description_en").each(function () {
         toggleFineFields($(this));
      });
   });
</script>
