{if $smarty.get.id neq ''}
            ...
            <div class="col-sm-12">
                <div class="white-box">
                    ...
                    <form id="SearchTransaction" method="post"
                          action="{$smarty.const.ROOT_ADDRESS_WITHOUT_LANG}/itadmin/ticket/partner-accountant-white-label{if $smarty.get.id neq ''}&id={$smarty.get.id}{/if}">
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="white-box">
                    ...
                    <p class="text-muted m-b-30">شما در لیست زیر تراکنش های یک هفته اخیر را مشاهده میکنید

                        <span class="pull-right ml-1">
                             <a href="{$smarty.const.ROOT_ADDRESS_WITHOUT_LANG}/itadmin/ticket/add-partner-transaction{if $smarty.get.id neq ''}&id={$smarty.get.id}{/if}"
                        ...
                        <span class="btn-label"><i class="mdi mdi-trending-up"></i></span>افزودن تراکنش جدید
                                  ...
                                  <a onclick="createExcelForTransactionUser()"
                                     class="btn btn-primary waves-effect waves-light" type="button" id="btn-excel">
                    ...
                    <div class="table-responsive">
                        <table id="partner_transaction" class="table table-striped">
                            <thead>
                            <tr>
                                <th>ردیف</th>
                                <th>شماره فاکتور</th>
    ...
    {else}
    <script>
      window.location = 'partner-white-label';
    </script>
{/if}
