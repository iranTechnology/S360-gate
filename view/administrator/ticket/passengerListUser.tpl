    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            <div class="white-box">
                ...
                <p class="text-muted m-b-30"> در لیست زیر شما میتوانید لیست مسافران  کاربر را مشاهده
                    نمائید
                    <span class="pull-right">
                        <a href="passengerAddUser&id={$smarty.get.id}" class="btn btn-info waves-effect waves-light "
                           type="button">
                        ...
                        <tbody>
                            ...
                            {foreach key=key item=item from=$list} {*نمایش اسامی کانترها*}
                                    ...
                                    <tr id="del-{$item.id}">
                                        ...
                                        <td>
                                            <a href="passengerEditUser&id={$item.id}&memberID={$smarty.get.id}"><i
                                            ...
                                            <a href="passengerTicketHistory&Code={if $item.NationalCode == ""}{$item.passportNumber}{else}{$item.NationalCode}{/if}"><i
