...
<div class="container-fluid">
    <div class="row bg-title">
        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
            ...
            <ol class="breadcrumb FloatRight">
                ...
                <li><a href="passengerListUser&id={$smarty.get.id}">مسافران کاربر</a></li>
                <li class="active">افزودن مسافر جدید</li>
            </ol>
        </div>
        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="white-box">
                <h3 class="box-title m-b-0">افزودن مسافر جدید</h3>
                <p class="text-muted m-b-30"> شما با استفاده از فرم زیر میتوانید مسافر جدیدی را در سیستم  خود ثبت نمائید</p>

                <form data-toggle="validator" id="AddPassengerUser" method="post">
                    <input type="hidden" name="flag" id="flag" value="PassengersAdd">
                    ...
                    <div class="form-group col-sm-6 ">
                        ...
                        <input type="text" class="form-control" id="passengerName" name="passengerName"
                               placeholder="نام  مسافر را وارد نمائید">
                    </div>
                    ...
                    <div class="form-group col-sm-6 ">
                        ...
                        <input type="text" class="form-control" id="passengerFamily" name="passengerFamily"
                               placeholder="نام خانوادگی مسافر را وارد نمائید">
                    </div>
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <input type="text" class="form-control" id="passengerNameEn" name="passengerNameEn"
                               placeholder="نام  لاتین مسافر را وارد نمائید">
                    </div>
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <input type="text" class="form-control " id="passengerFamilyEn" name="passengerFamilyEn"
                               placeholder="نام خانوادگی لاتین مسافر را وارد نمائید">
                    </div>
                    ...
                    <div class="form-group col-sm-6 dontShowInput">
                        <label for="passengerBirthday" class="control-label">تاریخ تولد-شمسی</label>
                        <input type="text" class="form-control datepicker" id="passengerBirthday" name="passengerBirthday"
                               placeholder="تاریخ تولد شمسی مسافر را وارد نمائید">
                    </div>
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <input type="text" class="form-control datepicker-miladi" id="passengerPassportExpire" name="passengerPassportExpire"
                               placeholder="تاریخ انقضاء پاسپورت مسافر را وارد نمائید">
                    </div>

                    <div class="form-group col-sm-6 showInput"  style="display: none">
                    ...
                    <div class="form-group col-sm-6 showInput" style="display: none">
                        ...
                        <input type="text" class="form-control datepicker-miladi " id="passengerBirthdayEn" name="passengerBirthdayEn"
                               placeholder="تاریخ تولد میلادی مسافر را وارد نمائید" >
                    </div>
