...
{$objFee->ShowInfoForEdit($smarty.get.id)}
    ...
    <div class="row bg-title">
        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
            ...
            <ol class="breadcrumb FloatRight">
                ...
                <li>تنظیمات</li>
                <li class="active">ویرایش تنطیم جریمه کنسلی</li>
            </ol>
        </div>
        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="white-box">
                ...
                <form data-toggle="validator" id="CancellationFeeEdit" method="post">
                    <input type="hidden" name="flag" value="CancellationFeeSettingEdit">
                    <input type="hidden" name="id" value="{$objFee->ResultSelectForEdit['id']}">
                    <div class="form-group col-sm-6 ">
                        <label for="AirlineIata" class="control-label">نام ایرلاین </label>
                        <select class="form-control select2" name="AirlineIata" id="AirlineIata">
                            <option value="">انتخاب کنید...</option>
                            {foreach $objFunctions->AirlineList() as $airline}
                            <option value="{$airline.abbreviation}" {if $airline.abbreviation eq $objFee->ResultSelectForEdit['AirlineIata']}selected="selected"{/if}>{$airline.name_fa}</option>
                            {/foreach}
                        </select>
                    </div>
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <input type="text" class="form-control" id="TypeClass" name="TypeClass"
                               placeholder="شناسه نرخی وارد نمائید" value="{$objFee->ResultSelectForEdit['TypeClass']}">
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <input type="text" class="form-control" id="ThreeDaysBefore" name="ThreeDaysBefore"
                               placeholder="درصد زمان مورد نظر را وارد نمائید" value="{$objFee->ResultSelectForEdit['ThreeDaysBefore']}">
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <input type="text" class="form-control" id="OneDaysBefore" name="OneDaysBefore"
                               placeholder="درصد زمان مورد نظر را وارد نمائید" value="{$objFee->ResultSelectForEdit['OneDaysBefore']}">
                    </div>
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <input type="text" class="form-control" id="ThreeHoursBefore" name="ThreeHoursBefore"
                               placeholder="درصد زمان مورد نظر را وارد نمائید" value="{$objFee->ResultSelectForEdit['ThreeHoursBefore']}">
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <input type="text" class="form-control" id="ThirtyMinutesAgo" name="ThirtyMinutesAgo"
                               placeholder="درصد زمان مورد نظر را وارد نمائید" value="{$objFee->ResultSelectForEdit['ThirtyMinutesAgo']}">
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <input type="text" class="form-control" id="OfThirtyMinutesAgoToNext" name="OfThirtyMinutesAgoToNext"
                               placeholder="درصد زمان مورد نظر را وارد نمائید" value="{$objFee->ResultSelectForEdit['OfThirtyMinutesAgoToNext']}">
