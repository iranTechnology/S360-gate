...
<div class="container-fluid">
    <div class="row bg-title">
        <div class="col-lg-6 col-sm-3 col-md-6 col-xs-12">
            <ol class="breadcrumb FloatRight">
                ...
                <li>
                    <a href="{$smarty.const.ROOT_ADDRESS_WITHOUT_LANG}/itadmin/rajaTransactions/list">
                        لیست تراکنش های رجا
                    </a>
                </li>
    ...
    <div class="row">
        <form data-toggle="validator" id="InsertExelRaja" method="post"  enctype="multipart/form-data">
            <input type='hidden' value='InsertExel' id='method' name='method'>
            <input type='hidden' value='rajaTransactions' id='className' name='className'>
                    ...
                    <div class="bg-white d-flex flex-wrap rounded w-100 ">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 nopad ">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <label for='gallery_files'
                                    ...
                                    <p>فایل خود را انتخاب یا در کادر بکشید</p>
                                </label>
                            </div>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p-0">
                                <div class="d-flex flex-wrap form-group gap-5 w-100">
                                    ...
                                    <div id='preview-gallery' class='drop_zone-new-parent-gallery'>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 nopad ">
                            <div class="form-group">
                                <label class="control-label" for="description">دلیل تراکنش</label>
                                <input type="text" class="form-control" name="description" id="description" placeholder="دلیل تراکنش را وارد نمایید">
                            </div>
                        </div>
