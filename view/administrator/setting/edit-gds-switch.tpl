...
{assign var="data_gds_switch" value=$obj_gds_switches->getGdsSwitchById($smarty.get.id)}
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="white-box row">
                ...
                <form data-toggle="validator" id="edit_gds_switch" method="post"  enctype="multipart/form-data">
                    <input type='hidden' value='editGdsSwitch' id='method' name='method'>
                    <input type='hidden' value='gdsSwitches' id='className' name='className'>
                    <input type='hidden' value='{$data_gds_switch['id']}' id='gds_switch_id' name='gds_switch_id'>
                    <div class="row">
                        <div class="form-group col-sm-6 ">

                            <label for="title" class="control-label">عنوان</label>
                            <input type="text" class="form-control" id="title" name="title" value="{$data_gds_switch['title']}"
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <input type="text" class="form-control" id="gds_switch" name="gds_switch" value="{$data_gds_switch['gds_switch']}"
