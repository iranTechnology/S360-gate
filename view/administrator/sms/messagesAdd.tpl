...
<div class="container-fluid">
    <div class="row bg-title">
        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
            ...
            <ol class="breadcrumb FloatRight">
                ...
                <li class="active">متن پیامک جدید</li>
            </ol>
        </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="white-box">
                <h3 class="box-title m-b-0">پیام جدید</h3>
                <p class="text-muted m-b-30"> شما با استفاده از فرم زیر میتوانید پیام های جدید جهت ارسال پیامک را در سیستم ثبت نمائید</p>

                <form data-toggle="validator" id="messageAdd" method="post">
                    <input type="hidden" name="flag" value="messageAdd">
 ...
 - شماره صندلی (مخصوص اتوبوس): |sms_bus_chairs_number|
 ...
 - کد پیگیری (مختص دسته بندی سازمانی): |sms_tracking_code|
 - نام و نام خانوداگی کاربر (مختص دسته بندی سازمانی): |sms_name_user_category_organiztion|
 - نام سازمان (مختص دسته بندی سازمانی): |sms_name_category_organiztion|
2. در صورتیکه از مقادیر بالا در پیامک هایی که معادلی ندارند استفاده کنید، به دلیل عدم وجود معادل این مقادیر، مقداردهی نمی گردند. (به عنوان مثال مقدار |sms_cost| در پیامک تبریک تولد مفهومی ندارد و به همین صورت و بدون جایگزینی ارسال می گردد)
                    ...
                    <div class="form-group col-sm-6 ">
                        ...
                        <textarea class="form-control" id="body" name="body" rows="5"
                                  placeholder="متن پیامک را وارد نمائید"></textarea>
                    </div>
                    <div class="form-group col-sm-6 ">
