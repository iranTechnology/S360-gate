...
<div class="container-fluid">
    <div class="row bg-title">
        <div class="col-lg-6 col-sm-3 col-md-6 col-xs-12">
            <ol class="breadcrumb FloatRight">
                ...
                <li class="active">درج پاپ آپ جدید</li>
            </ol>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    ...
    <div class="row">
        <form data-toggle="validator" id="add_pop_up" method="post"  enctype="multipart/form-data">
            <input type='hidden' value='insertPopUp' id='method' name='method'>
                ...
                <div class="d-flex flex-wrap gap-10">
                    ...
                    <div class="bg-white d-flex flex-wrap rounded w-100 ">
                        <div class='d-flex justify-content-between align-content-center flex-wrap w-100'>
                            <h4 class='d-flex flex-wrap font-bold m-0 py-3 px-4'>افزودن پاپ آپ</h4>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group">
                                <label for="pic" class="control-label">تصویر دسک تاپ</label>
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group">
                                ...
                                <input type="file" name="pic_mobile" id="pic_mobile" class="dropify" data-height="100"
                                       data-default-file=""/>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group">
                                ...
                                <input type="file" name="pic_sample" id="pic_sample" class="dropify" data-height="100"
                                       data-default-file=""/>
                            </div>
                        </div>
...
<script type="text/javascript" src="assets/JsFiles/popUp.js">
