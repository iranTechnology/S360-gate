{load_presentation_object filename="currencyHistoryEquivalent" assign="ObjCurrencyHistoryEquivalent"}
            ...
            <div class="white-box">
                ...
                <div class="table-responsive">
                    <table id="myTable" class="table table-striped ">
                        ...
                        {foreach key=key item=item from=$ObjCurrencyHistoryEquivalent->ListHistoryCurrencyEquivalent($smarty.get.id)}
                            {$number=$number+1}
                            <tr id="del-{$item.id}">
                                <td>{$number}</td>
