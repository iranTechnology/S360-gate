...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            <div class="white-box">
                <h3 class="box-title m-b-0">عنوان اتاق</h3>
                ...
                <div class="table-responsive">
                    <table id="myTable" class="table table-striped text-center">
                        ...
                        {foreach key=key item=item from=$objResult->SelectAll('reservation_room_title_tb')}
                        {$number=$number+1}
                        <tr id="del-{$item.id}">
