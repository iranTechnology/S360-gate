...
{$objResult->SelectRoomPrices($objBasic->list['id_city'], $objBasic->list['id_hotel'], $objBasic->list['id_room'], $objBasic->list['user_type'], $objBasic->list['id_same'], $smarty.get.date)}
...
<div class="container-fluid">
    ...
    <form id="editRoomPricesForUser" method="post" action="{$smarty.const.rootAddress}hotel_ajax">
        ...
        <input type="hidden" name="edit" value="editRoomPrices">
        ...
        <div class="col-sm-12">
            <div class="white-box">
                ...
                <div class="row show-grid">
                    ...
                    <div class="col-md-4">
                        <b>تاریخ: </b>
                        <input type="hidden" id="start_date" name="start_date" value="{$smarty.get.date}">
                        {$objPublic->format_Date($objResult->listRoomPrices_DBL['date'])}
                    </div>
                </div>
                            ...
                            <table class="table color-table purple-table" id="TableRoomPrice">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="text" class="form-control textPrice" name="online_price1" value="{$online_price|number_format:0:".":","}" id="online_price1" placeholder="قیمت برد هتل را وارد کنید"
                                               onkeypress="isDigit(this)" onkeyup="javascript:separator(this);" aria-invalid="false">
                                        </div>
                                    </td>
                                    <td>
                                        <div class="input-text">
                                        <input type="text" class="form-control textBoardPrice" name="board_price1" value="{$board_price|number_format:0:".":","}" id="board_price1" placeholder="قیمت را وارد کنید"
                                               onkeypress="isDigit(this)" onkeyup="javascript:separator(this);" aria-invalid="false">
                                        </div>
                                    </td>
                                    <td>
                                        <input type="text" class="form-control" name="currency_price1" value="{$objResult->listRoomPrices_DBL['currency_price']|number_format:0:".":","}" id="currency_price1" placeholder="قیمت ارزی را وارد کنید"
                                               onkeypress="isDigit(this)" onkeyup="javascript:separator(this);" aria-invalid="false">
                                    </td>
                                    <td>
                                        <select name="currency_type1" id="currency_type1"
                                                class="form-control ">
                                            <option value="">انتخاب کنید....</option>
                                            {foreach $objCurrencyEquivalent->ListCurrencyEquivalentAdmin() as $currency}
                                                <option value="{$currency.CurrencyCode}" {if $objResult->listRoomPrices_DBL['currency_type'] eq $currency.CurrencyCode}selected{/if}>{$currency.CurrencyTitle} ({$currency.EqAmount})</option>
                                            {/foreach}
                                        </select>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="form-control" name="online_price2" value="{$objResult->listRoomPrices_EXT['online_price']|number_format:0:".":","}" id="online_price2" placeholder="قیمت برد هتل را وارد کنید"
                                               onkeypress="isDigit(this)" onkeyup="javascript:separator(this);" aria-invalid="false">
                                    </td>
                                    <td>
                                        <input type="text" class="form-control" name="board_price2" value="{$objResult->listRoomPrices_EXT['board_price']|number_format:0:".":","}" id="board_price2" placeholder="قیمت را وارد کنید"
                                               onkeypress="isDigit(this)" onkeyup="javascript:separator(this);" aria-invalid="false">
                                    </td>
                                    <td>
                                        <input type="text" class="form-control" name="currency_price2" value="{$objResult->listRoomPrices_EXT['currency_price']|number_format:0:".":","}" id="currency_price2" placeholder="قیمت ارزی را وارد کنید"
                                               onkeypress="isDigit(this)" onkeyup="javascript:separator(this);" aria-invalid="false">
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="form-control" name="online_price3" value="{$objResult->listRoomPrices_ECHD['online_price']|number_format:0:".":","}" id="online_price3" placeholder="قیمت برد هتل را وارد کنید"
                                               onkeypress="isDigit(this)" onkeyup="javascript:separator(this);" aria-invalid="false">
                                    </td>
                                    <td>
                                        <input type="text" class="form-control" name="board_price3" value="{$objResult->listRoomPrices_ECHD['board_price']|number_format:0:".":","}" id="board_price3" placeholder="قیمت را وارد کنید"
                                               onkeypress="isDigit(this)" onkeyup="javascript:separator(this);" aria-invalid="false">
                                    </td>
                                    <td>
                                        <input type="text" class="form-control" name="currency_price3" value="{$objResult->listRoomPrices_ECHD['currency_price']|number_format:0:".":","}" id="currency_price3" placeholder="قیمت ارزی را وارد کنید"
                                               onkeypress="isDigit(this)" onkeyup="javascript:separator(this);" aria-invalid="false">
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td><input type="hidden" class="form-control" name="online_price4" value="{$objResult->listRoomPrices_CHD['online_price']|number_format:0:".":","}" id="online_price4" placeholder="قیمت برد هتل را وارد کنید" onkeypress="isDigit(this)" onkeyup="javascript:separator(this);" aria-invalid="false"></td>
                                    <td><input type="hidden" class="form-control" name="board_price4" value="{$objResult->listRoomPrices_CHD['board_price']|number_format:0:".":","}" id="board_price4" placeholder="قیمت را وارد کنید" onkeypress="isDigit(this)" onkeyup="javascript:separator(this);" aria-invalid="false"></td>
                                    <td><input type="hidden" class="form-control" name="currency_price4" value="{$objResult->listRoomPrices_CHD['currency_price']|number_format:0:".":","}" id="currency_price4" placeholder="قیمت ارزی را وارد کنید" onkeypress="isDigit(this)" onkeyup="javascript:separator(this);" aria-invalid="false"></td>
                                    <td></td>
                                    <td></td>
                                </tr>
