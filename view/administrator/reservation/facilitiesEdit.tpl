...
{$objResult->SelectAllWithCondition('reservation_facilities_tb', 'id', $smarty.get.id)}
    ...
    <div class="row bg-title">
        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
            <ol class="breadcrumb FloatRight">
                ...
                <li><a href="facilitiesAdd">امکانات</a></li>
                <li class="active">ویرایش امکانات</li>
            </ol>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="white-box">
                ...
                <p class="text-muted m-b-30">شما با استفاده از فرم زیر میتوانید امکانات را در سیستم ویرایش نمائید</p>

                <form id="EditFacilities" method="post" action="{$smarty.const.rootAddress}hotel_ajax">
                    <input type="hidden" name="flag" value="EditFacilities">
                        ...
                        <div class="form-group col-sm-3">
                            <div class="radio-inline col-sm-1">
                                <div class="radio radio-info">
                                    <i class="fontSize30 {$objResult->list['icon_class']}"></i>
                                </div>
                            </div>
                        </div>
                    </div>
