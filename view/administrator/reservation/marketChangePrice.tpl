...
{if $smarty.get.type == 'hotel'}
    {assign var="type" value='marketplaceHotel'}
{/if}
    ...
    <div class="row bg-title">
        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
            ...
            <ol class="breadcrumb FloatRight">
                ...
                <li class="active"> تغییرات قیمت {$hotel['name']}</li>
            </ol>
        </div>
    </div>
        ...
        <div class="col-sm-12">
            <div class="white-box">
                ...
                <form autocomplete="off" id="FormChangePriceHotel" method="post" action="{$smarty.const.rootAddress}hotel_ajax">
                    ...
                    <input type="hidden" name="type_application" id="type_application" value="{$type}">
                    <input type="hidden" name="type_id" id="type_id" value="{$hotel['id']}">
                    <input type="hidden" name="city_code" id="city_code" value="{$hotel['city']}">
                    <input type="hidden" name="hotel_star" id="hotel_star" value="{$hotel['star_code']}">
            ...
            <div class="white-box">
                ...
                <div class="table-responsive">
                    <table id="myTable" class="table table-striped text-center">
                        ...
                        {foreach key=key item=item from=$objPrice->PriceChangeList($type , $smarty.get.id)}
                            {$number=$number+1}
                            <tr id="del-{$item.id}">
