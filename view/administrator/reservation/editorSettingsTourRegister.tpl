    ...
    <div class="row bg-title">
        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
            <ol class="breadcrumb FloatRight">
                ...
                <li>رزرواسیون</li>
                <li>تنظیمات</li>
                <li class="active">تنظیم ویرایشگر برای ثبت تور</li>
            </ol>
        </div>
    </div>
            ...
            <div class="white-box">
                ...
                <div class="table-responsive">
                    <table id="myTable" class="table table-striped">
                        ...
                        {foreach key=key item=item from=$ObjResult->isEditor()}
                            {$number=$number+1}
                            <tr id="del-{$item.id}">
                                <td>{$number}</td>
                                <td>توضیحات، مدارک لازم، قوانین و مقررات، قوانین کنسلی و برنامه سفر تور؛ ورود اطلاعاتش با ویرایشگر باشد.</td>
                                <td>
