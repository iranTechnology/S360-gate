...
<div class="container-fluid">
    <div class="row bg-title">
        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
            <ol class="breadcrumb FloatRight">
                ...
                {/if}
                <li class="active">گالری هتل {$objFunction->ShowName('reservation_hotel_tb', {$smarty.get.id})}</li>
            </ol>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="white-box">
                <h3 class="box-title m-b-0">{$objFunction->ShowName('reservation_hotel_tb', {$smarty.get.id})}  اضافه کردن عکس برای هتل</h3>
    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            <div class="white-box">
                <h3 class="box-title m-b-0">گالری هتل {$objFunction->ShowName('reservation_hotel_tb', {$smarty.get.id})} </h3>
                            ...
                            <td>{$item.name}</td>
                                ...
                                <td>
                                    {if $item.is_del neq 'yes'}
                                        <a href="editHotelGallery&id={$item.id}">
                                ...
                                <td>
                                    {if $item.is_del neq 'yes'}
                                        <a id="DelHotelGallery-{$item.id}" href="#" onclick="logical_deletion('{$item.id}', 'reservation_hotel_gallery_tb'); return false" class="popoverBox  popover-danger" data-toggle="popover" title="حذف تغییرات" data-placement="right"
