...
{* دریافت آمار *}
{assign var="statsData" value=$objReport->showDestinationStats()}
    ...
    <div class="row bg-title">
        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
            <ol class="breadcrumb FloatRight">
                ...
                <li class="active">آمار تفکیکی مقصدها</li>
            </ol>
        </div>
            ...
            <div class="white-box">
                <div class="row">
                    <div class="col-sm-12">
                        <h4 class="box-title m-b-0">
                            <i class="fa fa-globe"></i> آمار تفکیکی مقصدها
                        </h4>
                        <p class="text-muted m-b-30">
                            نمایش آمار بازدید کشور ها برای آژانس
                            <strong>{$statsData.agency.name|default:'انتخاب نشده'}</strong>
                ...
                {if $statsData.success && $statsData.count > 0}
                    ...
                    <div class="table-responsive">
                        <table id="destinationTable" class="table table-striped table-bordered table-hover">
                            <thead>
                            <tr>
                                <th width="10" class="text-center">ردیف</th>
                                <th width="60" class="text-right">کشور</th>
                            ...
                            {foreach $statsData.data as $key => $item}
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="safarBankReportImpressionDestCity&id={$smarty.get.id}&country={$item.destination}">
...
<style>
    ...
    #destinationTable td:first-child,
    #destinationTable th:first-child {
        text-align: center !important;
    }
    .font-bold {
        font-weight: 600;
...
<script>
    function showDetail(destination, type, agencyId) {
        alert('نمایش جزئیات برای مقصد: ' + destination + '\nنوع: ' + type + '\nشناسه آژانس: ' + agencyId);
        // می‌توانید اینجا یک مودال باز کنید یا به صفحه دیگری هدایت کنید
    }
</script>