    ...
    <div class="row bg-title">
        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
            <ol class="breadcrumb FloatRight">
                ...
                <li class="active">آرشیو پرواز روزانه</li>
            </ol>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-sm-12">
            <div class="white-box">
                <h3 class="box-title m-b-0">آرشیو پرواز روزانه</h3>

                {assign var="number" value="0"}
                {foreach key=key item=item from=$objResult->charterArchiveFilterDay($smarty.get.flyCode, $smarty.get.airline, $smarty.get.id)}
