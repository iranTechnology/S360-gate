    ...
    <div class="row bg-title">
        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
            <ol class="breadcrumb FloatRight">
                ...
                <li>رزرواسیون</li>
                <li>تنظیمات</li>
                <li class="active">تنظیمات تور</li>
            </ol>
        </div>
    </div>
            ...
            <div class="white-box">
                ...
                <div class="table-responsive">
                    <table id="myTable" class="table table-striped">
                        ...
                        {foreach key=key item=item from=$ObjResult->orderTour()}
                            {$number=$number+1}
                            <tr id="del-{$item.id}">
                                <td>{$number}</td>
                                <td>{$item.title}</td>
                                <td>
                                    <a onclick="orderTourActive('{$item.id}'); return false;">
                                    {if $item.enable eq '1'}
                                ...
                                {if $smarty.const.TYPE_ADMIN eq '1'}
                                    ...
                                    <td>
                                        <a id="DelHotelRoom-3" href="#" onclick="logical_deletion('{$item.id}', 'reservation_tour_setting_tb'); return false"
