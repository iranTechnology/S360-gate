...
{$objResult->SelectAllWithCondition('reservation_room_quality_tb', 'id', $smarty.get.id)}
    ...
    <div class="row bg-title">
        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
            <ol class="breadcrumb FloatRight">
                ...
                <li><a href="roomQuality">کیفیت اتاق</a></li>
                <li class="active">ویرایش کیفیت اتاق</li>
            </ol>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="white-box">
                ...
                <p class="text-muted m-b-30">شما با استفاده از فرم زیر میتوانید کیفیت اتاق را در سیستم ویرایش نمائید</p>
