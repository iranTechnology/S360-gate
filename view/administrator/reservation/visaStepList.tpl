{load_presentation_object filename="visa" assign="objVisaStep"}
{assign var="data" value=$objVisaStep->StepAdditionalData($smarty.get.visaId)}
    ...
    <div class="row bg-title">
        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
            <ol class="breadcrumb FloatRight">
                ...
                <li class='active'>مراحل اخذ ویزا</li>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="white-box">
                ...
                <h4>درج مراحل اخذ ویزا</h4>
                <form id="EditStep" method="post">
                    <input type="hidden" name="flag" value="updateStep">
