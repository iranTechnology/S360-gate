...
{* دریافت آمار *}
{assign var="statsData" value=$objReport->showTourStats()}
    ...
    <div class="row bg-title">
        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
            <ol class="breadcrumb FloatRight">
                ...
                <li class="active">آمار تفکیکی تورها - {$city|default:''}</li>
            </ol>
        </div>
    </div>
            ...
            <div class="white-box">
                <div class="row">
                    <div class="col-sm-12">
                        <h4 class="box-title m-b-0">
                            <i class="fa fa-plane"></i> آمار تفکیکی تورها
                        </h4>
                        <p class="text-muted m-b-30">
                            نمایش آمار بازدید تورها برای شهر
                            <strong>{$city|default:'انتخاب نشده'}</strong>
                ...
                {if $statsData.success && $statsData.count > 0}
                    ...
                    <div class="table-responsive">
                        <table id="tourTable" class="table table-striped table-bordered table-hover">
                            <thead>
                            <tr>
                                <th width="10" class="text-center">ردیف</th>
                                <th width="120" class="text-right">نام تور</th>
                                <th width="80" class="text-center">تاریخ تور</th>
                                <th width="60" class="text-center">امپرشین</th>
                            </tr>
                            </thead>
                            <tbody>
                            {foreach $statsData.data as $key => $item}
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <span class="label label-default">{$item.start_date|default:'-'}</span>
                                    </td>
                                    <td class="text-center">
                                        <a href="safarBankReportImpressionTourDaily&id={$smarty.get.id}&city={$smarty.get.city}&tour_name={$item.tour_name|urlencode}">
                ...
                {else}
                    <div class="alert alert-warning text-center">
                        ...
                        {if $statsData.success}
                            هیچ توری برای شهر <strong>{$city}</strong> در بازه زمانی انتخاب شده یافت نشد.
                        {else}
