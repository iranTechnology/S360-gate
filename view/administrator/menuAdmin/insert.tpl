        ...
        <div class="col-sm-12">
            <div class="white-box">
                <form id="addMenuAdmin" method="post">
                    ...
                    <div class="form-group col-sm-4">
                        <label for="other_lang" class="control-label"></label> زبان های دیگر را دارد<small style="color: red"> انگلیسی - عربی </small>
                        <select name="other_lang" id="other_lang"  class="form-control select2">
                            <option value="">انتخاب کنید....</option>
