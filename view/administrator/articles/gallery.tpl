...
{assign var="article" value=$objArticles->getArticle($smarty.get.id)}
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="white-box col-md-12">
                <h3 class="box-title m-b-0"> اضافه کردن عکس برای مقاله</h3>
...
<script type="text/javascript">
  myDropzone.on('sending', function(file, xhr, formData) {
    ...
    formData.append('className', 'articles')
    formData.append('id', '{$article['id']}')
  })
  myDropzone.on('success', function(file, response) {
    GetArticleGalleryData("{$article['id']}")
