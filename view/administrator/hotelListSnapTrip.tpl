...
{assign var="snapTripHotels" value=$objHotel->listHotelSnapTrip(100, 0)}
        ...
        <div class="col-sm-12">
            <div class="white-box">
                <h3 class="box-title m-b-0">
                    لیست هتل‌های اسنپ تریپ
                    <span class="text-muted" id="hotelCount">({$snapTripHotels|count} هتل)</span>
                </h3>
                <p class="text-muted m-b-30">نمایش هتل‌های موجود در سرویس اسنپ تریپ</p>
                ...
                <div class="table-responsive">
                    <table id="hotelTable" class="table table-striped table-bordered">
                        ...
                        {foreach key=key item=hotel from=$snapTripHotels}
                            ...
                            <tr>
                                ...
                                <td class="align-middle">{$hotel.city_name|default:'-'}</td>
                            </tr>
                            {foreachelse}
                            <tr>
