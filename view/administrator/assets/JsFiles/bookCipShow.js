...
function ModalShowBookForCip(RequestNumber) {


    $.post(libraryPath + 'ModalCreator.php',
        {
            Controller: 'bookshow',
            Method: 'ModalShowBookForCip',
            Param: RequestNumber,
        },
        function (data) {
            $('#ModalPublic').html(data);
...
function ModalShowBookForServiceCip(RequestNumber) {


    $.post(libraryPath + 'ModalCreator.php',
        {
            Controller: 'bookshow',
            Method: 'ModalShowBookForServiceCip',
            Param: RequestNumber,
        },
        function (data) {
            $('#ModalPublic').html(data);
...
function selectTextMessage(_this){
    ...
    let sample_text=$('input[name="sample_sms_text"]').val()
    let new_text=''
    ...
    switch (_this.val()) {
        ...
        case 'Cancel':
            ...
            break;
        case 'Change':
            sample_text = sample_text.replace('با عرض پوزش ،', '').replace('با عرض پوزش،', '').replace('با عرض پوزش', '');
            new_text=''
            break;
        case 'OtherSms':
            sample_text=''
