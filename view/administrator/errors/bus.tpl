...
<div class="container-fluid">
    <div class="row bg-title">
        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
            ...
            <ol class="breadcrumb FloatRight">
                <li><a href="{$smarty.const.ROOT_ADDRESS_WITHOUT_LANG}/itadmin/errors/bus">خانه</a></li>
                <li class="active">لیست خطا های اتوبوس</li>
            </ol>
        </div>
        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="white-box">
                <h3 class="box-title m-b-0">لیست خطا های اتوبوس </h3>
                 <div class="row">

                            <div class="form-group col-sm-12 DynamicAdditionalData">
                                
                                {assign var="listErrors" value=$objErrors->showAllErrors('bus')}
