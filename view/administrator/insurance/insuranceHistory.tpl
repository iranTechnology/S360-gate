    ...
    <div class="row bg-title">
        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
            ...
            <ol class="breadcrumb FloatRight">
                ...
                <li>گزارش خرید</li>
                <li class="active">سوابق خرید بیمه</li>
            </ol>
        </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="white-box">
                ...
                <form id="SearchInsuranceHistory" method="post" action="{$smarty.const.rootAddress}insuranceHistory">
        ...
        <div class="col-sm-12">
            <div class="white-box">
                ...
                <div class="box-btn-excel">
                    <a onclick="createExcelForReportInsurance()" class="btn btn-primary waves-effect waves-light " type="button" id="btn-excel">
                ...
                <div class="table-responsive">
                    <table id="insuranceHistory" class="table table-striped text-center">
                        <thead>
                        <tr>
                            <th>ردیف</th>
                            <th>تاریخ خرید<br />شماره بیمه</th>
                            <th>مقصد<br />نوع بیمه<br />شماره فاکتور</th>
                            <th>عنوان بیمه</th>
                            <th>نام خریدار<br /> نوع کاربر<br />تعداد<br />نوع کانتر</th>
                            <th>سهم آژانس</th>
                            {if $smarty.const.TYPE_ADMIN eq '1'}<th style="direction: ltr">+ apiسود </th>{/if}
                            {if $smarty.const.TYPE_ADMIN eq '1'}
                            <th> سهم ما</th>
                            {/if}
                        ...
                        <tr id="del-{$item.id}">
                            ...
                            <td>{$item.destination}<br />{$item.source_name_fa}<br />{$item.factor_number}</td>
                            ...
                            <td>{$item.totalPriceIncreased|number_format}<br /><span class="font11">{$item.passenger_name} {$item.passenger_family}</span></td>
                            ...
                            <td>
                                ...
                                <div class="btn-group m-r-10">
                                    ...
                                    <ul role="menu" class="animated flipInY" style="list-style: none; padding: 0;">
                                        <li>
                                            {if $item.status neq 'nothing'}
                                            <a onclick="ModalShowBookForInsurance('{$item.factor_number}');return false" data-toggle="modal" data-target="#ModalPublic">
                            ...
                            <td>
                                ...
                                <hr style='margin:3px'>
                                {if $item.reference_application eq 'gds'}
                                    gds
                                {elseif $item.reference_application eq 'at'}
                                    اتوماسیون
                                {elseif $item.reference_application eq 'safar360'}
                                    سفر360
                                {/if}
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            {if $smarty.const.TYPE_ADMIN eq '1'}<th>({$objbook->totalApiCommission|number_format})ريال</th>{/if}
                            {if $smarty.const.TYPE_ADMIN eq '1'}<th>({$objbook->totalOurCommission|number_format})ريال</th>{/if}
                            <th>({$objbook->totalCost|number_format})ريال</th>
                            {if $smarty.const.TYPE_ADMIN eq '1'}<th colspan="2"></th>{else}<th colspan="4"></th>{/if}
                        </tr>
...
<div class="i-section">
    <div class="i-info">
        <span> ویدیو آموزشی بخش سوابق خرید بیمه   </span>
    </div>
