            ...
            <div class="col-sm-12">
                <div class="white-box">
                    ...
                    <form id="SearchTransaction" method="post"
                          action="{$smarty.const.ROOT_ADDRESS_WITHOUT_LANG}/itadmin/newTransaction">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <select name="Reason" id="Reason" class="form-control">
                                ...
                                <option value="buy" {if $smarty.post.Reason eq 'buy' or empty($smarty.post.Reason)}selected="selected"{/if}>خرید</option>
                                ...
                                <option value="indemnity_cancel" {if $smarty.post.Reason eq 'indemnity_cancel'}selected="selected"{/if}>واریز کنسلی</option>
                                <option value="all" {if $smarty.post.Reason eq 'all'}selected="selected"{/if}>همه</option>
                            </select>
                        </div>
                        <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="white-box">
                    ...
                    {assign var="transactions" value=$objTransaction->getAllTransactions()}
                        ...
                        <table id="all_transactions" class="table table-striped">
                            ...
                            {foreach key=key item=item from=$transactions}
                                ...
                                <tr id="del-{$item.id}" >
                                    ...
                                    <td>
                                        <span style="color: {$item.typeColor}; font-weight: bold;">{$item.type}</span>
                                    </td>
                                    <td>{$item.comment}</td>
                                    <td>{$item.date}</td>
                                    {*                                    <td>{$item.price|number_format}</td>*}
                                    {*                                    <td>{$item.customer_price|number_format}</td>*}
                                    <td>{$item.depositToAccount|number_format:0:".":","}</td>
                                    <td>{$item.accountDeducted|number_format:0:".":","}</td>
