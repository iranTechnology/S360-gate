...
{assign var="is_from_banner" value=$smarty.get.banner}
    ...
    <div class="row">
        <form data-toggle="validator" method="post" id="editSpecialPage" enctype='multipart/form-data'>
            ...
            <input type="hidden" name="page_id" value="{$special_page['id']}">
                ...
                <div class="{if $is_from_banner eq 1}d-none{/if} col-lg-8 col-md-8 col-sm-12 col-xs-12">
            ...
            <div class="{if $is_from_banner neq 1}col-lg-4 col-md-4 col-sm-12 col-xs-12{else}col-lg-12 col-md-12 col-sm-12 col-xs-12{/if}">
                <div class="d-flex flex-wrap gap-10">

                    <div class="bg-white {if $is_from_banner neq 1}d-flex{else}d-none{/if} flex-wrap rounded w-100 ">
                        <div class=' d-flex justify-content-between align-content-center flex-wrap w-100'>
                            <h4 class='align-items-center d-flex flex-wrap font-bold gap-10 m-0 px-4 py-3'>
                                زبان
                            </h4>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="d-flex flex-wrap form-group gap-5 w-100">
                                ...
                                <input  onchange="dropHandler(event,true)" type='file' accept="image/*,pdf"
                                       class=' d-none'
                                        {if $is_from_banner neq '1'}multiple {/if}  name='gallery_files[]' id='gallery_files'>
                            ...
                            <div class='d-flex flex-wrap gap-10 justify-content-center p-10 w-100'>
                                ...
                                {foreach $special_page['files']['gallery_files'] as $key=>$file}
                                    <div class="align-items-center flex-wrap dropzone-parent-box d-flex justify-content-between p-3 pip rounded-xl w-100 ">
                                        ...
                                        <img class="border d-flex imageThumb image-count rounded-xl w-25"
                                             src='{$file['src']}'
                                             title="" data-count="{$special_page['files']['gallery_files']|count}">
                                        ...
                                        <div class='dropzone-parent-trash-shakkhes'>
                                            ...
                                            <div class='dropzone-radio-shakhes  {if $is_from_banner eq '1'}d-none{/if}'>
                    ...
                    <div class="separate-toggleable  {if $is_from_banner eq '1'}d-none{/if} {if $special_page['page_type'] eq 'separate' } d-flex  {else} d-none {/if} bg-white d-flex flex-wrap rounded w-100 ">
                        <div class='d-flex justify-content-between align-content-center flex-wrap w-100 '>
                            <h4 class='align-items-center d-flex flex-wrap font-bold gap-10 m-0 px-4 py-3'>
                                فایل های ضمیمه
                            </h4>
