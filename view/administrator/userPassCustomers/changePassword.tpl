...
<div class="container-fluid">
    ...
    <div class="row">
        <form data-toggle="validator" id="change_password" method="post"  enctype="multipart/form-data">
            <input type='hidden' value='changePasswordCustomer' id='method' name='method'>
            ...
            <input type='hidden' value='{$info_customer['user_name']}' id='user_name' name='user_name'>
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="d-flex flex-wrap gap-10">

                    <div class="bg-white d-flex flex-wrap rounded w-100 ">
                        <div class='d-flex justify-content-between align-content-center flex-wrap w-100'>
                            <h4 class='d-flex flex-wrap font-bold m-0 py-3 px-4'>تغییر رمز عبور    {$info_customer['title']} </h4>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group">
                                <label for="new_password" class="control-label">رمز عبور جدید</label>
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group">
                                <label for="new_password_repeat" class="control-label">تکرار رمز عبور جدید</label>
                                <input type="text" class="form-control" name="new_password_repeat" id="new_password_repeat"
