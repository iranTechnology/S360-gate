...
<html class="no-js" lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="http://mahbalseir.com/fa/user/GlobalFile/css/register.css">
                            ...
                            <div class="container d-flex flex-wrap">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12 ">
                                    ...
                                    <div class="menu-login">
                                        <div onclick="window.location = '{$smarty.const.ROOT_ADDRESS}/loginUser'" class="c-header__btn">
                                            <div class="c-header__btn-login" >
                                                {include file="`$smarty.const.FRONT_THEMES_DIR`old_mahbal_seir/topBarName.tpl"}
                                ...
                                <div class="mainMenuContainer">
                                    ...
                                    <ul class="mainMenu">
                                        <li class= "active">
                                            ...
                                            <a  href="http://{$smarty.const.CLIENT_MAIN_DOMAIN}/fa/user/home.php">صفحه اصلی</a>
                                        </li>
                    ...
                    <div class="copyright " >
                        <div class="container">
                            ...
                            <div class="col-lg-6 col-md-5 col-xs-12 irantech " >
                                <p class="txt14 yekan txtDDD">طراحی وب سایت: <a class="it-link" href="#" onclick="return false">ایران تکنولوژی</a></p>
                            </div>
                        </div>
                    </div>
                </footer>
