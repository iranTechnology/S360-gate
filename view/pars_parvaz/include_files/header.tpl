...
{load_presentation_object filename="parsParvaz" assign="obj_main_page" subName="customers"}
...
<link rel="stylesheet" href="project_files/css/select2.css"><link rel="stylesheet" href="project_files/css/owl.theme.default.min.css"><link rel="stylesheet" href="project_files/css/owl.carousel.min.css">
