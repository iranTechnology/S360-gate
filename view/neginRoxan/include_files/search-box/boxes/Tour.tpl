<div class="__box__  tab-pane {if $smarty.const.PAGE_TITLE == 'internalTour' ||  $smarty.const.GDS_SWITCH eq 'mainPage'} active show {/if}" id="Tour_internal" role="tabpanel" aria-labelledby="tour-tab">
 <div id="tour_dakheli" class="_internal row">
  <form class="d_contents" method="post" name="gdsTourLocal" id="gdsTourLocal" target="_blank">
   ...
   <div class="col-lg-2 p-2 col-md-6 col-sm-6 col-12 btn_s col_search margin-center">
...
<div class="__box__  tab-pane {if $smarty.const.PAGE_TITLE == 'internationalTour' } active show {/if}" id="Tour_external" role="tabpanel" aria-labelledby="tour-tab2">
