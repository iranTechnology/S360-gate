...
{assign var="max_internal" value=6}
...
{assign var="max_external" value=6}
            ...
            <div>
                ...
                <div class="parent-tab-tour">
                    <div class="tab-content" id="pills-tabContent">
                        <div aria-labelledby="tab-tour-dakheli" class="__tour__internal__ tab-pane fade show active"
                             id="tour-dakheli" role="tabpanel">
                            <div class="__tour__internal__ owl-carousel owl-theme owl-tours">
                                            ...
                                            <a class="link-parent"
                                               href="{$smarty.const.ROOT_ADDRESS}/detailTour/{$item['id_same']}/{$item['tour_slug']}">
                                                <div class="parent-img-tour">
                                                    <img alt="{$item['tour_name']}"
                                                         class="__image_class__"
...
{*                                                                {for $i = 0; $i < count($item['rate_average']); $i++}*}
{*                                                                    <svg class="__star_class_light__1"*}
{*                                                                         viewbox="0 0 576 512"*}
...
<i class="fa-light fa-sack-dollar"></i>
                                                        ...
                                                        <span class="___price_class__ color-toman">{$item['min_price']['discountedMinPriceR']|number_format} تومان</span>
                                                    </div>
...
<i class="fa-light fa-calendar-days"></i>
                                                        ...
                                                        <span class="__date_class__">
                                                            ...
                                                            {$day} {$objFunctions->dateFormatSpecialJalali($item['startDate'],'F')} {$year}
                            ...
                            <div class="__tour__internal__ parent-tours">
                                ...
                                {foreach $tour_internal as $item}
                                    {if $min_internal <= $max_internal}
                                        <a class="__i_modular_nc_item_class_0 link-parent"
                                           href="{$smarty.const.ROOT_ADDRESS}/detailTour/{$item['id_same']}/{$item['tour_slug']}">
                                            <div class="parent-img-tour">
                                            ...
                                            <div class="parent-text-owl">
                                                <div class="parent-title-rank">
                                                    ...
                                                    <div class="parent-rating">
                                                        <div class="rating-stars">
{*                                                            {for $i = 0; $i < count($item['rate_average']); $i++}*}
{*                                                                <svg class="__star_class_light__1" viewbox="0 0 576 512"*}
{*                                                                     xmlns="http://www.w3.org/2000/svg">*}
{*                                                                    <!--! Font Awesome Pro 6.3.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->*}
{*                                                                    <path d="M316.9 18C311.6 7 300.4 0 288.1 0s-23.4 7-28.8 18L195 150.3 51.4 171.5c-12 1.8-22 10.2-25.7 21.7s-.7 24.2 7.9 32.7L137.8 329 113.2 474.7c-2 12 3 24.2 12.9 31.3s23 8 33.8 2.3l128.3-68.5 128.3 68.5c10.8 5.7 23.9 4.9 33.8-2.3s14.9-19.3 12.9-31.3L438.5 329 542.7 225.9c8.6-8.5 11.7-21.2 7.9-32.7s-13.7-19.9-25.7-21.7L381.2 150.3 316.9 18z"></path>*}
{*                                                                </svg>*}
...
<i class="fa-light fa-calendar-days"></i>
                        ...
                        <div aria-labelledby="tab-tour-khareji" class="__tour__external__ tab-pane fade"
                             id="tour-khareji" role="tabpanel">
                            <div class="__tour__external__ owl-carousel owl-theme owl-tours">
