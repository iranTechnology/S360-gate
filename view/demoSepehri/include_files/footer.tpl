                        ...
                        <div class="col-xl-3 col-md-6 col-lg-3 col_foo">
                            <div class="footer_widget">
                                ...
                                <ul class="links double_links">
                                    ...
                                    <li><a href="{$smarty.const.ROOT_ADDRESS}/page/flight">##S360Flight##</a>
                                    </li>
                                    ...
                                    <li class=""><a
                                                href="{$smarty.const.ROOT_ADDRESS}/page/visa">##S360Visa##</a>
                                    </li>

                                    <li><a href="{$smarty.const.ROOT_ADDRESS}/page/train">##S360Train##</a>
                                    </li>

                                    <li><a href="{$smarty.const.ROOT_ADDRESS}/page/bus">##S360Bus##</a></li>

                                    <li><a href="{$smarty.const.ROOT_ADDRESS}/page/fun">
                                            ##S360Entertainment## </a></li>
                                    <li><a href="{$smarty.const.ROOT_ADDRESS}/page/car"> ##S360Car## </a></li>
                        ...
                        <div class="col-12 ">
                            <div class="col_namads">
                                <a target="_blank" rel="nofollow" href="https://www.cao.ir/paxrights">
                                    <img src="project_files/{$smarty.const.SOFTWARE_LANG}/images/certificate1.png" alt="">
                                </a>
                                <a target="_blank" rel="nofollow" href="https://www.cao.ir/">
                                    <img src="project_files/{$smarty.const.SOFTWARE_LANG}/images/certificate2.png" alt="">
                                </a>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            ...
                            <div class="copyright_content_text copyright_content d-flex flex-row justify-content-center">
                                ##SoftwareDemo##
                            </div>
