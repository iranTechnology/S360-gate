...
<section class="i_modular_banner_gallery">
    <div class="banner-safiran __banner_tabs__">
{*        <img alt="img-banner" class="__image_class__" src="project_files/images/bg.jpg"/>*}
    </div>
    <div class="i_modular_searchBox search_box">
        <div class="container">
            ...
            <div class="search_box_div_mobile">
                <ul class="nav" id="searchBoxTabsMobile">
...
<style>
    ...
    {/if}
   .banner-slider-display { display: none; }
</style>
