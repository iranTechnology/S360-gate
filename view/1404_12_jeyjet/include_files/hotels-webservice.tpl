            ...
            <div>
                ...
                <div class="parent-tab-hotel">
                    <div class="tab-content" id="pills-tabContent-hotel">
                        <div aria-labelledby="tab-hotel-dakheli" class="__hotel__internal__ tab-pane fade show active"
                             id="hotel-dakheli" role="tabpanel">
                        ...
                        <div aria-labelledby="tab-hotel-khareji" class="__hotel__external__ tab-pane fade"
                             id="hotel-khareji" role="tabpanel">
                                                    ...
                                                    <a class="link-parent"
                                                       href="{$smarty.const.ROOT_ADDRESS}/resultExternalHotel/{$item['CountryEn']}/{$item['DepartureCityEn']}/{$objDate->daysAfterToday('7')}/{$objDate->daysAfterToday('8')}/1/R:2-0-0">
                                                        ...
                                                        <div class="text-hotel">
                                                            ...
                                                            <span class="__city_class__">{$item['DepartureCityFa']}</span>
                                                        </div>
                                                    </a>
                                                </div>
