...
<div class="col-12 p-0 pt-1 d-flex flex-wrap parent_multiTrack additional-flight-multi-way-js p-1" p-1="">
...
<div class="col-lg-2 col-md-4 col-sm-6 col-12 col_search date_search p-1">
<div class="form-group w-100">
...
<div class="remove_btn d-none col-lg-auto col-md-3 col-sm-3 col-6 btn_s col_search p-1" id="remove_btn">
