    ...
    <section class="i_modular_hotels_webservice hotel-ghods">
        <div class="container">
            <div class="title-ghods" data-aos="fade-up">
                ...
                <a class="more-title-ghods" href="{$smarty.const.ROOT_ADDRESS}/page/hotel">
            ...
            <div data-aos="fade-up">
                ...
                <div class="parent-tab-hotel">
                    <div class="tab-content" id="pills-tabContent-hotel">
                        <div aria-labelledby="tab-hotel-dakheli" class="__hotel__internal__ tab-pane fade show active" id="hotel-dakheli" role="tabpanel">
                            <div class="owl-carousel owl-theme owl-hotel-ghods">
                                ...
                                {foreach $hotel_internal as $item}
                                        ...
                                        <div class="__i_modular_nc_item_class_0 item">
                                            <a class="link-parent" href="{$smarty.const.ROOT_ADDRESS}/roomHotelLocal/reservation/{$item['id']}/{$item['name_en']|strip:'-'}">
                                                <img alt="{$item['City']}" class="__image_class__" src="{$smarty.const.ROOT_ADDRESS_WITHOUT_LANG}/pic/{$item['logo']}"/>
                        ...
                        <div __i_modular_nc_item_class_3="" aria-labelledby="tab-hotel-khareji" class="__hotel__external__ tab-pane fade" id="hotel-khareji" role="tabpanel">
                            <div class="owl-carousel owl-theme owl-hotel-ghods">
