...
{if $check_general}
    <section class="i_modular_tours tab-tour">
        <div class="container">
            ...
            <ul data-aos="fade-up" class="nav nav-pills d-flex align-items-center justify-content-center" id="pills-tab" role="tablist">
            ...
            <div data-aos="fade-up" class="parent-tab-tour">
                <div class="tab-content" id="pills-tabContent">
                    ...
                    <div aria-labelledby="tab-tour-khareji" class="tab-pane fade show active" id="tour-khareji"
                        ...
                        <a data-aos="fade-up" class="btn-more" href="{$smarty.const.ROOT_ADDRESS}/page/tour">
