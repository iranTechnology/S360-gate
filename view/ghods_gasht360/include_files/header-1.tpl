...
{load_presentation_object filename="ghodsGasht" assign="obj_main_page" subName="customers"}
...
<!-- datepicker calendar -->
<script src="assets/datepicker/jalali.js" type="text/javascript"></script>
...
<link href="project_files/css/{$StyleSheetHeader}" rel="stylesheet"/>
    ...
    <script>
      !function (t, e, n) {
        ...
        s.id = "ua-script-NH38ELHF"; s.dataset.analyticsobject = n;
        s.async = 1; s.type = "text/javascript";
        s.src = "https://cdn.yektanet.com/rg_woebegone/scripts_v3/NH38ELHF/rg.complete.js?v=" + r, c.parentNode.insertBefore(s, c)
