        ...
        <div class="row">
            <div class="col-lg-3 col-md-6">
                <div class="links_box">
                    ...
                    <div class="links_btn"><a href="https://s360online.iran-tech.com/gds/loginUser"
                                              class="cta"><span>ورود </span></a><a
                                href="https://s360online.iran-tech.com/gds/registerUser"
            ...
            <div class="col-lg-3 col-md-6 meteorology">
                <div class="links_box">
                    ...
                    <a class="ttt" href="javascript:"> هواشناسی</a>
                    <div class="captin_box"><p>توسط این بخش می تواند منطقه یا مناطق جغرافیایی را جهت نمایش وضعیت آب
                            هوایی انتخاب نماید.تا در زمان گردش بیشترین لذت را از مسافرت خود داشته باشید.</p></div>
                    <div class="links_btn"><a href="javascript:" class="cta SMWeather"><span>هواشناسی </span></a>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 exchange_rate">
                <div class="links_box">
                    ...
                    <div class="captin_box"><p>توسط این بخش شما می تواند بروز ترین ، آخرین نرخ لحظه ای ارزهای
                            انتخابی خود را بر اساس ارز مرجع،مشاهده نمایید. تا در زمان گردش بیشترین لذت را از مسافرت خود
                            داشته باشید</p></div>
                    <div class="links_btn"><a href="javascript:" class="cta SMChange"><span>نرخ ارز </span></a>
                    </div>
                </div>
            </div>
        </div>
