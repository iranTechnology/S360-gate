...
{*                                                <a href="{$smarty.const.ROOT_ADDRESS}/resultTourLocal/1-all/1-{$item_tour.id}/{$objDate->jdate("Y-m-d", '', '', '', 'en')}/all">*}
                                                    <a href="{$smarty.const.ROOT_ADDRESS}/resultTourLocal/1-2/1-{$item_tour.id}/all/all">
...
{*                                                <a href="{$smarty.const.ROOT_ADDRESS}/resultTourLocal/1-all/{$item_tour.id}-all/{$objDate->jdate("Y-m-d", '', '', '', 'en')}/all">*}
                                ...
                                <li><a href="{$smarty.const.ROOT_ADDRESS}/page/tours"> جست و جوی تور </a></li>
                            </ul>
                        </li>
                        ...
                        <li class="purchase-tracking"><a href="{$smarty.const.ROOT_ADDRESS}/UserTracking">پیگیری خرید</a></li>
