        ...
        <div class="d-flex flex-wrap align-items-center">
            <div class="col-lg-6  col-md-6 col-sm-12 col-12 my-div-mobile">
                <div class="parent-about">
                    <!--                            <h5 class="titr-top">دوکاتور</h5>-->
                    <h2 class="mb-3">درباره ما</h2>
                    <h3>تمام تورها و هتل های دنیا را با ما جست و جو کنید.</h3>
                    <p>
                    ...
                    <ul class="ul-about">
                        <li>
                            ...
                            <span>با بیش از 10 سال سابقه کاری</span>
                        </li>
                        <li>
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--! Font Awesome Pro 6.3.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path class="fa-primary" d="M438.6 105.4C451.1 117.9 451.1 138.1 438.6 150.6L182.6 406.6C170.1 419.1 149.9 419.1 137.4 406.6L9.372 278.6C-3.124 266.1-3.124 245.9 9.372 233.4C21.87 220.9 42.13 220.9 54.63 233.4L159.1 338.7L393.4 105.4C405.9 92.88 426.1 92.88 438.6 105.4H438.6z"/></svg>
                            </div>
                            <span>سریع تر و ایمن تر سفر کنید</span>
                        </li>
                        <li>
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--! Font Awesome Pro 6.3.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path class="fa-primary" d="M438.6 105.4C451.1 117.9 451.1 138.1 438.6 150.6L182.6 406.6C170.1 419.1 149.9 419.1 137.4 406.6L9.372 278.6C-3.124 266.1-3.124 245.9 9.372 233.4C21.87 220.9 42.13 220.9 54.63 233.4L159.1 338.7L393.4 105.4C405.9 92.88 426.1 92.88 438.6 105.4H438.6z"/></svg>
                            </div>
                            <span>پشتیبانی 24 ساعته در تمامی مراحل سفر</span>
                        </li>
                    </ul>
            ...
            <div class=" col-lg-5 offset-lg-1 col-md-6 col-sm-12 col-12 d-none d-md-block">
                <div class="about-img position-relative">
                    <div class="parent-img">
                        <img src="project_files/images/about.png" alt="about">
                    </div>
                </div>
            </div>
        </div>
