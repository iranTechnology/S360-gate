<div class="col-md-12 col-xs-12 col-sm-12 d-ceckboxs">
    <div class="cntr">
        <label for="rdo-10" class="btn-radio select_multiway select-type-way-js" data-type='internal'>
        ...
        <label for="rdo-20" class="btn-radio select_multiway select-type-way-js">
