...
{*        <select data-placeholder=" انتخاب مبدأ "*}
{*                name="route_origin_internal" id="route_origin_internal"*}
{*                class="select2_in select2-hidden-accessible origin-internal-js" tabindex="-1" aria-hidden="true" use-cusatomer-db="false">*}
{*            <option >انتخاب مبدا</option>*}

{*            {foreach $routes_departure_flight_internal as $rout_departure}*}
{*                <option value="{$rout_departure['Departure_Code']}">{$rout_departure['Departure_City']} ({$rout_departure['Departure_Code']} )</option>*}
{*            {/foreach}*}
{*        </select>*}
{*    </div>*}
{*    <button onclick="reversRouteFlight('internal')" class="switch_routs" type="button" name="button">*}
