                    ...
                    <div class="parent-text-category-tour-demo">
                        ...
                        <div>
                            ...
                            <span class="___price_class__">
                                {$tour['min_price']['discountedMinPriceR']|number_format} ریال

                                {if $tour['min_price']['minPriceA']|floatval > 0}
                                    + {$tour['min_price']['minPriceA']} {$tour['min_price']['CurrencyTitleFa']}
                                {/if}
                            </span>
                            <span>ریال</span>
                        </div>
                                ...
                                <a href="{$smarty.const.ROOT_ADDRESS}/detailTour/{$item['id_same']}/{$item['tour_slug']}" class="__i_modular_nc_item_class_0">
                                    <div class="parent-img">
                                        ...
                                        <div class="___price_class__ price-tour-demo">
                                            ...
                                            {if $item['min_price']['minPriceA']|floatval > 0}
                                                + {$item['min_price']['minPriceA']} {$item['min_price']['CurrencyTitleFa']}
                                            {/if}
                                        </div>
                                    </div>
                                    <div class="text-tour">
