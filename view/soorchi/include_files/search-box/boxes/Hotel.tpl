<div class="__box__ tab-pane" id="Hotel">
    ...
    <div class="_external flex-wrap international-hotel-js" id="international_hotel">
        <form class="d_contents" data-action="https://s360online.iran-tech.com/" id="international_hotel_form"
            ...
            <div class="col-lg-2 col-md-3 col-sm-6 col-12 btn_s col_search margin-center p-1">
                <input class="nights-hotel-js" id="nights_hotel" name="nights_hotel" placeholder="زمان خروج"
                       type="hidden" value="" />
                <button class="btn theme-btn seub-btn b-0" onclick="searchInternationalHotel()" type="button"><span>جستجو</span>
                </button>
            </div>
        </form>
    </div>
