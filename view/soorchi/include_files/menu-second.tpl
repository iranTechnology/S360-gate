...
<section class="i_modular_menu gym" id="gym-box">
    <div class="container">
        <div class="parent-gym">
            <div class="gym-text">
                <h3>باشگاه همسفران السا گشت</h3>
                <p>به باشگاه السا گشت خوش آمدید، جایی که همه ی سفرها به یاد ماندنی می شوند. اینجا مکانی است برای

                    شما که در ماجراجویی های خود، السا گشت را انتخاب کرده اید.</p>
                <p>در این باشگاه منحصر به فرد، خدمات و امکاناتی وجود دارند که تجربه ی سفرهای با السا گشت را به اوج

                    می رسانند.

                    شما به عنوان یک همسفر ویژه، بازیگر اصلی این ماجرا هستید. به ما بپیوندید و با السا گشت، به
