...
<?php
class salamParvazIframe extends mainPage {
    ...
    public $icons_json = '{
         "Flight_internal": {"icon": "<i class=\"fa-light fa-plane-circle-check\"></i>", "name": "پرواز داخلی"},
         "Flight_external": {"icon": "<i class=\"fa-light fa-plane-departure\"></i>", "name": "پرواز خارجی"},
         "Hotel_internal": {"icon": "<i class=\"fa-light fa-house\"></i>", "name": "هتل داخلی"},
         "Hotel_external": {"icon": "<i class=\"fa-light fa-hotel\"></i>", "name": "هتل خارجی"},
