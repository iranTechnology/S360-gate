...
<!--                               style="max-width: 80px; min-height: 50px">-->
                               ...
                               <img src="https://api.qrserver.com/v1/create-qr-code/?size=300&data="<?= 'http://' . CLIENT_DOMAIN .'/gds/pdf&target=parvazBookingLocal&id='. $info['request_number'] .'&lang=fa' ?>" style="max-width: 80px; min-height: 50px"></td>
