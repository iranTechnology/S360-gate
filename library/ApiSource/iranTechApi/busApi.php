...
class busApi extends clientAuth
{
                ...
                if(responseSuccessfulCheck($status_checker) || responseSuccessfulCheck($status_checker)){
                    ...
                    if(responseSuccessfulCheck($status_checker) || responseSuccessfulCheck($status_checker)){
                        ...
                        /*     if ($_SERVER['REMOTE_ADDR'] == '84.241.4.20') {
                                 var_dump($serviceTitle);

                             }*/
                        $itCommission=$irantechCommission->getCommission($serviceTitle, '13',$agencyID);
                        /*if ($_SERVER['REMOTE_ADDR'] == '84.241.4.20') {
...
//            echo json_encode($responseDataBusDetail,256|64); die();
...
//                    }
                    ...
                    if(empty($CheckTransaction)){
                        ...
                        if($reduceTransaction){
                            ...
                            /*  if ($_SERVER['REMOTE_ADDR'] == '84.241.4.20') {
                                  $responseDataBusReserve = json_decode('{"response":{"successfulStatus":true,"Methode":"Safar724::busReserve","data":{"trackCode":26207787,"ticketNumber":26207787,"pnr":26207787},"information":null}}',true);
                              }else{
                              }*/
                            $responseDataBusReserve = $this->busReserveExecute($requestUrl, $data);

//                            if ($_SERVER['REMOTE_ADDR'] == '84.241.4.20') {
//echo json_encode($responseDataBusReserve,256|64);
//                            }
                            ...
                            if(responseSuccessfulCheck($status_checker)){
                                ...
                                $admin->ConectDbClient('', $agencyID, 'Update', $dataReport, 'book_bus_tb', $condition);
                                $ModelBase->setTable("report_bus_tb");
    ...
    {
        return 'http://safar360.com/Core/V-1/Bus/';
    }
