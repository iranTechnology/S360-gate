...
class ApiHotel extends clientAuth
{
    ...
    private function setApiRoot() {
        $this->apiRoot = 'http://safar360.com/CoreTest/V-1/Hotels/';
    }
    ...
    public function Book($data) {
        ...
        if ($checkInternal) {
            $it_commission = $irantechCommission->getCommission('PublicLocalHotel', '9');
            $serviceTitle = 'PublicLocalHotel';
        } else {
            $it_commission = $irantechCommission->getCommission('PublicPortalHotel', '10');
