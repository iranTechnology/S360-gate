...
class ApiTour extends clientAuth
{
    ...
    private function getNameMethodApiTour(): array {
        ...
        return ['countries', 'cities', 'typesTour', 'search', 'detail', 'prereserve', 'book', 'reserve','packages','hotelsPackages','informationsHotel','tourRoutes','infoTourByDate','packageOfTour','infoSpecialHotel','listTourTravelProgram','getInfoTour','getInfoTourRoutByIdTour','getTypeVehicleApi'];
    }
    ...
    private function getClientProviders(): array {
        $providers = $this->getModel('providersTourModel')->get()->where('client_id', '166')->find();
