...
با تشکر- دپارتمان فروش';
    ...
    public function checkStatusFlightReminder(){
        ...
        foreach($BookShow as $booking){
            ...
            // اگر بین 29 تا 31 دقیقه از زمان رزرو گذشته
        ...
        WHERE id = $clientId";
                ...
                $this->sendSmsToClient($booking , $client[0]['Mobile']);
    ...
    private function sendSmsToClient($eachDirection , $clientMobile) {
        ...
        try {
            ...
            if ($objSms) {
                ...
                if(!empty($clientMobile)) {
                    ...
                    $this->log("clientMobile not found");
                }
