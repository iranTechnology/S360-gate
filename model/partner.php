        ...
        if (!empty($result)) {
            ...
            if ($explod_name_pic[0] == "done") {
                ...
                if ($res_update || $res_update_color) {
                    ...
                    return 'success : اطلاعات  با موفقیت ویرایش شد';
                } else {
                    return 'error : خطا در ویرایش اطلاعات ';
                }
            }else{
                return "error : خطا در ویرایش  لوگو ";
            }
        } else {

            return "error : اطلاعات مورد نظر وجود ندارد،با وب مستر خود تماس بگیرید";
        }
    }
